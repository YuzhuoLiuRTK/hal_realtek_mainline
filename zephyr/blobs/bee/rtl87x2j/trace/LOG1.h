...
#define TRACE_FOR_UNEXPECTED_CODE_FLOW_IN_LE_ONLY 1   //"Should not enter here if LE only! LR=0x%x"
#define PRINT_RECORD_FAULT_INFO                 2     //"[Record Fault] fault_type:0x%x, mcause:0x%x, plic_irq_num:0x%x, pc:0x%x, ra::0x%x, sp:0x%x, a0:0x%x, a1:0x%x, a2:0x%x, a3:0x%x, a4:0x%x, a5:0x%x, a6:0x%x, a7:0x%x, final_mcause:0x%x, final_mie:0x%x, final_mtval:0x%x, rxi300_adr0:0x%x, cur_signal_type:%d, sig_param:0x%x, sig_ext_param:0x%x"
...
#define XYZ_UNABLE_TO_ALLOCATE_MEMORY_FROM_EVENT_BUFFER_POOL    49      //"xyz.Unable to allocate memory from event buffer pool! event_code=0x%x, event_param_len=%d"
...
#define SNIFF_REDESIGN                            64      //"[Sniff] sniff redesign reg0x48=0x%04x, first_inst=%d(slot)=0x%x(half slot), next_instant_in_nat_clk=0x%x(half slot), tsniff=%d, sniff_attemp=%d, sniff_timeout=%d, ssr_flag=%d"
...
#define PENDING_AFH_PDU_LOG                       135      //"[PENDING AFH PDU] keep offset in lmp pdu, ce: 0%x, afh instant offset: 0x%x, current tpoll: 0x%x"
...
#define LOG_SSR_STATE_ACTIVATE    293    //"[SSR] activate SSR (ce_index %d): inst %d ssr_inst %d"
#define LOG_SSR_STATE_ENTER    294    //"[SSR] enter SSR (ce_index %d): inst %d prev_pkt_time %d ssr_to %d"
#define LOG_SSR_STATE_EXIT    295    //"[SSR] exit SSR (ce_index %d): LR 0x%x"
...
#define LOG_LC_EXIT_SSR_MODE    348    //"[SSR] lc exit SSR mode: ce_index %d"
#define LOG_LC_ENTER_SSR_MODE    349    //"[SSR] lc enter SSR mode: ce_index %d"
...
#define DUMMY_NBC_TIMEOUT    466    //"Dummy NBC Timeout: lt_addr %d pid %d tx_status %d clock 0x%x"
...
#define LMP_RELEASE_AM_ADDR_FAILED    513    //"lmp release am_addr failed: am_addr %d pid %d LR=0x%08x"
...
#define LOG_INVALID_ESCO_CE_INDEX_WARN 1176 //"Warning: invalid esco_ce_index %d max_num_esco_ce %d LR 0x%x"
#define LOG_INVALID_ESCO_CH_ID_WARN 1177 //"Warning: invalid esco_ch_id 0x%x max_num_esco_ch %d LR 0x%x"
...
#define CALCULATE_MAX_SLOT    1229    //"lmp_calculate_max_slot: max_slot=%d, cond_bm=0x%x, LR=0x%x"
...
#define LOG_BTC_MAC_GET_COMMON_CONTEXT_INVALID_MAC_ID 1249 //"[BTC_MAC] Warning: failed to get common context: invalid mac_id %d LR 0x%x"
#define LOG_BTC_MAC_GET_BREDR_CONTEXT_INVALID_MAC_ID 1250 //"[BTC_MAC] Warning: failed to get bredr context: invalid mac_id %d LR 0x%x"
#define LOG_BTC_MAC_GET_LE_CONTEXT_INVALID_MAC_ID 1251 //"[BTC_MAC] Warning: failed to get le context: invalid mac_id %d LR 0x%x"
#define LOG_BTC_MAC_GET_CE_INDEX_INVALID_CTX 1252 //"[BTC_MAC] Warning: failed to get ce_index: invalid ctx LR 0x%x"
#define LOG_BTC_MAC_GET_LUT_TABLE_INVALID_CTX 1253 //"[BTC_MAC] Warning: failed to get lut table: invalid ctx LR 0x%x"
#define LOG_BTC_MAC_SET_FIXED_MAC 1254 //"[BTC_MAC] set fixed mac id %d"
#define LOG_MISMATCH_MAC_ID_WARN 1255 //"Warning: mismatch mac_id %d %d LR 0x%x"
#define LOG_BTC_MAC_SET_LEGACY_MAC_FAIL 1256 //"[BTC_MAC] set page/inquiry/scan mac_id failed, mac_id:%d"
#define LOG_BTC_MAC_SET_LE_MAC_FAIL 1257 //"[BTC_MAC] set adv/scan/initiator mac_id failed, mac_id:%d"
#define LOG_DUAL_BT_SET_MAC_CH_CLA 1258 //"[DUAL_BT] mac(%d) set ch_cla 0x%08x%08x%04x le_ch_cla 0x%08x%02x"
#define LOG_DUAL_BT_GEN_CH_MAP 1259 //"[DUAL_BT] mac(%d) afh_host_cla_en %d host_map 0x%08x%08x%04x"
#define LOG_DUAL_BT_GEN_CH_MAP_LE 1260 //"[DUAL_BT] mac(%d) afh_host_cla_en %d le_host_map 0x%08x%02x"
#define LOG_INVALID_MAC_ID_WARN 1261 //"Warning: invalid mac_id %d LR 0x%x"
...
#define BT_FW_LMP_MSG_SENT_EXT_PDU_PARAMS 1376 //"[clk:0x%08x] --> send lmp opc:%d/%d (addr:%d pid:%d tid:%d ce:%d m:%d, ce_st:%d), %08x-%08x-%08x-%08x"
...
#define BT_FW_LMP_MSG_RX_EXT_PDU_PARAMS 1378 //"[clk:0x%08x] <-- receive lmp opc:%d/%d (addr:%d pid:%d tid:%d ce:%d m:%d, ce_st:%d), %08x-%08x-%08x-%08x"
...
#define LOG_LMP_GET_CE_INDEX_FROM_AM_ADDR_INVALID_AM_ADDR_PID 1381 //"Warning: failed to get CE index: invalid am_addr %d pid %d LR=0x%x"
#define LOG_MSS_ABORT_DUE_TO_PENDING_TX 1382 //"Aborting MSS before instant due to pkt(s) in scheduler: lc_allowed_pkt_cnt=%d, ce_index=%d, is_broadcast=%d"
#define BB_DRIVER_SET_NO_AUTO_ACK_FOR_ALL_LINKS 1383 //"[BB] No Auto ACK For All Links: %d"
#define BT_FW_LONG_LMP_PTT_NOT_ENABLE 1384 //"PTT is not enabled, couldn't use long lmp 2DH1, ce:%d, subop: 0x%x"
...
#define SYNC_PKT_LOCAL_LOOPBACK  1405  //"conn_handle=0x%x, pkt_len=%d"
...
#define SYNC_PKT_LOCAL_LOOPBACK_ERROR 1410 //"SYNC pkt local loopback error! test_mode: %d"
#define LC_764  1412  //"lc_handle_baseband_commands: in LMP_PERIODIC_INQUIRY"
#define LC_774  1413  //"lc_handle_baseband_commands:mac_id:%d, lc_cur_device_state:%d, bd_addr:0x%x 0x%x 0x%x"
...
#define LC_1524  1425  //"[Sniff] kill sniff in baseband, am_addr=%d, piconet_id=%d"
...
#define FLOW_STOP_SHARE_POOL  1473  //"[LC] set flow STOP: reserved_buffers %d, remain_memory %d"
#define FLOW_GO_SHARE_POOL  1474  //"[LC] set flow GO: reserved_buffers %d, remain_memory %d"
...
#define LC_ISR_4230  1498  //"Inq resp pkt sent. clk:0x%x, random_backoff=%d(unit: slot)"
...
#define LC_SYNC_LINKS_280  1523  //"over codec %d num_esco_links_over_codec %d esco_ce_index %d esco_ch_id %d lt_addr %d"
...
#define LC_UTILS_1668  1626  //"lc_invoke_scheduler: MSS in progress: mss_state %d"
#define LC_UTILS_1877  1627  //"Trying: %d 0x%X"
#define LC_UTILS_1952  1628  //"queued_pkt = %d, lmp_pkt = %d"
#define LC_UTILS_3000  1629  //"[Error] Rescheduling null pkt in %d"
...
#define LMP_SYNC_LINKS_1435  1736  //"lmp_allocate_esco_entity_from_ce_database: mac_id=%d"
#define LMP_SYNC_LINKS_1474  1737  //"lmp_release_esco_entity_to_ce_database: esco_ce_index=%d, entity_status=%d, status=%d"
...
#define LMP_SYNC_LINKS_2959  1749  //"rx pkt 0x%x, pkt size %d (slot), tx pkt 0x%x, pkt size %d (slot), window size %d, latency %d, window number %d"
...
#define LMP_TASKS_1953  1772  //"Detach timer started for 0x%x(unit: 10ms), ce_index=%d, am_addr=%d, piconet_id=%d"
...
#define LMP_TASKS_4809  1808  //"Detach sent.Restarted timer. ce_index=0x%x, tpoll=%d, am_addr=%d, piconet_id=%d"
...
#define LOG_OS_SIGNAL_QUEUE_ENQUEUE_UNRELATED_SIGNAL_INTO_QUEUE_WARN 1890  //"[OS][SIG_QUEUE] Warning: enqueue signal (type %d) allocated from queue (task_id %d) into unrelated queue (task_id %d)"
#define LOG_OS_NO_FREE_TASK_SIGNAL_WARN 1891  //"[OS] Warning: couldn't get any free signal from task (task_id %d) LR 0x%x"
#define LOG_OS_FREE_SIGNAL_FAILED 1892  //"[OS] Warning: failed to free signal (ptr 0x%x): LR 0x%x"
...
#define NO_SUPPORT_TIMER 2430 //"TIMER ID No Support!! LR:0x%x"
...
#define MSG_LE_PRIVACY_LOCAL_RPA 2502 //"local RPA in resolving_list[%d] = 0x%04x%04x%04x"
...
#define LOG_LC_TPOLL_MGR_HTPOLL_START_END_MISMATCH_LT_ADDR_PID 2523 //"[LC][TPOLL] Warning: htpoll start/end notify: mismatch cur(am_addr %d pid %d) link(am_addr %d pid %d)"
...
#define LOG_INACTIVE_PICONET 2543 //"Warning: inactive piconet %d lr 0x%x"
#define LOG_INVALID_LT_ADDR_PID 2544 //"Warning: invalid lt_addr %d pid %d max_num_piconet %d lr 0x%x"
#define LOG_INVALID_CE_INDEX 2545 //"Warning: invalid ce_index %d max_num_ce %d lr 0x%x"
#define LOG_UNASSIGNED_CE_INDEX 2546 //"Warning: unassigned ce_index %d status %d lr 0x%x"
...
#define LOG_LC_TPOLL_MGR_HTPOLL_TASK_NOT_FOUND_IN_TLI 2549 //"[LC][TPOLL] Warning: htpoll task (am_addr %d pid %d addr %p) is not found in TPOLL_LINK_INFO"
...
#define LOG_LC_PCA_MGR_CHECK_IN_LE_CE 2555 //"[LC][PCA] in ce: entry %d nat_clk 0x%x"
#define LOG_LC_PCA_MGR_AFTER_CE_END_INTR 2556 //"[LC][PCA] after ce end: entry %d nat_clk 0x%x"
#define LOG_HTPOLL_BW_POLICY_RX_INFO 2557 //"[HTPOLL][BW] default BW policy RX info (am_addr %d pid %d): rx_clk 0x%x lcl_rx_pkt_type 0x%x crc_err %d tx_expected %d credit %d cont_null_pkt_cnt %d"
#define LOG_HTPOLL_INC_BW_POLICY_RX_INFO 2558 //"[HTPOLL][BW] inc BW policy RX info (am_addr %d pid %d): cur_rsvd_slots %d slot_passed %d htpoll_rsvd_slots %d cur_slot %d"
#define LOG_IGNORE_LE_LINK_HANDLE_IN_PCA 2559 //"[LC][PCA]Ignore LE link handle during pca update: instant:%d, clk_adj_slot:%d, clk_adj_us:%d"
#define LOG_HTPOLL_BW_POLICY_HTPOLL_TASK_NULL 2560 //"[HTPOLL][BW] default policy: task is NULL, interval:%d, credit:%d"
#define LOG_HTPOLL_BW_POLICY_NULL 2561 //"[HTPOLL][BW] default policy: policy is NULL"
#define LOG_LC_HTPOLL_SCHED_HIST_START_TASK 2562 //"[HTPOLL][SCHED_HIST] start task: task(addr %p lut_ind %d inst %d intvl %d rsvd_slot %d periodic %d state 0x%x) in_scheduling %d susp_state %d hlc_killed %d"
#define LOG_LC_HTPOLL_SCHED_HIST_CHECK_TASK_RESCHED 2563 //"[HTPOLL][SCHED_HIST] check task resched: cur_task(addr %p inst %d periodic %d state 0x%x) task(addr %p inst %d periodic %d state 0x%x) cur_inst %d"
#define LOG_LC_HTPOLL_SCHED_HIST_UPDATE_OLD_TASKS 2564 //"[HTPOLL][SCHED_HIST] update old tasks: cur_task(addr %p inst %d periodic %d state 0x%x htpoll_cnt_in_stopping %d susp_state %d) cur_inst %d sched_action %d pca_intr_occur %d"
#define LOG_LC_HTPOLL_SCHED_HIST_TASK_EXPIRED 2565 //"[HTPOLL][SCHED_HIST] task expired: task(addr %p orig_inst %d updt_inst %d periodic %d state 0x%x)"
#define LOC_LC_HTPOLL_SCHED_HIST_SELECT_NEW_TASKS 2566 //"[HTPOLL][SCHED_HIST] select new tasks: cur_task(addr %p inst %d periodic %d state 0x%x) task_pass_pca(addr %p inst %d periodic %d state 0x%x) cur_inst %d"
#define LOG_LC_HTPOLL_SCHED_HIST_INVALID_REC_TYPE 2567 //"[HTPOLL][SCHED_HIST] Warning: invalid record type %d"
#define LOG_LC_HTPOLL_SCHED_HIST_PID 2568 //"[HTPOLL][SCHED_HIST] htpoll schedule history for pid %d:"
#define LOG_LC_TPOLL_MGR_HANDLE_ROLE_SWITCH_TASK_CANT_RUN_WARN 2569 //"[LC][TPOLL] Warning: htpoll task shouldn't run when handling role switch: old(am_addr %d pid %d lut_index %d) new(am_addr %d pid %d lut_index %d) cur 0x%x is_bcsb_registered %d"
#define LOG_LC_HTPOLL_SCHED_HIST_START_TASK2 2570 //"[HTPOLL][SCHED_HIST] start task: task(addr %p paired %p lut_ind %d inst %d intvl %d rsvd_slot %d periodic %d state 0x%x) in_scheduling %d susp_state %d hlc_killed %d"
#define LOG_LC_HTPOLL_SCHED_HIST_CHECK_TASK_RESCHED2 2571 //"[HTPOLL][SCHED_HIST] check task resched: cur_task(addr %p inst %d periodic %d state 0x%x) next_task(addr %p inst %d periodic %d state 0x%x) task(addr %p inst %d periodic %d state 0x%x) cur_inst %d"
#define LOG_LC_HTPOLL_SCHED_HIST_UPDATE_OLD_TASKS2 2572 //"[HTPOLL][SCHED_HIST] update old tasks: cur_task(addr %p inst %d periodic %d state 0x%x htpoll_cnt_in_stopping %d susp_state %d) next_task(addr %p inst %d periodic %d state 0x%x htpoll_cnt_in_stopping %d susp_state %d) cur_inst %d sched_action %d pca_intr_occur %d"
#define LOC_LC_HTPOLL_SCHED_HIST_SELECT_NEW_TASKS2 2573 //"[HTPOLL][SCHED_HIST] select new tasks: cur_task(addr %p inst %d periodic %d state 0x%x) next_task(addr %p inst %d periodic %d state 0x%x) task_pass_pca(addr %p inst %d periodic %d state 0x%x) cur_inst %d"
#define LOG_LC_HTPOLL_TASK_EXEC_INFO2 2574 //"[LC][TPOLL] htpoll exec: am_addr %d pid %d htpoll_ind %d append %d inst %d intvl %d rsvd_slots_sched %d cur_slot %d"
#define LOG_BB_HTPOLL_NOT_STARTED_WHEN_APPEND_HTPOLL_WARN 2575 //"[BB][HTPOLL] Warning: htpoll (index %d) not started when appending htpoll"
#define LOG_LC_TPOLL_LINK_INFO_TASK_BUFFER_FULL_WARN 2576 //"[LC][TPOLL] Warning: tli task buffer full: am_addr %d pid %d LR 0x%x"
#define LOG_LC_TPOLL_MGR_INVALID_SCHED_ACTION 2577 //"[LC][TPOLL] Warning: invalid sched_action %d: pid %d"
#define LOG_LC_TPOLL_MGR_HTPOLL_CURRENT_NULL2 2578 //"[LC][TPOLL] Error: htpoll current is null: am_addr %d pid %d htpoll_end_intr_occur %d"
#define LOG_LC_TPOLL_MGR_INVALID_HTPOLL_INDEX 2579 //"[LC][TPOLL] Warning: invalid htpoll index %d: am_addr %d pid %d"
#define LOG_LC_NAME_REQUEST_COMMAND_DISALLOW 2580 //"[LC][NAME_REQ] Name request command disallow due to under link construction progress"
#define LOG_ENABLE_RX_INT_DUMP 2581 //"ENABLE RX INTERRUPT LOG"
#define LOG_DISABLE_RX_INT_DUMP 2582 //"DISABLE RX INTERRUPT LOG"


#define LOG_LC_INV_PKT_TYPE_POLICY_CHECK_NULL 2595 //"[INV_PKT_TYPE] Warning: policy NULL: LR 0x%x"
#define LOG_LC_INV_PKT_TYPE_POLICY_CHECK_TYPE_MISMATCH 2596 //"[INV_PKT_TYPE] Warning: type mismatch: type(%d %d) LR 0x%x"
#define LOG_LC_ACT_ESCO_MGR_SET_ALL_ESCO_LINKS_PAUSED 2597 //"[ESCO][ACT_ESCO_MGR] set all esco links paused: except ce_bm 0x%x, is_all_esco_links_paused %d"
#define LOG_LC_ACT_ESCO_MGR_CLR_ALL_ESCO_LINKS_PAUSED 2598 //"[ESCO][ACT_ESCO_MGR] clear all esco_links paused: is_all_esco_links_paused %d"
#define LOG_CHANGE_ESCO_WINDOW 2599 //"[ESCO] change esco win: esco_win (orig %d new %d), esco_policy %d"
...
#define LOG_LMP_VENDOR_P2P_CLK_ADJ_RX_AFTER_PCA_INTR 2617 //"[P2P_CLK_ADJ] rx_intr after pca_intr (pid %d): rx_intr_recv_cnt %d orig_dis_invalid_pkt_type_ignored %d clk 0x%x"
...
#define LOG_LMP_VENDOR_P2P_CLK_ADJ_RX_ONLY_ONE_PKT_AFTER_PCA 2621 //"[P2P_CLK_ADJ] RX only one packet after pca update before timeout"
#define LOG_LMP_VENDOR_P2P_CLK_ADJ_PAUSE_ESCO 2622 //"[P2P_CLK_ADJ] pause esco: enable %d"
#define LOG_B2S_INSERT_HTPOLL_IDLE_ZONE_FAIL            2623 //"[HTPOLL][B2S] Warning: failed to insert htpoll_idle_zone(inst %d->%d win %d clk_ref_type %d)"
#define LOG_B2S_HTPOLL_UPDATE_ZONE_FROM_MGR             2624 //"[HTPOLL][B2S] B2S htpoll update idle zone from mgr: ori_native_inst:%d, sync_b2b_inst:%d, rsvd_slot:%d, src_type:%d, curr_slot:%d, reset_htpoll:%d"
#define LOG_B2S_HTPOLL_CANCEL_ZONE_FROM_MGR             2625 //"[HTPOLL][B2S] B2S htpoll cancel idle zone from mgr: ori_native_inst:%d, sync_b2b_inst:%d, rsvd_slot:%d, src_type:%d, curr_slot:%d, reset_htpoll:%d"
#define LOG_B2S_HTPOLL_IDLE_ZONE_SYNC_FROM_MGR          2626 //"[HTPOLL][B2S] B2S htpoll sync idle zone from mgr: ori_native_inst:%d, sync_b2b_inst:%d, rsvd_slot:%d, src_type:%d"
#define LOG_B2S_HTPOLL_IDLE_ZONE_CONFLICT               2627 //"[HTPOLL][B2S] B2S htpoll (inst %d slot %d) conflict with idle zone (inst %d slot %d): new htpoll inst %d, new htpoll rsvd slot %d"
#define LOG_B2S_HTPOLL_END_OBSV_UPDATE                  2628 //"[HTPOLL][B2S] B2S htpoll end: ce_index:%d, ref_schedule_inst:%d, next_sched_inst:%d, next_sched_inst_in_native:%d, next_rsvd_slot:%d, curr_inst:%d, max_rsvd_slot:%d, tpoll_type:%d, sync_sched_cont:%d"
#define LOG_B2S_DISCONNECT_OBSV_UPDATE                  2629 //"[HTPOLL][B2S] B2S link disconnect in B2S htpoll enable, ce_index:%d"
#define LOG_B2S_HTPOLL_INFO                             2630 //"[HTPOLL][B2S] Set B2S htpoll, ce_index:%d, enable:%d, type:%d, htpoll_interval:%d, def_rsvd_slt:%d"
#define LOG_B2S_HTPOLL_SYNC_TRAFFIC_INFO                2631 //"[HTPOLL][B2S] Get B2S sync traffic info, ce_index:%d, sync_interval:%d, sync_rsvd_slot:%d"
#define LOG_B2S_DISABLE_HTPOLL_DUE_TO_NO_NEXT_INSTANT   2632 //"[HTPOLL][B2S] Disable and reset B2S htpoll due to No next schedule instant, ce_index:%d"
#define LOG_B2S_HTPOLL_SYNC_SCHE_BLOCK_MISSING          2633 //"[HTPOLL][B2S] The sync schedule block missing for sync periodic type, ce_index:%d"
#define LOG_B2S_HTPOLL_SET_LINK_HTPOLL                  2634 //"[HTPOLL][B2S] B2S set link htpoll: ce_index:%d, ref_schedule_inst:%d, next_sched_inst:%d, next_rsvd_slot:%d, curr_inst:%d, max_rsvd_slot:%d, tpoll_type:%d, sync_sched_cont:%d"
#define LOG_B2S_HTPOLL_UPDATE_SCHE_WITH_INFO            2635 //"[HTPOLL][B2S] Update schedule with info: least_feature_inst:%d, last_greatest_inst:%d, safe_sche_inst:%d, htpoll_schedule_ref_inst:%d, candidate_schedule_inst:%d, candidate_rsvd_slot:%d"
#define LOG_B2S_HTPOLL_CHECK_IN_TPOLL_START             2636 //"[HTPOLL][B2S] Enable B2S htpoll in tpoll start: ce_index:%d, enable:%d, type:%d, htpoll_interval:%d, def_rsvd_slt:%d"
#define LOG_B2S_HTPOLL_CHECK_IN_TPOLL_STOP              2637 //"[HTPOLL][B2S] Disable B2S htpoll in TPOLL stop: ce_index:%d"
#define LOG_B2S_HTPOLL_PCA_INTR_HANDLE                  2638 //"[HTPOLL][B2S] Handle pca intr for B2S htpoll: ce_index:%d, enable:%d, type:%d, htpoll_interval:%d, def_rsvd_slt:%d, sync_handle:%d"
#define LOG_B2S_HTPOLL_CE_INDEX_MISMATCH                2639 //"[HTPOLL][B2S] Warning: ce_index mismatch in handle htpoll start failure, ce_index:%d, b2s_ce_index:%d"
#define LOG_B2S_HTPOLL_START_HTPOLL_FAIL                2640 //"[HTPOLL][B2S] Warning: b2s htpoll start failure, reason:%d, interval:%d, rsvd_slot:%d, instant:%d, real_instant:%d, periodic:%d, restart:%d"
#define LOG_B2S_HTPOLL_CE_ENTITY_MISMATCH               2641 //"[HTPOLL][B2S] Warning: b2s info state missmatch with ce_entity: b2s_enable:%d, ce_index:%d, b2s_ce_index:%d"
#define LOG_B2S_HTPOLL_DISABLE_IN_RESET                 2642 //"[HTPOLL][B2S] Warning: b2s htpoll disable during reset, ce_index:%d"
#define LOG_B2S_IDLE_ZONE_MAP_NULL_OR_HTPOLL_DISABLE    2643 //"[HTPOLL][B2S] Warning: idle zone map NULL or b2s htpoll disable: idle_zone_map:0x%x, b2s_htpoll_enable:%d"
#define LOG_B2S_IDLE_ZONE_HTPOLL_DIABLE_IN_END          2644 //"[HTPOLL][B2S] Warning: idle zone ce_index invalid or b2s htpoll disable, ce_index:%d, b2s_htpoll_enable:%d"
#define LOG_B2S_HTPOLL_DIABLE_IN_TPOLL_STOP             2645 //"[HTPOLL][B2S] Warning: htpoll disable in tpoll stop, bypass htpoll end task, ce_index:%d, b2s_htpoll_enable:%d"
#define LOG_B2S_HTPOLL_SKIP_RESTART_IN_END_INTR         2646 //"[HTPOLL][B2S] Skip htpoll restart in end interrupt, ce_index:%d, inst:%d, htpoll_interval:%d, htpoll_rsvd_slot:%d"
#define LOG_B2S_HTPOLL_SKIP_RESTART_IN_SET_HTPOLL       2647 //"[HTPOLL][B2S] Skip htpoll restart in set htpoll, ce_index:%d, inst:%d, htpoll_interval:%d, htpoll_rsvd_slot:%d"
#define LOG_SECURE_CONN_UPDATE_FW_DAYCOUNTER_CNT        2648 //"[SC] update expect_daycounter due to clock wraparound cur_clock 0x%x, last_rx_clock 0x%x, expect_daycounter %d"
#define LOG_SECURE_CONN_UPDATE_DAYCOUNTER               2649 //"[SC] update daycounter %d -> %d"
#define LOG_SECURE_CONN_COMPARE_HW_TX_CNT_WITH_FW       2650 //"[SC] compare aes_tx_cnt, HW: msb 0x%x lsb 0x%x, FW: msb 0x%x lsb 0x%x, start_encryption_tx_check %d, schd->tx_count %d, record_tx_count %d"
#define LOG_SECURE_CONN_UPDATE_HW_AES_TX_CNT            2651 //"[SC] update aes_tx_cnt due to wrong aes_tx_cnt, new aes_tx_cnt msb 0x%x lsb 0x%x, fw_workaround_status %d"
#define LOG_CLK_DRAG_HANDLE_PCA_INTR 2652 //"[CLK_DRAG] align nat clk (pid 0x%x clk 0x%x) to ref pid (pid 0x%x clk 0x%x)"
#define LOG_CLK_DRAG_CLOCK_ADJUST_COMPLETION 2653 //"[CLK_DRAG] clock adjust completion and correlation enabled: ref_ce_index %d master_pid 0x%x"
#define LOG_CLK_DRAG_ADJUST_NATIVE_CLOCK_CHECK 2654 //"[CLK_DRAG] mac(%d) adjust clock check: total_us_diff %d adjust_us %d us_diff %d instant %d master_ce_idx_bm 0x%x"
#define LOG_CLK_DRAG_CHECK_RX_INTR_AFTER_PCA 2655 //"[CLK_DRAG] check rx intr after pca: mgr_master_ce_idx_bm 0x%x master_ce_idx_bm 0x%x ce_idx %d"
#define LOG_CLK_DRAG_ENABLE_INFO 2656 //"[CLK_DRAG] clk drag enable: fast_align %d master_ce_idx %d ref_ce_idx %d status %d"
#define LOG_CLK_DRAG_DISABLE_INFO 2657 //"[CLK_DRAG] clk drag disable: master_pid 0x%x (active %d master %d master_cnt %d lc_num_conn %d corr_en %d)"
#define LOG_VHCI_C2H_RETRY_WARN 2658 //"Warning!! "Warning!! HCI_IF_EVT_DATA_IND returned abnormal status:%d. Packet retained for retry."
...
#define LOG_SECURE_CONN_RESET_MIC_ERR_CNT 2719 //"[SC] reset mic_err_cnt to %d due to seqn is same"
#define LOG_SECURE_CONN_UPDATE_FW_REC_RX_CNT 2720 //"[SC] update record dec_rx_cnt msb 0x%x, lsb 0x%x"
#define LOG_SECURE_CONN_COMPARE_HW_RX_CNT_WITH_FW 2721 //"[SC] compare dec rx cnt, HW: msb 0x%x lsb 0x%x, FW: msb 0x%x lsb 0x%x, master_in_tx_disable_rx_enable_state %d"
#define LOG_SECURE_CONN_UPDATE_HW_DEC_RX_CNT 2722 //"[SC] update dec_rx_cnt due to wrong dec_rx_cnt, rx_msb 0x%x, rx_lsb 0x%x, status %d"
#define LOG_RHINO_STRICT_MODEM_REG                    2723 //"[RHINO][MODEM] modem reg@pageD, reg@0x68:0x%x, reg@0x6a:0x%x, reg@0x6c:0x%x, modem reg@page2, reg@0x62:0x%x"
#define LOG_RHINO_STRICT_MODEM_REG_2                  2724 //"[RHINO][MODEM] modem reg@page2, reg@0x62:0x%x, modem reg@page3, reg@0x62:0x%x, modem reg@page0, reg@0x18:0x%x"
#define LOG_RHINO_CHECK_FOR_STATUS_NOISY              2725 //"[RHINO][MODEM] pkt_noisy reg@0x244:0x%x, reg@0xac:0x%x, modem reg@page2,0x64:0x%x, piconet_clk:0x%x, SNR value reg@page0,0x68:0x%x"
#define LOG_RHINO_CHECK_FOR_SNR_VALUE                 2726 //"[RHINO][MODEM] SNR value in RX packet, reg@page0,0x68:0x%x"
#define LOG_RHINO_HANDLE_NOISY_PACKET                 2727 //"[RHINO][RX] Force CRC error for noisy packet, pkt_hdr:0x%x, pl_hdr:0x%x"
#define LOG_RHINO_HANDLE_CRC_OK_FIFO_ZERO             2728 //"[RHINO][RX] Handle CRC OK, RX FIFO ERROR, pkt_hdr:0x%x, pl_hdr:0x%x"
#define LOG_UPDATE_TIMER_FOR_FIRST_TX_LMP             2729 //"[RHINO][SSR] Update timer for first tx lmp after SSR => ce_index :%d, pre_pkt_time:0x%x"
#define LOG_INVALID_CE_INDEX_RHINO                    2730 //"[RHINO][SSRDBG] Invalid ce_index for handle SSR function => ce_index :%d, pkt_header:0x%x, pl_hdr:0x%x, am_addr:%d, pid:%d"
#define LOG_LBT_INIT_SETTING                          2731 //"[LBT] Init LBT before value, reg@0x2b4 => 0x%x"
#define LOG_RHINO_MULTILINK_TPOLL_SET                 2732 //"[RHINO][MULTILINK] Set Tpoll in multilink mgr, ce_index:%d, tpoll:%d"
#define LOG_RHINO_MULTILINK_TPOLL_RESUME              2733 //"[RHINO][MULTILINK] Resume Tpoll in multilink mgr, ce_index:%d, tpoll:%d"
#define LOG_SECURE_CONN_SNIFFING_INFO                 2734 //"[SC] shadow slave sc_use_enc_rand %d, enc_rand_remote 0x%x-0x%x, aco 0x%x-0x%x, daycounter 0x%x"
#define LOG_SECURE_CONN_SET_AES_CNT_WHEN_S_TO_M       2735 //"[SC] set ce: %d lut_index %d, aes_rx (msb:0x%x, lsb:0x%x), aes_tx (msb:0x%x, lsb:0x%x), daycounter %d"
#define LOG_SECURE_CONN_SEC_RESET_AUDIO_AES_RX_CNT    2736 //"[SC] Secondary reset audio aes_rx_cnt from pri: msb:0x%x lsb:0x%x"
#define LOG_SECURE_CONN_SEC_UPDATE_RX_CNT             2737 //"[SC] update sniffing link aes_rx_cnt rx_msb 0x%x, rx_lsb 0x%x, ori_rx_lsb 0x%x, aes_rx_cnt_from_pri 0x%x"
#define LOG_SECURE_CONN_UPDATE_RELAY_PKT_LLID_TO_AES_RX_CNT 2738 //"[SC] update relay pkt llid to rx_lsb 0x%x"

#define LOG_RHINO_UPDATE_NOP_EVENT                    2750 //"[RHINO] Update and return NOP event after reset"
#define LOG_RHINO_SEND_TEST_LMP_FAIL                  2751 //"[RHINO] Send vendor test lmp fail, ce_index:%d"
#define LOG_RHINO_READ_RAW_RSSI_VALUE                 2752 //"[RHINO] Read raw rssi value, ce_index:%d, raw rssi:%d"
#define LOG_RHINO_HCI_UART_LOOPBACK                   2753 //"[RHINO] Handle hci date with loopback test, conn_handle:%d, pkt_length:%d"
#define LOG_READ_PRIORITY_SETTING                     2754 //"READ priority setting mac(%d): reg@0x11C:0x%x, reg@0x11E:0x%x, reg@0x120:0x%x, reg@0x2F4:0x%x, reg@0x21C:0x%x, reg@0x27C:0x%x"
#define LOG_RHINO_READ_UART_FLOW_CTRL                 2755 //"[RHINO] READ UART Flow Ctrl reg:0x%x"
#define LOG_DISABLE_RX_BEFORE_SNIFF_ANCHOR            2756 //"[RHINO] Disable RX before sniff anchor, reg@0x322:0x%x"
#define LOG_BZDMA_END_LATCH_SNIFF_TOLERANCE           2757 //"[RHINO] Bzdma end latch and sniff tolerance, reg@0x35e:0x%x"
#define LOG_PSD_NEW_FEATURE_REG_VALUE                 2758 //"[RHINO] PSD new featue, 0x340:0x%x, 0x342:0x%x, 0x344:0x%x, 0x346:0x%x"
#define LOG_ENABLE_DISABLE_PSD_NEW_FEATURE            2759 //"[RHINO] Enable/Disable PSD SCAN, enable:%d, 0x342:0x%x nat_clk: 0x%x "
#define LOG_READ_MODEM_REG_SET                        2760 //"[RHINO] MODEM reg set, page2_0x56:0x%x, page2_0x58:0x%x, page3_0x04:0x%x, page6_0x64:0x%x"
#define LOG_READ_RADIO_TIMING                         2761 //"Radio timing reg(FW/HW), 0xC6:0x%x/0x%x, 0xC8:0x%x/0x%x, 0xCE:0x%x/0x%x, 0xD0:0x%x/0x%x, 0xD2:0x%x/0x%x, 0xD4:0x%x/0x%x"

#define LOG_RHINO_VENDOR_ENABLE_HEC                   2762 //"[RHINO] Enable/disable HEC extra check reg@0x124:0x%x"
#define LOG_RHINO_VENDOR_ENABLE_SNR                   2763 //"[RHINO] Enable/disable SNR extra check reg@0xAC:0x%x"
#define LOG_RHINO_MULTILINK_MAX_CONNECTION            2764 //"[RHINO][MULTILINK] Over maximum connection number, ce_index:%d, acl_conn_number:%d"
#define LOG_RHINO_MULTILINK_HANDLE_HTPOLL_ENABLE      2765 //"[RHINO][MULTILINK] handle htpoll enable for rhino multilink, ce_index:%d, acl_conn_number:%d, link_in_sniff:%d, htpoll_enable:%d
#define LOG_RHINO_MULTILINK_HANDLE_HTPOLL_ENABLE_FAIL 2766 //"[RHINO][MULTILINK] htpoll enable fail for rhino multilink, ce_index:%d, result:%d"
#define LOG_RHINO_MULTILINK_HANDLE_HTPOLL_DISABLE     2767 //"[RHINO][MULTILINK] handle htpoll disenable for rhino multilink, ce_index:%d, acl_conn_number:%d, link_in_sniff:%d, htpoll_enable:%d"
#define LOG_RHINO_MULTILINK_HANDLE_HTPOLL_DISABLE_FAIL 2768 //"[RHINO][MULTILINK] htpoll disable fail for rhino multilink, ce_index:%d, result:%d"
#define LOG_RHINO_MULTILINK_ALREADY_ENABLE            2769 //"[RHINO][MULTILINK] Warning: mgr htpoll already enable in check function"
#define LOG_RHINO_MULTILINK_ALREADY_DISABLE           2770 //"[RHINO][MULTILINK] Warning: mgr htpoll already disable in check function"
#define LOG_RHINO_MULTILINK_RESET_HTPOLL              2771 //"[RHINO][MULTILINK] htpoll reset fail for rhino multilink, ce_index:%d, result:%d"
#define LOG_RHINO_PKT_TYPE_CAL_MAX_SLOT               2772 //"[RHINO][MAX_SLOT] Update maximum slots with changed packet type, pkt_type:0x%x, hci_max:%d, max:%d"
#define LOG_RHINO_BYPASS_SEND_MAX_SLOT_PDU            2773 //"[RHINO][MAX_SLOT] Bypass sending maximux slot PDU"
#define LOG_RHINO_BYPASS_SEND_MAX_SLOT_REQ_PDU        2774 //"[RHINO][MAX_SLOT] Bypass sending maximux slot request PDU after exit sniff mode, ce_index:%d"
#define LOG_RHINO_READ_HCI_UART_FORCE_RTS_enable      2775 //"[RHINO] Enable HCI UART force RTS, reg@0x38:0x%x, platform_reg@0xe08:0x%x"
#define LOG_RHINO_READ_HCI_UART_FORCE_RTS_disable     2776 //"[RHINO] Disable HCI UART force RTS, reg@0x38:0x%x, platform_reg@0xe08:0x%x"

#define LOG_BZ_AUTH_PEER_USING_THE_SAME_PUB_KEY_ERR   2778 //"[AUTH] error: peer using the same public key with us, start to disconnection with it. ce_index: %d"
#define LOG_BZ_AUTH_PEER_USING_THE_SAME_PUB_KEY_ERR2  2779 //"[AUTH] Warning: peer using the same public key with us, regenerate ecdh key pair. ce_index: %d"
#define LOG_BZ_AUTH_PUBLIC_KEY_COMPARE                2780 //"[AUTH] AUTH pubkey compare, local:0x%x,0x%x,0x%x,0x%x, peer:0x%x, 0x%x, 0x%x,0x%x"
#define LOG_BZ_AUTH_PUBLIC_KEY_UPDATE                 2781 //"[AUTH] AUTH pubkey update :0x%x,0x%x,0x%x,0x%x,0x%x,0x%x,0x%x,0x%x"
#define LOG_EXIT_SSR_BYPASS_UPDATE_TIMER              2782 //"[SSR] BYPASS restart sniff timer for sending lmp => ce_index :%d"
#define LOG_EXIT_SSR_BY_HOST_DATA                     2783 //"[SSR] Exit SSR By Host data to send => ce_index :%d, curr_slot:%d"
#define LOG_EXIT_SSR_BY_LMP_PDU                       2784 //"[SSR] Exit SSR By LMP PDU to send => ce_index :%d, curr_slot:%d"
#define LOG_BYPASS_EXIT_SSR_BY_RECEIVE_LMP_PDU        2785 //"[SSR] Bypass Exit SSR By receiving LMP PDU => ce_index:%d"
#define LOG_UPDATE_SSR_INSTANT_FOR_CLK_WRAP           2786 //"[SSR] Update SSR instant for clock wraparound, orignal SSR inst:0x%x, update_SSR_inst:0x%x"
#define LOG_BTC_INFO_IN_SNIFF                         2787 //"[SNIFF] SNIFF BTC Info => ce_index:%d, next_achor:0x%x, offset:%d, interval:%d, rsvd_slot:%d "
#define LOG_ENTER_DLPS_FAIL_FOR_SNIFF_MODE            2788 //"[SSR] Enter DLPS FAIL due to sniff mode, entity_status:%d, ce_status:%d, sniff_interval:%d, interval_threshold:%d"
...
#define LOG_AUDIO_SNIFF_SECONDARY_ACK_PAYLOAD_ALLOC_FAIL 2846 //"[AS] Warning: ent->sniff.sec.ack_payload allocate fail"
...
#define LOG_AUDIO_SNIFF_RESCHED_AUDIO_A2DP_HTPOLL 2850 //"[AS] resched audio a2dp htpoll: ctrl(am_addr %d pid %d), cur_inst: %d"
...
#define LOG_AUDIO_SNIFF_LL_PRE_CONN_UPDT_SKIP_IDLE_ZONE_REGISTER 2853 //"[AS][IDLEZONE] skip register idle zone for menu_cs is in idle state, conn_entry:%d"
...
#define LOG_FREE_BUFFER_CONTENT 2881 //"free buffer pool content: am_addr:%d, pid:0x%x, pdu_code:%d, payload_content:%d"
...
#define LOG_AUDIO_SNIFF_IDLE_ZONE_REG_PAGE_SCAN_WINDOW 2899 //"//"[AS][PAGESCAN] Create idle zone for next page scan window : curr_slot:%d, scan_period:%d, scan_window:%d, scan_type:%d, idle_zone_inst:%d, idle_zone_ext_inst:%d, idle_zone_win:%d"
...
#define LOG_AUDIO_SNIFF_IDLE_ZONE_REG_INQ_SCAN_WINDOW 2902 //"[AS][INQSCAN] Create idle zone for next INQ scan window : curr_slot:%d, scan_period:%d, scan_window:%d, scan_type:%d, idle_zone_inst:%d, idle_zone_ext_inst:%d, idle_zone_win:%d"
...
#define LOG_AUDIO_SNIFF_SECONDARY_RX_NO_PKT_IN_INTERVAL 2904 //"[AS] Secondary receive no packet in a2dp/esco interval: rx_indication:%d, trigger_count:%d, set_correlation:%d, rx_rssi:%d"
...
#define LOG_AUDIO_SNIFF_HTPOLL_SYNC_IN_RECOVERY_LINK 2906 //"[AS][HTPOLL SYNC] Cancel the recovery only in receiving htpoll sync"
#define LOG_TPOLL_VAL_IN_DISCONN  2907 //"Discon tpoll %d am_addr %d pid %d"
#define LOG_AUDIO_SNIFF_MULTILINK_IDLE_ZONE_SCHEDULE 2908 //"[AS][IDLEZONE] Register addtional idle zone for multi-link : win_inst:%d, win_slot:%d"
#define LOG_ESCO_INSTANT_INTR_NEW 2909 //"[ESCO][START] mac(%d) esco_lt_addr:%d, pid:%d, packet_received:%d, lc_esco_window_overlap:%d, esco_ctrl_reg:0x%04x, cur_clk:0x%x"
#define LOG_FORBID_AFH_UPDATE 2910 //"[AFH] Forbid afh update due to on-going PCA update: am_addr %d pid %d"
#define LOG_UPDATE_AFH_INSTANT 2911 //"[LC][PCA] Update afh instant: pid %d am_addr %d afh_instant(old 0x%x new 0x%x)"
#define LOG_AUDIO_SNIFF_CHECK_IDLE_ZONE_SOURCE_TYPE  2912 //"[AS][IDLEZONE] Schedule recovery link, check idle zone source type:%d"
#define LOG_AUDIO_SNIFF_IDLEZONE_IN_RECOVERY  2913 //"[AS][IDLEZONE] Avoid idle zone in recovery link htpoll, win_inst:%d, win_slot:%d, src_type:%d"
#define LOG_UNSNIFF_LMP_BYPASS_ENTER_TRANSITION_MODE  2914 //"[SNIFF] handle unsniff lmp and bypass entering sniff transition mode, pid:%d, am_addr:%d"
#define LOG_SNIFF_LMP_BYPASS_ENTER_TRANSITION_MODE    2915 //"[SNIFF] handle sniff lmp and bypass entering sniff transition mode, pid:%d, am_addr:%d"
#define START_SNIFF_LOG 2916 //"[LC][SNIFF] start sniff: am_addr %d pid %d dsniff %d tsniff %d next_inst %d cur_inst %d"
#define LOG_SET_IGNORE_TPOLL_FLAG                     2917 //"[TPOLL_REQ] Set the ignore remote tpoll flag, conn_handle:%d, ce_index=%d, ignore_tpoll_req_flag:%d"
#define LOG_IGNORE_REMOTE_TPOLL_REQ                   2918 //"[TPOLL_REQ] ignore remote tpoll request, ce_index=%d, lmp_opcode:%d"
#define LOG_AUDIO_SNIFF_DYNAMIC_IDLE_ZONE_ALLOCATION  2919 //"[AS][IDLEZONE][DYNAMIC] Dynamic allocation idle zone for multi-link : cnt_in_intvl:%d, frequent_packet_num:%d, enable:%d"
#define LOG_AUDIO_SNIFF_REGISTER_DYNAMIC_IDLE_ZONE    2920 //"[AS][IDLEZONE][DYNAMIC] Register dynamic idle zone : win_inst:%d, win_slot:%d, rx_rssi:%d"
#define STOP_RANDOM_BCKOFF_TIMER_FAIL                 2921 //"Warning: stop ramdom backoff timer fail !"
#define LOG_IDLEZONE_MGR_INSERT                       2922 //"[IDLEZONE_MGR] Insert idle zone request into mgr, win_inst:%d, win_slot:%d, src_type:%d, priority:%d"
#define LOG_IDLEZONE_MGR_REMOVE                       2923 //"[IDLEZONE_MGR] Remove idle zone request from mgr, win_inst:%d, win_slot:%d, src_type:%d, priority:%d"
#define LOG_IDLEZONE_MGR_UPDATE                       2924 //"[IDLEZONE_MGR] Update idle zone request from mgr, win_inst:%d=>%d, win_slot:%d=>%d, src_type:%d=>%d, priority:%d=>%d"
#define LOG_IDLEZONE_MGR_CANCEL                       2925 //"[IDLEZONE_MGR] Cancel idle zone request from mgr, win_inst:%d, win_slot:%d, src_type:%d, priority:%d"
#define LOG_IDLEZONE_MGR_UPDATE_IN_PCA                2926 //"[IDLEZONE_MGR] Update mgr instant from pca update: orig_win_end:%d, update_win_end:%d, tuning_value:%d"
#define LOG_SCHEDULE_IDLE_ZONE_MGR_INST               2927 //"[IDLEZONE_MGR_HTPOLL] Update idle zone instant from mgr, audio_inst:%d, win_inst:%d, win_slot:%d, src_type:%d, priority:%d"
#define LOG_REGISTER_WITH_IDLEZONE_MGR                2928 //"[IDLEZONE_MGR_HTPOLL] Register idle zone with mgr init schedule, inst4new_idle_sched_next:%d, win_inst:%d, win_slot:%d, src_type:%d, priority:%d, cancel:%d"
#define LOG_IDLEZONE_MGR_OBSV_UPDATE_1                2929 //"[IDLEZONE_MGR_HTPOLL] obsv_update in mgr, original: inst4new_idle_sched_next:%d, win_inst:%d, win_slot:%d, src_type:%d, priority:%d, cancel:%d, update_zone_inst:%d, update_zone_slot:%d, curr_slot:%d"
#define LOG_IDLEZONE_MGR_OBSV_UPDATE_2                2930 //"[IDLEZONE_MGR_HTPOLL] obsv_update in mgr, update: update_zone:%d, win_inst:%d, win_slot:%d, src_type:%d, priority:%d, cancel:%d"
#define LOG_IDLEZONE_MGR_OBSV_CANCEL_1                2931 //"[IDLEZONE_MGR_HTPOLL] obsv_cancel in mgr, original: inst4new_idle_sched_next:%d, cancel_inst:%d, cancel_slot:%d, curr_inst:%d "
#define LOG_IDLEZONE_MGR_OBSV_CANCEL_2                2932 //"[IDLEZONE_MGR_HTPOLL] obsv_cancel in mgr, cancel: cancel_zone:%d, win_inst:%d, win_slot:%d, src_type:%d, priority:%d, cancel:%d"
#define LOG_IDLEZONE_MGR_ABO_HIGH_PRIORITY            2933 //"[IDLEZONE_MGR_HTPOLL] register abosolutely high priority idle zone in mgr, win_inst:%d, win_slot:%d, src_type:%d, priority:%d"
#define LOG_B2B_HTPOLL_INFO                           2934 //"[HTPOLL][B2B] Set B2B htpoll, enable:%d, interval:%d, rsvd_slot:%d, ref_inst:%d"
#define LOG_B2B_DISCONNECT_OBSV_UPDATE                2935 //"[HTPOLL][B2B] B2B link disconnect in B2B htpoll enable"
#define LOG_B2B_HTPOLL_END_OBSV_UPDATE                2936 //"[HTPOLL][B2B] B2B htpoll end: interval:%d, rsvd_slot:%d, next_ref_inst:%d, candidate_ref_inst:%d, in_receive_slv_traffic:%d, correlated:%d, num_conflict:%d"
#define LOG_B2B_HTPOLL_IDLE_ZONE_CONFLICT             2937 //"[HTPOLL][B2B] B2B htpoll (inst %d slot %d intvl %d) conflict with idle zone (inst %d slot %d): new periodic htpoll inst %d"
#define LOG_B2B_INSERT_HTPOLL_IDLE_ZONE_FAIL          2938 //"[HTPOLL][B2B] Warning: failed to insert htpoll_idle_zone(inst %d->%d win %d clk_ref_type %d)"
#define LOG_B2B_HTPOLL_IDLE_ZONE_SYNC_FROM_MGR        2939 //"[HTPOLL][B2B] B2B htpoll sync idle zone from mgr: ori_native_inst:%d, sync_b2b_inst:%d, rsvd_slot:%d, src_type:%d"
#define LOG_B2B_HTPOLL_UPDATE_ZONE_FROM_MGR           2940 //"[HTPOLL][B2B] B2B htpoll update idle zone from mgr: ori_native_inst:%d, sync_b2b_inst:%d, rsvd_slot:%d, src_type:%d, curr_slot:%d"
#define LOG_B2B_HTPOLL_CANCEL_ZONE_FROM_MGR           2941 //"[HTPOLL][B2B] B2B htpoll cancel idle zone from mgr: ori_native_inst:%d, sync_b2b_inst:%d, rsvd_slot:%d, src_type:%d, curr_slot:%d"
#define LOG_B2B_HTPOLL_END_INTR_DBG                   2942 //"[HTPOLL][B2B] B2B htpoll end intr bypass: htpoll_update_process:%d, htpoll_transition:%d"
#define LOG_B2B_HTPOLL_SLAVE_TRAFFIC_INFO             2943 //"[HTPOLL][B2B] Slave traffic in BTC: interval:%d, offset:%d, rsvd_slot:%d"
#define LOG_B2B_HTPOLL_MASTER_TRAFFIC_INFO            2944 //"[HTPOLL][B2B] Master traffic in BTC: interval:%d, offset:%d, rsvd_slot:%d"
#define LOG_B2B_HTPOLL_RESET_LINK_CHECK_STATE         2945 //"[HTPOLL][B2B] B2B htpoll reset link bypass: htpoll_update_process:%d, htpoll_transition:%d"
#define LOG_BYPASS_HW_GEN_MULTI_ESCO_INT              2946 //"[ESCO] bypass hw dupilate esco end interrupt esco_inst_last_rx_clk 0x%x, instant_slot %d"
#define LOG_WRONG_CE_STATUS_WHEN_RX_ACCEPT_SNIFF_REQ  2947 //"[SNIFF] wrong ce status when RX accept sniff req: ce_index %d ce_status %d"
#define LOG_SECURE_CONN_NO_LUT_WARNING                2948 //"[SC] Warning: invalid lut_index %d, am_addr %d, pid %d"
#define LOG_SECURE_CONN_CHECK_DHKEY_ARGU_INDEX        2949 //"[SC] mixed_scalar_multiply_state0 Set ce %d, ce_ptr->dhkey_cal_mpal_argu_index to %d"
...
#define LOG_DISABLE_LE_BEFORE_PCA_UPDATE              2964 //"[AS][LE_ADV_SCAN] Disable LE ADV SCAN before PCA update: LE_EXT_ADV_disable_bm:%d, LE_EXT_SCAN_disable:%d, LE_EXT_INIT_SCAN_disable:%d, LE_Legacy_ADV_disable:%d, LE_legacy_SCAN_disable:%d, LE_legacy_INIT_SCAN_disable:%d"
#define LOG_ENABLE_LE_EXT_ADV_AFTER_PCA_UPDATE        2965 //"[AS][LE_ADV_SCAN] Enable LE EXT ADV after PCA update: adv_handle:%d, event_property:%d, pid:%d, le_ext_adv_disable_bm:%d"
#define LOG_ENABLE_LE_EXT_SCAN_AFTER_PCA_UPDATE       2966 //"[AS][LE_ADV_SCAN] Enable LE EXT SCAN after PCA update"
#define LOG_ENABLE_LE_LEGACY_ADV_AFTER_PCA_UPDATE     2967 //"[AS][LE_ADV_SCAN] Enable LE legacy ADV after PCA update"
#define LOG_ENABLE_LE_LEGACY_SCAN_AFTER_PCA_UPDATE    2968 //"[AS][LE_ADV_SCAN] Enable LE legacy SCAN after PCA update"
#define LOG_DISABLE_LE_EXT_ADV_BEFORE_PCA_UPDATE      2969 //"[AS][LE_ADV_SCAN] Disable LE EXT ADV before PCA update: adv_handle:%d, event_property:%d, pid:%d, le_ext_adv_disable_bm:%d"
#define LOG_GET_LE_ADV_PID_FAIL                       2970 //"[AS][LE_ADV_SCAN] Warning!!, get LE ADV pid fail: LE_ADV_handle:%d"
#define LOG_ENABLE_LE_EXT_INIT_SCAN_AFTER_PCA_UPDATE  2971 //"[AS][LE_ADV_SCAN] Enable LE EXT initial SCAN after PCA update"
#define LOG_ENABLE_LE_LEGACY_INIT_SCAN_AFTER_PCA_UPDATE 2972 //"[AS][LE_ADV_SCAN] Enable LE initial legacy SCANN after PCA update"
#define LOG_IGNORE_LE_RESET_IN_PCA                    2973 //"[AS][LE_ADV_SCAN]Ignore LE reset during pca update: instant:%d, clk_adj_slot:%d, clk_adj_us:%d"
#define MEMORY_ALLOCATE_RECORD        2974  //"[MEM_ALLOC] <record> func: %s, size: %d, ram_type: %d, file_line: %d, data_on: %d, data_off: %d, buffer_on: %d"
#define MEMORY_ALLOCATE_CONFIG        2975  //"[MEM_ALLOC] <config> le_num_master_links: %d, le_num_slave_links: %d, bzdma_supported_le_max_seg_num: %d, bzdma_supported_le_max_frag_num: %d, bredr_max_active_conn: %d, bredr_max_piconet: %d, bredr_max_sco_conn: %d, bredr_max_esco_conn: %d"
#define MEMORY_ALLOCATE_NOTE          2976  //"[MEM_ALLOC] <note> var: %s, num: %d, sizeof: %d"
#define MEMORY_ALLOCATE_CONFIG2       2977  //"[MEM_ALLOC] <config> bredr_max_bc_conn: %d, g_lmp_max_ce_database_entries: %d, g_lmp_max_conn_handles: %d, max_acl_tx_pkt_cnts: %d, max_acl_rx_pkt_cnts: %d, max_lmp_pkt_cnts: %d, max_event_pkt_cnts: %d, max_fhs_pkt_cnts: %d"
#define MEMORY_ALLOCATE_CONFIG3       2978  //"[MEM_ALLOC] <config> max_le_acl_tx_pkt_cnts: %d, max_le_acl_rx_pkt_cnts: %d, max_le_pdu_pkt_cnts: %d, max_sco_tx_pkt_cnts: %d, max_sco_rx_pkt_cnts: %d, max_hci_cmd_pkt_cnts: %d"
#define MEMORY_ALLOCATE_CONFIG4       2979  //"[MEM_ALLOC] <config> max_iso_tx_pkt_cnts: %d, max_iso_rx_pkt_cnts: %d"
#define MEMORY_ALLOCATE_CONFIG5       2980  //"[MEM_ALLOC] <config> timerMaxNumber: %d, lower_task_stack_size: %d"
#define MEMORY_HEAP_INFO              2981  //"[MEM_ALLOC] heap memory scan:data on %d, data off %d, buffer on %d, buffer off %d"
#define LOG_FLUSH_AUX1_ACL_RXIFO      2982  //"[WORKAROUND] Flush AUX1 ACL RX FIFO rxfifo_bytes=%d"
#define LOG_FLUSH_AUX1_ESCO_RXIFO     2983  //"[WORKAROUND] Flush AUX1 ESCO RX FIFO rxfifo_bytes=%d"
#define LOG_RESET_RX_FIFO_WORKAROUND  2984  //"[WORKAROUND] Flush abnormal RX FIFO rxfifo_bytes=%d"
#define LOG_LE_ENABLE_LEGACY_ADV_FAIL 2985  //"[LL][ADV] Warning: Failed to get new pid for legacy ADV: pid 0x%x"
#define LOG_ESCO_END_INTR 2986 //"[ESCO][END] mac(%d) esco_lt_addr:%d, pid:%d, esco_ctrl_reg:0x%04x, cur_clk:0x%x"

#define LOG_BZDMA_TRXFIFO_PTR_DUMP 2994 //"[BZDMA] mac(%d): acl(txfifo 0x%08x rxfifo 0x%08x) sco(txfifo 0x%08x rxfifo 0x%08x)"
#define LOG_LINK_SCHEDULE_INFO_DUMP 2995 //"[LC] link sched info: (ce %d lt_addr %d pid %d) rptr:4/wptr:4/allowed_cnt:4/pkt0_tx_sts:4/pkt0_llid:4/pkt1_tx_sts:4/pkt1_llid:4=0x%08x pkt0_fw_sent_time=0x%x pkt1_fw_sent_time=0x%x"
...
#define MSG_FW_MAIN_SHOWTIME 2998 //"firmware-4.0 version = %04x %04x cpu clock = %d ahb_wait_cnt = %d my_bt_addr = 0x%02x%02x%02x%02x%02x%02x, IS_USE_VHCI=%d"
...
#define MSG_SUPTER_TO               3043  //"[clk:0x%08X] Sup_To - timer(cur %d to %d) pid %d addr %d ce %d sta %d lut(id %d low %04x up %04x) pinfo %04x sched(sta %d type %d src %d), tpoll_en=%d, tpoll=%d, susp_cnt=%d, suspension_state=%d, hw_status=0x%x, slv_tpoll_mask_reg=0x%x"
...
#define BZ_FW_ISOCH_0380_1 3055 //"add sco queues: sco id(%d) host 8bit(%d) air 8bit(%d) no_transparent(%d) ISO CONNS(%d) con_handle(%d) sync_conn_handle(%d), bz_sco_pkt_size(%d)"
...
#define LMP_MSG_PREFER_PACKET_TYPE 3064 //"== ptt_sta:%d prefer packet type:0x%x data rate: 0x%x allow_status: 0x%x max slot(accept %d sent %d), cqddr_pkt_type=0x%x =="
...
#define LMP_UTILS_0380_1 3081 //"Warning : slave cnt %d + master cnt %d > LMP_MAX_PICONETS_SUPPORTED"
...
#define DMA_ISR_ACL_RX_WRONG_PKT_TYPE   3119 //"[HCI_DMA] Wrong pkt_type=%d!"
...
#define MSG_INQURY  3141 //"[clk:0x%08x]lc_start_inquiry: inquiry_length+ext_inquiry_length=%d (unit: 1.25ms), ext_inquiry_length=%d (unit: slot), Ninquiry=%d"
...
#define MSG_PAGING_REM_DEV  3146 //"[clk:0x%08x]lc_start_paging: bd_addr:0x%04x%04x%04x lt_addr:%d pid:%d, page_timeout=%d (unit: slot), ext_page_timeout=%d (unit: slot), acc_page_timeout=%d (unit: slot), Npage=%d"
...
#define LE_MSG_HW_INSTRUCTION_CODE_ERROR 3206 //"[LL][DRIVER] Warning: invalid LE instruction: code %d LR 0x%x"
...
#define LE_MSG_INVALID_CONN_ENTRY 3209 //"Warning: LE invalid entry_id 0x%x LR 0x%x"
#define LE_MSG_SET_UNCONNECTED_CONN_ENTRY 3210 //"Warning: LE set instruction on unconnected entry_id 0x%x code %d"
...
#define LE_MSG_FREE_H2L_ACL_DATA_ERROR 3220 //"HCI Data Pkt (H2L) Free Error (entry %d pkt 0x%08x) !!"
...
#define LE_MSG_CONFIRM_DEV_LIST 3234 //"Confirm Dev List: mac(%d) type %d addr %d wr(DWord0 %08x DWord1 %08x) rd(DWord0 %08x DWord1 %08x)"
...
#define LE_MSG_HANDLE_RX_PKT_IN_TASK 3237 //"LE_RX PKT: mac(%d) type %d src %d rx_bytecnt %d conn_entry %d ce_cnt %d (clk:0x%08x)"
...
#define LE_MSG_CONNECT_NO_ALIVE 3258 //"Err!! LE Connect is Not Alive (entry %d active_bm 0x%x)"
...
#define LE_MSG_INSTALL_SESSION_KEY_1 3280 //"[LL]install sessKey-1: role %d entry_id 0x%x iv(0x%04x%04x%04x%04x)"
...
#define LE_MSG_INSTALL_SESSION_KEY_3 3288 //"[LL]install sessKey-3: SKD(0x%04x%04x%04x%04x%04x%04x%04x%04x%04x%04x%04x%04x%04x%04x%04x%04x)"
...
#define LL_MSG_EXT_ADV_TASK_ALREADY_IN_QUEUE_WARN 3331 //"[LL][ADV_EXT] Warning: adv task already in queue: task 0x%x type %d"
...
#define LL_MSG_EXT_ADV_TASK_NOT_IN_QUEUE_WARN 3333 //"[LL][ADV_EXT] Warning: adv task not in queue: task 0x%x type %d"
#define LL_MSG_EXT_ADV_CHK_FREE_TASK_DATA 3334 //"[LL][ADV_EXT] task_cnt(free %d total %d) data_cnt(free %d total %d)"
...
#define LE_MSG_GEN_LL_CONN_PARAM_REQ 3350 //"[LL]Gen LL_CONN_PARAM_REQ (%d): interval(ori %d min %d max %d) slv_l(%d->%d) sup_to(%d->%d) pref_period %d ref_ce_cnt %d offset(%d %d %d %d %d %d)"
...
#define LL_MSG_EXT_RUN_QUEUE_INFO 3367 //"[LL][ADV_EXT] mac(%d) adv_runq(%d) task(rsvd:8/type:8/adv_set_id:8/adv_handle:8)[5]=(0x%08x %d)(0x%08x %d)(0x%08x %d)(0x%08x %d)(0x%08x %d)"
#define LL_MSG_EXT_ADV_NO_FREE_DATA_ERR 3368 //"[LL][ADV_EXT] Warning!! No Free Data, payload_len=%d, LR=0x%x"
...
#define LL_MSG_EXT_ADV_TASK_CUR_ERR 3396 //"[clk1%08x][LL][ADV_EXT] mac(%d) Remove current task err: adv_h %d instant %d"
#define LL_MSG_EXT_ADV_TASK_LOOP_CNT_TOO_LARGE 3397 //"[LL][ADV_EXT] Err!! Loop Cnt Too Large "
#define LL_MSG_EXT_ADV_CUR_TASK_INFO 3398 //"[LL][ADV_EXT][clk1 %d] mac(%d) cur(task 0x%x adv_h %d instant %d) run_q %d"
...
#define LL_MSG_EXT_SCAN_SCHED_INFO 3404 //"[LL][ADV_EXT] mac(%d) scan_sched: cur:0x%p, cur_type:0x%x, cur_inst:%d, runq(1v1_len:%d, lv2_len:%d, expire_len:%d), free_cnt:%d, task(start_cnt:%d, end_cnt:%d)"
...
#define LL_MSG_EXT_SCAN_SCAN_STATE_INFO 3411 //"[LL][ADV_EXT] log_state:%d (1:scan; 0:init):(en:%d, phy_bm:0x%x, intvl:%d, win:%d)"
#define LL_MSG_INVALID_LL_AUX_PHY 3412 //"Error!! invalid ll_aux_phy:%d (0:1M; 1:2M; 2:Coded 7:Proprietary 4M)"
#define LL_MSG_INVALID_LL_HOST_PHY 3413 //"Error!! invalid ll_host_phy:%d (1:1M; 2:2M; 4:Coded 128:Proprietary 4M)"
#define LL_MSG_INVALID_LL_HW_PHY 3414 //"Error!! invalid ll_hw_phy:%d (0:1M; 1:2M; 2:500K; 3:125K 4:Proprietary 4M)"
...
#define LL_MSG_INVALID_LL_INIT_PHY_ID 3430 //"Error!! invalid ll_init_phy_id:%d (0:1M; 1:2M; 2:Coded 3:Proprietary 4M)"
...
#define LE_TX_TEST_TX_POWER 3435 //"hci_handle_set_tx_power_for_tx_test: force_le_tx_test_power=%d, tx_power_request=%d, adv_actual_power[0]=%d(dBm), adv_actual_power[1]=%d(dBm), need_enable_lbt=%d"
...
#define LE_SET_DATA_LEN_COMMAND 3446 //"[LL] LE Set Data Length Command: request_size=%d, request_time=%d, remote_support_coded_phy=%d, config_max_tx_size=%d, config_max_tx_time=%d"
#define LL_MSG_PERIODIC_DATA_DURATION_TOO_LARGE 3447//"[LL][PA] Warning!! pa_total_duration=%d, pa_interval=%d (unit:us)"
#define LE_MSG_GEN_LL_CONN_PARAM_RSP 3448 //"[LL]Gen LL_CONN_PARAM_RSP (%d): interval(ori %d min %d max %d) slv_l(%d->%d) sup_to(%d->%d) pref_period %d ref_ce_cnt %d offset(%d %d %d %d %d %d)"
#define LE_MSG_KILL_CONNECTION 3449 //"[LL] request hw to kill le conn entry 0x%x !!"
...
#define LE_MSG_GEN_LL_CONN_UPDT_REQ_CONN_ANCHOR_POINT_INFO 3461 //"[LL]Gen LL_CONN_UPDT_REQ (%d): ap %d inst %d offset %d interval_slot %d"
...
#define LL_MSG_EXT_ADV_TASK_ERR_WITH_LR 3465 //"[LL][ADV_EXT] Err!! Task Null, LR=0x%x "
...
#define LE_LINK_DBG_CE_END 3470 //"CE:%d rx_any_pkt:%d crc_error:%d, ap:0x%x, slv_clk:0x%x, ntv_clk:0x%x %d, non-hdt sn/nesn=%d/%d, hdt sn/nesn=%d/%d"
...
#define LE_ADJ_ENTRY_PRIORITY_LOG   3486    //"[LL] le adj entry priority, entry:0x%x, priority:%d, priority_min:%d, priority_opt:0x%x"
#define LE_RESET_ALL_ENTRY_PRIORITY  3487    //"Reset all entry priority"
#define LE_INVALID_ENTRY_BM       3488    //"entry bitmap >= 32, invalid parameters error."
#define IS_RTK_TV 3489 //"is_rtk tv"
...
#define LE_MSG_LE_RECV_CONN_REQ_WITH_INVALID_CE_INTERVAL_PARA 3493 //"Received invalid connection_ind: connection_interval: %d, win_size: %d"
#define LE_MSG_LE_RECV_CONN_REQ_WITH_INVALID_SUPTO_PARA 3494 //"Received invalid connection_ind: supervision_timeout: %d"
#define LE_ARBITRATOR_INTERRUPT_LOG 3495 //"[LL] mac(%d) Arbitration, state: 0x%x, pre_entry: %x, pre_inst: %x, win: %x, rpt_cr_entry: %x, rpt_map: %x, rpt_anch:%x, ce_cnt: %d, rpt_type: %x, rpt_anch_v: %x, anch_clk_diff: %x, cur_handle_clk:%x, pre_pri_backup: %x"
...
#define LOG_PSD_SCAN_OPTION_DISALLOW_BOTH_ALIG_PID_AND_ONLY_STEALING_WARN 3581 //"[LC][PSD] Warning: disallow to enable both psd align piconet and only stealing option at the same time: align_pid %d"
#define LOG_ITO_MSG_PAGE_RESPONSE_TIMEOUT 3582 //"Page Resp Timeout (no response for 8 slots): page(pid %d clk 0x%x) page_scan(pid %d clk 0x%x)"
#define HCI_DROP_INQ_RPT 3583 //"event pool approaches empty. drop inq report, event code: 0x%x, num_response=%d"
...
#define MSG_BLE_HW_FLOW_STOP_SHARE_POOL 3587 //"LS: set le flow STOP: reserved_buffers %d, reserve_memory %d"
#define MSG_BLE_HW_FLOW_GO_SHARE_POOL 3588 //"LS: set le flow GO: reserved_buffers %d, reserve_memory %d"
...
#define LOG_LL_DRIVER_UPDATE_MEU_ANCHOR_POINT 3597 //"[LL][DRIVER] update meu anchor point (ent_addr 0x%x cmpl_addr 0x%x): slot %d->%d cnt %d->%d clk_adj(slot %d us %d)"
#define MSG_ALLOC_OS_BUFFER_FAIL_LR 3598 //"!!!os_wrapper_alloc_buffer fail!!!, LR=0x%x"
#define LOG_PARSE_LE_EXT_CREATE_CONN_PARAM_FAILED 3599 //"[LL][ADV_EXT] Warning: ext create conn param parse failed: phy_id %d status %d err_case %d"
#define LOG_LE_CONN_UPDATE_FAILED 3600 //"[LL] Warning: conn update failed: status %d err_case %d"
#define LOG_LE_REMOTE_CONN_PARAM_REQ_REPLY_FAILED 3601 //"[LL] Warning: remote conn param req reply failed: status %d err_case %d"
#define LOG_LLC_CONN_PARAM_VALIDATION_FAILED 3602 //"[LL][CONN_PARAM] Warning: invalid param: status %d err_case %d LR 0x%x"
#define LOG_LLC_CONN_PARAM_PROC_SET_LOCAL_STATE 3603 //"[LL][CONN_PARAM] set local state: entry %d state %d->%d"
#define LOG_LLC_CONN_PARAM_PROC_SET_REMOTE_STATE 3604 //"[LL][CONN_PARAM] set remote state: entry %d state %d->%d"
#define LOG_LLC_CONN_PARAM_PROC_INVALID_LOCAL_STATE 3605 //"[LL][CONN_PARAM] Warning: invalid local state: entry %d state %d expected %d LR 0x%x"
#define LOG_LLC_CONN_PARAM_PROC_INVALID_REMOTE_STATE 3606 //"[LL][CONN_PARAM] Warning: invalid remote state: entry %d state %d expected %d LR 0x%x"
#define LOG_LLC_CONN_PARAM_PROC_INVALID_FINISH_STATE 3607 //"[LL][CONN_PARAM] Warning: invalid finish state: entry %d state %d"
#define LOG_LLC_CONN_PARAM_HANDLE_REQ_FAILED 3608 //"[LL][CONN_PARAM] Warning: failed to handle req: entry %d status %d err_case %d"
#define LOG_LLC_CONN_PARAM_HANDLE_RSP_FAILED 3609 //"[LL][CONN_PARAM] Warning: failed to handle rsp: entry %d status %d err_case %d"
#define LOG_LLC_CONN_PARAM_PROC_FAILED_FOR_WAIT_HCI_REQ_REPLY 3610 //"[LL][CONN_PARAM] Warning: failed to schedule conn param req proc: entry %d wait_hci_req_reply=1"
#define LOG_LLC_CONN_PARAM_PROC_IGNORED 3611 //"[LL][CONN_PARAM] ignore conn param req proc: entry %d state_remote %d"
#define LOG_LLC_CONN_PARAM_HANLDE_REQ_WHEN_LOCAL_PROC_ALREADY_INIT 3612 //"[LL][CONN_PARAM] recv conn param req when local proc already initiated: entry %d state_local %d"
#define LOG_LLC_CONN_PARAM_HANDLE_REJECTED_INFO 3613 //"[LL][CONN_PARAM] handle rejected: entry %d dir %d err_code %d old_state(local %d remote %d)"
#define LOG_LL_CONN_GET_PREF_PERIOD_INFO 3614 //"[LL][CONN] get perf period: pref_period_suggested %d period(esco %d cis %d bis %d suggested %d) => new_perf_period %d"
#define LOG_LL_CONN_ADJUST_CONN_INTERVAL_FOR_CODED_PHY_CONSTRAINT 3615 //"[LL][CONN] adjust interval for coded phy: entry %d orig_interval %d(1.25ms) max_rx_size_time %d(us) max_rx_time %d(us) interval_coded_min %d(us)"
#define LOG_LL_CONN_DECIDE_CONN_INTERVAL_INFO 3616 //"[LL][CONN] decide interval: entry %d interval(min %d max %d) pref_preiod_suggested %d => interval %d"
#define LOG_LL_CONN_CHECK_OFFSET_BY_CONN_PARAM 3617 //"[LL][CONN] check offset by conn param: entry %d offset %d(1.25ms) cand_ap %d cand_offs %d new_interval_slot %d"
#define LOG_LL_CONN_UPDATE_OFFSET_BY_CONN_PARAM 3618 //"[LL][CONN] update offset by conn param: entry %d offset_slot %d->%d"
#define LOG_LL_CONN_ANCHOR_POINT_MOVE_FAIL_DUE_TO_LLC_PROC_PENDED 3619 //"[LL][CONN] failed to move anchor point due to pended LLC proc: entry %d llc_type_bm 0x%x"
#define LOG_LL_CONN_CONFLICT_DETECT_ESCO_INFO 3620 //"[LL][CONN] le link(entry %d) conflict with eSCO link(lt_addr %d pid %d): le(ap %d rsvd_slot %d) esco(ap %d next_ap %d rsvd_slot %d)"

#define LE_PA_UPDT_DATA_RACE_COND_LOG_0 3621 //"[PA] Warning!! PA updt data race cond, PA early check data is updating, seg valid bit is not set"
#define LE_PA_UPDT_DATA_RACE_COND_LOG_1 3622 //"[PA] Warning!! PA updt data race cond, sync task: 0x%x, check PA is transmitting, pend replace data at event end task"
#define LE_PA_UPDT_DATA_RACE_COND_LOG_2 3623 //"[PA] Warning!! PA updt data race cond, sync task: 0x%x, replace data at event end task is done"
#define LE_PA_UPDT_DATA_RACE_COND_LOG_3 3624 //"[PA] Warning!! PA updt data race cond, sync task: 0x%x, check PA is transmitting, pend fill bzdam desc action"
...
#define LE_MSG_RECEIVE_LL_POWER_CONTROL_REQ 3632 //"[LL] LE Power Control Req received. Entry:%d. phy_bm:%d, delta:%d, txpower:%d, bz_phy=%d, pRem->proceeding=%d, pRem->rssi_cur_avg_valid=%d, pRem->rssi_cur_avg=%d"
...
#define LE_MSG_ACTUAL_TX_POWER_CHANGED  3635 //"[LL] Update LE Power Control record. New_power is different from original_power. Original_power:%d, RF_mode:%d, New_power:%d, offset:%d"
#define LE_MSG_GET_LINK_TXGAIN_INDEX_FAIL    3636 //"[LL] Get txgain index fail!! conn_entry:%d, rf_mode:%d, LR=0x%x"
...
#define LE_PWR_CTRL_DBG_03  3639       //"[LE_PWR_CTRL] Warning: le phy transfer fail: trans_type: 0x%x, phy: 0x%x, LR:0x%x"
#define LE_PWR_CTRL_DBG_04  3640       //"[LE_PWR_CTRL] current_path_loss_zone: 0x%x, rssi_dbm: %d, path_loss_db: %d"
#define LE_PWR_CTRL_DBG_06  3642       //"[LE_PWR_CTRL] managing_pwr_lvl: %d, here only calculate delta power by rssi_cur_avg: %d (rssi_cur_avg_valid: %d)"
#define LE_PWR_CTRL_DBG_07  3643       //"[LE_PWR_CTRL] rssi_estimation: entry: %d, phy_rate: %d, rssi_dbm: %d, reg_LR=0x%x"
#define LE_PWR_CTRL_DBG_08  3644       //"[LE_PWR_CTRL] path_loss_calculation: i=%d, entry: %d, path_loss: %d, upwards_l2m: %d, downwards_m2l: %d, upwards_m2h: %d, downwards_h2m: %d, remote_tx_power: %d, rssi: %d, old_cur_zone: %d, new_cur_zone: %d"
#define LE_PWR_CTRL_DBG_09  3645       //"[LE_PWR_CTRL] entry: %d, self_power_ctrl_start: %d, rssi_profile_nclk_slot=0x%x, cur_nclk_slot=0x%x, phy_rate=%d, managing_pwr_lvl: %d, rssi_cur_avg_valid: %d, rssi_cur_avg=%d, proceeding: %d"
#define LE_GET_CIS_TX_PHY_FAIL 3646    //"Get CIS Tx phy == BZ_PHY_INVALID, cis_uid=%d, unit_id=%d"
#define LE_PWR_CTRL_APR_BYPASS 3647    //"[LE_PWR_CTRL] entry: %d, bypass APR(%d) in power control resp, force_link_tx_power: %d"
#define LE_PWR_CTRL_USER_MODE_TX_POWER 3648 //"[LE_PWR_CTRL] entry: %d, force_link_tx_power: %d"
#define LE_MSG_GET_NON_LINK_TXGAIN_INDEX_FAIL    3649 //"[LL] Get txgain index fail!! rf_mode=%d, request_power=%d, LR=0x%x"
#define LE_MSG_GET_TXGAIN_INDEX_FAIL    3650 //"[LL] Get txgain index fail!! rf_mode=%d, txgain_type=%d, request_power=%d, LR=0x%x"
...
#define LL_MSG_RX_FIFO_MISMATCH 3664 //"[clk %08x] WARNING!!! ACL Rx FIFO mismatch (entry %d conn_counter %d)!! rx_pkt_cnt(fw %d  hw %d) bytecnt(hw %d fw %d) src%d"
...
#define LE_EXT_SCAN_REMOVE_ERR_TASK      3669    //"[LL][EXT_SCAN] Warning: mac(%d) remove current task whose instant is passed: cur_inst %d task(type %d inst %d)"
...
#define LL_EXT_ADV_DECIDE_INST_LOG  3672   //"[ADV_EXT] mac(%d) decide ext_adv instant, cur == 0x%x, now_clk = %d, new_inst = %d"
#define LL_EXT_ADV_CHECK_COLLISION_LOG   3673    //"[ADV_EXT] adv check collision:%d, task:0x%x, type:%d, instant:%d -> %d, next_free_slot_offset:%d < %d"

#define LE_MSG_RECEIVE_CHANNEL_REPORTING   3674  //"[LL] LE Channel Reporting Ind received. Entry:%d. enable:%d, max_delay:%d, min_spacing:%d"
#define LE_MSG_RECEIVE_CHANNEL_STATUS   3675  //"[LL] LE Channel Status Ind received. Entry:%d. bitmap: 0x%x 0x%x 0x%x 0x%x 0x%x"

#define LE_MSG_GEN_LL_CH_REPORT_IND 3676 //"[LL]Gen LL_CHANNEL_REPORT_IND (%d): enable:%d, max_delay:%d, min_spacing:%d"
#define LE_MSG_GEN_LL_CH_STATUS_IND 3677 //"[LL]Gen LL_CHANNEL_STATUS_IND (%d): 0x%x 0x%x 0x%x 0x%x 0x%x"
#define LE_MSG_GEN_LL_MIN_NUM_USED_CH_IND    3678 //"[LL]Gen LL_MIN_USED_CHANNELS_IND (%d): min_ch_phys:0x%x, min_num_used_ch:0x%x"
#define LE_MSG_RECEIVE_MIN_NUM_USED_CH_IND   3679  //"[LL] LE Min Num Used Ch Ind received. Entry:%d. min_ch_phys:0x%x, min_num_used_ch:0x%x"
#define LE_MSG_NO_NEED_SEND_MIN_CH_IND       3680  //"[LL] no send min ch num ind Entry:%d. min_ch_phys:0x%x, min_num_used_ch:0x%x"

#define LE_GET_AA_CH_LOG 3681 //"entry:%d, future_time_slot:%d, aa:0x%x, ch_index:%d"
#define LE_GET_AA_CH_FAIL_LOG 3682 //"conn_handle:0x%x, future_time:%d"
#define LE_GET_CH_LOG1 3683 //"entry:%d, ref_ap:0x%x, ref_ce:%d, tar_time:0x%x, tar_ce:%d, tar_channel_index:%d"
#define LE_GET_CH_LOG2 3684 //"hop_inc:%d, chose_index:%d, chbm_L:0x%08x, chbm_H:0x%x"
#define LE_GET_CH_ERROR 3685 //"Error, cannot find channel_index"

#define EXT_ADV_PKT_EXTENDED_HEADER_LEN_ERROR 3686 //"[ERR] extended header len + 1: 0x%x > pkt payload length: 0x%x"

#define EXT_ADV_PKT_EXTENDED_HEADER_LEN_NOT_MATCH_FLAG 3688 //"[ERR] extended header len computed with ext header flag (excluded ACAD): 0x%x > extended header length: 0x%x"
#define SUSPEND_RESUME_PROTOCOL_LOG     3689 //"[Syscall] Suspend Resume LE Protocol: status:%d, le_bitmap:0x%x, operation:%d, enable:(%d, %d), flag:%d"
#define LE_MSG_HIT_CONN_ADV_NO_GNT_LOG  3690 //"[LL] hit_conn_adv conflict with conn update instant-1-2, switch to conn: entry_id:%d, cur:%d, counter:%d, next_ap:%d, instant:%d"

#define LE_FLOW_CTRL_HCI_C2H_PKT_NODE_EXHAUSTED    3691 //"[Flow Ctrl] Warning: HCI_C2H_PKT_NODE exhausted: pkt_type %d buf %p"
#define LE_FLOW_CTRL_FREE_HCI_C2H_PKT_NODE_FAILURE 3692 //"[Flow Ctrl] Warning: Free ACL or LE ACL data pkt failure, conn handle: 0x%x"
#define FLOW_CTRL_CHG_LE_RX_FLOW_STOP_PKT_CNT 3693 //"[Flow Ctrl] ACL rx th cnt from %d to %d, LE ACL from %d to %d since host specified new total ACL rx pkt cnts"
#define FLOW_CTRL_TOTAL_SENT_C2H_ACL_PKT_NUM_NOT_MATCHED 3694 //"[Flow Ctrl] Warning: total sent c2h ACL pkt num is greater than specified host buffer size"
...
//####################################################################
#define LOG_LL_HANDLE_MASTER_UPDATE_INTR_INVALID_TYPE_WARN 3720 //"Warning: invalid type (%d) for ll master update intr"
...
#define LOG_READ_MAC_LE_REG 3876 //"mac(%d) le_reg0x%x=0x%04x"
...
#define LOG_LL_GET_CHU_BY_ENTRY_ID_WARN 4000 //"[LL] Warning: Failed to get conn handle unit by etnry_id (mac_id %d entry %d) LR 0x%x"
#define LOG_LL_GET_CHU_BY_CHU_INDEX_WARN 4001 //"[LL] Warning: Failed to get conn handle unit by chu_index %d num_links %d LR 0x%x"
#define LOG_LL_INVALID_ACL_ENTRY_ID 4002 //"[LL] Warning: invalid acl entry_id (mac_id %d entry %d) LR 0x%x"
...
#define MAIN_MSG_KEEP_ALIVE2 4636 //"Keep Alive (%d) - free pool cnt:(%d %d %d %d : %d %d %d %d : %d %d %d %d : %d %d %d)"
#define POOL_ID_INFO 4637 //"pool_id: acl_data_pool_id:%d, lmp_pdu_buffer_pool_handle:%d, hci_cmd_buffer_pool_handle:%d, acl_data_to_host_pool_id:%d, hci_event_buffer_pool_handle:%d, lmp_fhs_pkt_buffer_pool_handle:%d, le_acl_data_to_ll_pool_id:%d, le_llc_pdu_pool_id:%d"
#define POOL_ID_INFO2 4638 //"pool_id: le_acl_data_to_host_pool_id:%d, synchronous_data_pool_id:%d, synchronous_data_to_host_pool_id:%d, hci_iso_c2h_buffer_pool_handle:%d, hci_iso_h2c_buffer_pool_handle:%d, general_data_pool_id:%d, ext_adv_data_pool_id:%d"
...
#define DAPE_TEST_LOG542 4642 //"LE Conn Updt hw_entry:%d, fw_entry_id:%d, reg0x22:0x%04x, reg0x24:0x%04x"
#define DAPE_TEST_LOG543 4643 //"le_cnt:%d, le_bm:(mac0:0x%08x,mac1:0x%08x), adv:%d(int:0x%04x), scan:%d(int:0x%04x,win:0x%04x,dup:%d), init:%d(int:0x%04x,win:0x%04x) wakeup_cnt:%d, pm_err_code:0x%x, 0x%x, 0x%x, 0x%x, 0x%x le_inst_rpt:(mac0:0x%04x,mac1:0x%04x)"
...
#define DAPE_TEST_LOG570 4670 //"[LL][CONN_UPDT] Parameters not changed. No actual update: handle:%d ce_interval:%d(1.25ms) ce_len:%d(slot) slv_l:%d sup_to:%d(10ms)"
...
#define DAPE_TEST_LOG633 4733 //" [DLE][handle 0x%x] Update Length tx_phy(current%d new%d) CI(current%d host%d)phy_updt_state%d compare(phy %d rate %d) tx(time %d size %d real size %d)"
...
#define LOG_LL_DRIVER_SET_LE_INSTR 4736 //"[LL][DRIVER] mac(%d) set LE instruction: code %d"
#define LOG_LL_DRIVER_SET_LE_SLV_UPDT_INSTR 4737 //"[LL][DRIVER] mac(%d) set LE slv updt instruction: code %d slv_ent %d"
#define DAPE_TEST_LOG638 4738 //"[LL PHY UPDT (%d)] Issue HW PHY UPDT instant %d m:%d hw_tx_phy %d hw_rx_phy %d (0:1M 1:2M 2:125K 3:500K, 4:Proprietary 4M, 5:HDT)"
...
#define LOG_LE_HW_ERROR_WARN 4743 //" Warning: mac(%d) LE HW error: hw_err 0x%x([0]:h2h_exp_flg, [1]:iq_lost)"
...
#define DAPE_TEST_LOG647 4747 //" [LL] Warning!! Entry %d cnt %d phy rate not match. Tx(HW%d FW%d) Rx(HW%d FW%d) (FW 0:1M 1:2M 4:LR 128:Proprietary 4M) (HW 0:1M 1:2M 2:125K 3:500K 4:Proprietary 4M)"
...
#define DAPE_TEST_LOG651 4751 //" [LL] Update Tx Phy to FW's value(HW%d FW%d)(FW 0:1M 1:2M 4:LR 128:Proprietary 4M) (HW 0:1M 1:2M 2:125K 3:500K 4:Proprietary 4M)"
...
#define LE_GRANT_DECISION 4754 //"mac(%d): pre_clk_diff:0x%x, two_anch_clk_diff:0x%x, cur_clk:0x%x, cur_ent_anch:0x%x, scan_pri:%d, link_pri:%d, pre_pri_backup:%d, flag:%d, lose:%d, window:%d, rpt_priority:%d"
...
#define LE_MSG_UNCONNECTED_CONN_ENTRY 4761 //"LE Recv LLC PDU With Unconnected Entry %d"
#define LE_DEASSERT_LOG_1             4762 //"[LL] gnt_deassert:0x%x, entry:%d, cur_nclk:(%d,%d), cur_nclk2:(%d,%d), cur_nclk3:(%d,%d), le_ap:(%d,%d), slot_diff:%d"
#define LE_DEASSERT_LOG_2             4763 //"[LL] check_deassert_condition: type:%d, ap:%d, intvl:%d, offs:%d"
#define LE_MSG_GET_PKT_HEAD_TO_ACC_HIT_EXCEPTION 4764 //"LE get pkt head to acc hit timing type exception: %d"
#define LE_MSG_GET_PHY_VALID_BM_EXCEPTION 4765 //"LE get valid phy bm with types exception: %d"
...
#define MINT_OS_MALLOC_FAIL  5003     //"OS_ALLOC_BUFFER Fail: tx_pool_id: %d, LR=0x%x"
...
#define LE_MSG_PARSE_RX_TAIL_STATUS 5008  //"[LE] Parse Rx HW Tail. Total Len: %d, rx_tail_offset: %x, tail_len: %x, src: %x, status3_en: %x, status2_en: %x, iso_hit_latch_en: %x, crc_en: %x, bc_cnt: %x, valid: %x, status4_en: %x"
...
#define LE_MSG_ISO_RX_LL_CIS_REQ_CIG_PARAMS0 5025 //"[ISO] recd  ll cis req info param0: cig_id %d cis_id %d phy(%d %d) max_sdu(%d %d) framing_mode %d framed %d sdu_intv(%d %d) rate(%d %d)"
...
#define LE_MSG_HW_CIS_S_CONN_INTR_INFO 5033  //"[ISO] ISO HW cis conn intr!! ch_map %04x, hw_status %04x "
...
#define LE_MSG_CIS_SUPERVISION_TIMEOUT 5046  //"[ISO] Supervision timeout in CIS link: cis_uid %d, no_rx_any %d, last_cis_cnt %d"
...
#define LE_MSG_CHECK_CIS_CONN_INT_EVT 5064  //"[ISO] check cis conn int evt: id %d, state %d, reason %d, cis_ps_list_updt %d, cis_entry_en_map 0x%04x"
...
#define LE_MSG_CIG_PARA_ERR_BY_SEG_NUM 5073 //"[ISO] cig para fail, bn_m2s: %d, delay_itv: %d"
#define LE_MSG_UPDATE_CE_LENGTH_LOG 5074 //"[ISO] Update LE ce_length due to CIS: entry:%d, cis_bm:0x%x, cam1:0x%x"
#define LE_RESCHEDULE_LE_LINK_DEBUG 5075 //"[LE] traffic in BTC: type:%d, interval:%d, anchor_point:%d, offset:%d, reserved_slot:%d"
#define LE_MSG_ISO_FW_GEM_PACK_PARAM_VENDOR 5076  //"[ISO] Vendor cmd Gen CIG Packing Params: result %d, ull cnt %d, policy %d, cis(bmap %x cnt %d, sub_intv(%d %d %d %d), cis_len(all %d, min %d)"
#define LE_MSG_CIG_GET_UNIT_BY_UNIT_ID_WARN 5077 //"[ISO] Warning: failed to get cig unit by unit_id (mac_id %d cig_uid %d) LR 0x%x"
#define LE_MSG_CIG_GET_UNIT_BY_CIG_INDEX_WARN 5078 //"[ISO] Warning: failed to get cig unit by cig_index %d max_cig_num %d LR 0x%x"
#define LE_MSG_CIS_GET_UNIT_BY_UNIT_ID_WARN 5079 //"[ISO] Warning: failed to get cis unit by unit_id (mac_id %d cis_uid %d) LR 0x%x"
#define LE_MSG_CIS_GET_UNIT_BY_ENTRY_ID_WARN 5080 //"[ISO] Warning: failed to get cis unit by entry_id (mac_id %d cis_entry %d) LR 0x%x"
#define LE_MSG_CIS_GET_UNIT_BY_CIS_INDEX_WARN 5081 //"[ISO] Warning: failed to get cis unit by cis_index %d max_cis_num %d LR 0x%x"
#define LE_MSG_BIG_GET_UNIT_BY_UNIT_ID_WARN 5082 //"[ISO] Warning: failed to get big unit by unit_id (mac_id %d big_uid %d) LR 0x%x"
#define LE_MSG_BIG_GET_UNIT_BY_BIG_INDEX_WARN 5083 //"[ISO] Warning: failed to get big unit by big_index %d max_big_num %d LR 0x%x"
#define LE_MSG_BIS_GET_UNIT_BY_UNIT_ID_WARN 5084 //"[ISO] Warning: failed to get bis unit by unit_id (mac_id %d bis_uid %d) LR 0x%x"
#define LE_MSG_BIS_GET_UNIT_BY_ENTRY_ID_WARN 5085 //"[ISO] Warning: failed to get bis unit by entry_id (mac_id %d bis_entry %d) LR 0x%x"
#define LE_MSG_BIS_GET_UNIT_BY_BIS_INDEX_WARN 5086 //"[ISO] Warning: failed to get bis unit by bis_index %d max_bis_num %d LR 0x%x"
#define LE_MSG_MOVE_CIG_UNIT_TO_MAC_FAIL_WARN 5087 //"[ISO] Warning: failed to move cig unit(uid %d): mac_id(%d->%d) num_cis %d dest_used(cis_cnt %d cig_cnt %d)"
#define LE_MSG_MOVE_CIG_UNIT_TO_MAC_INFO 5088 //"[ISO] move cig unit(uid %d): mac_id(%d->%d) num_cis %d src_used(cis_cnt %d cis_map 0x%x cig_cnt %d cig_map 0x%x) dest_used(cis_cnt %d cis_map 0x%x cig_cnt %d cig_map 0x%x)"
#define LE_MSG_ISO_FW_MODIFY_M2S_TRANS   5089 //"[ISO] change max max_translat_m2s due to iso tx pkt cnt cfg, from %d to %d"
#define LE_MSG_ISO_FW_MODIFY_S2M_TRANS   5090 //"[ISO] change max max_translat_s2m due to iso rx pkt cnt cfg, from %d to %d"
#define LE_MSG_CIS_TX_ACKED_IN_TX_THR 5091  //"[ISO] tx iso data acked in tx thr int: id %d, hw_bmap %08x fw_bmap %08x, acked (bzdma %d)"
#define LE_MSG_CIS_WORKAROUND_RX_CIE_TERM_ERROR 5092 //"[ISO] cis uid %d mac %d workaround rx cie term err, set dis_rx_cie = %d"
...
#define LE_MSG_BIS_FW_REDUCE_WW 5147 //"[ISO] BIS origin ww_us:%d, new ww_us:%d, ww_reduce:%d, new ww slot:%d us:%d"
#define LE_MSG_BIG_CREATE_WW_AUTO_UPDATE  5148 //"[ISO] BIG Sync WW Auto Update: local sca:%d, remote sca:%d, iso interval:%dslot, se_len:%dus, comp_duration:%dus, disallow_auto_updt_ww:%d."
#define LE_MSG_BIG_CREATE_NO_PA_ENTITY  5149 //"[ISO][Warn] Cannot find pa_entity, handle=0x%x"
#define LE_MSG_BIS_RX_COLLECTOR_ERROR 5150 //"[ISO Rx] BIS Rx Collector Error!! dequeue %d times, bis_id: 0x%x, rptr: 0x%x, rptr_region: 0x%x ~ 0x%x"
#define LE_MSG_ISO_MALLOC_PSDU_TEST_BUFFER_ERR 5151 //"[ISO] psdu test buffer malloc fail"
#define LE_MSG_BIG_CTRL_EVENT_BANDWIDTH 5152 //"[ISO] BIG CTRL Event Increase Bandwidth: entry:%d, big_uid:%d, cstf:%d, cssn:(%d->%d), required_bw:%d(choose from %d and %d)us"
#define LE_MSG_KILL_CIS             5153 //"[ISO] LE Instruction 17, request hw to kill cis uid %d !!"
#define LE_MSG_DUP_DELETE_CIS       5154 //"[ISO] duplicate delete cis uid %d"
#define LE_MSG_CIS_WW_UPDT_INT      5155 //"[ISO] cis window widening update interupt, cis uid %d"
#define LE_MSG_CIS_OUT_OF_WW_INT    5156 //"[ISO] cis out of window widening interupt, cis uid %d"
#define LE_MSG_CIS_CH_UDATE         5157 //"[ISO] le acl %d update associated cis channel map"
#define LE_MSG_LE_ACL_CONN_UPD_CIS_AP_UDATE 5158 //"[ISO] le slave (%d) conn update, adjust ap cis cam, shift clk: %d, shift cnt: %d"
#define LE_MSG_BIG_KILL_BIG_AT_END_INT      5159 //"[ISO] Delay Kill BIG at BIG END: big_uid:%d, bitmap:0x%x, gen_event:%d, big_handle:%d"
#define LE_MSG_BIG_KILL_CIS_AT_END_INT      5160 //"[ISO] Delay Kill CIS at CIG END: cig_uid:%d, cis_uid:%d, kill_bitmap:0x%x, active_bitmap:0x%x"
#define LE_MSG_BIS_TOGGLE_EMPTY_OPT         5161 //"[ISO] BIS enable bis_tx_empty_opt:%d"
#define LE_MSG_ISO_CAL_MPT_PHY_EXCEPTION    5162 //"[ISO] cal mpt duration phy exception: %d"
#define LE_GET_BIS_PHY_FAIL                 5163 //"[ISO] Get BIS phy == BZ_PHY_INVALID, big_uid=%d, bis_uid=%d"
#define LE_MSG_ISO_CREATE_BIG_PARAM_V2      5164 //"[ISO] Create BIG param v2(BIG Info): hdt_rates 0x%x, hdt_mic_length %d hdt_pkt_format %d"
#define LE_MSG_ISO_CREATE_BIG_TEST_PARAM_V2 5165 //"[ISO] Create BIG test param v2(BIG Info): hdt_rates 0x%x, hdt_mic_length %d hdt_pkt_format %d hdt_block_num %d"

// PA/CIS/BIS priority vendor cmd related
#define DIFF_PA_ENTRY_PRIORITY      5200 //"[LL] pa_active_bm = 0x%x, PA_entry_prioriy: %d, %d, %d, %d, PA_entry_prioriy_min: %d, %d, %d, %d"
#define DIFF_BIS_ENTRY_PRIORITY     5201 //"[LL] bis_active_bm = 0x%x, BIS_entry_prioriy: %d, %d, %d, %d, BIS_entry_prioriy_min: %d, %d, %d, %d"
#define DIFF_CIS_ENTRY_PRIORITY     5202 //"[LL] cis_active_bm = 0x%x, CIS_entry_prioriy: %d, %d, %d, %d, CIS_entry_prioriy_min: %d, %d, %d, %d"
#define BIG_EVT_END_LOG             5203 //"[LL] big event end, big_evt_end_bm_bis_updt[%d] |= BIT%d"
#define CIG_EVT_END_LOG             5204 //"[LL] cig event end, cig_evt_end_bm_cis_updt[%d] |= BIT%d"
#define ADJ_BIS_PRIORITY            5205 //"[LL] adjust bis priority, l_manager.aging_array[%d].priority = %d, last_scheduled_anchor_point = 0x%x"
#define ADJ_CIS_PRIORITY            5206 //"[LL] adjust cis priority, l_manager.aging_array[%d].priority = %d, last_scheduled_anchor_point = 0x%x"
#define LE_INVALID_ENTRY_BM_02      5207 //"[LL] entry bitmap > 1F, invalid parameters error."
#define SET_PA_TX_PRIORITY_LOG      5208 //"[LL] set pa tx handle priority, ae_handle[%d] = %d"
#define SET_PA_RX_PRIORITY_LOG      5209 //"[LL] set pa rx handle priority, sync_handle = 0x%x, entry[0x%x].priority_min = %d"
#define SET_BIS_PRIORITY_LOG        5210 //"[LL] set_big_handle_priority_min, big_conn_handle = %d, entry[0x%x].priority_min = %d"
#define SET_CIS_PRIORITY_LOG        5211 //"[LL] set_cig_handle_priority_min, cig_handle = %d, entry[0x%x].priority_min = %d"
#define SET_AE_PRIORITY_LOG         5212 //"[LL] set_ae_handle_priority, handle[%d] = %d"
#define LE_WRITE_ENTRY_PRIORITY_LOG 5213 //"[LL] le write priority_min only, entry_id.u16:0x%x, priority_min:%d, priority_opt:0x%x"

//MSFT region
#define MSFT_HCI_EXTENSION_TO_MANY_UUID 5500 // "[HCI EXT] Warning!! Too many UUID ad entry!! packet len: %d, uuid set count: %d"
#define MSFT_HCI_EXTENSION_AUDIO_INTF_PARAM 5510 //"[HCI EXT] audio interface param: vendor ID 0x%X, vendor param 0x%X, len 0x%X, params 0x%X 0x%X 0x%X 0x%X, 0x%X 0x%X 0x%X 0x%X"
#define MSFT_HCI_EXTENSION_AUDIO_CODEC_CAPB 5511 //"[HCI EXT] audio codec capb: serv_categ 0x%X, len 0x%X, media_type 0x%X, codec_type 0x%X"
#define MSFT_HCI_EXTENSION_AUDIO_CODEC_RAW  5512 //"[HCI EXT] audio codec raw infor: 0x%X 0x%X 0x%X 0x%X, 0x%X 0x%X 0x%X 0x%X"
#define MSFT_HCI_EXTENSION_AUDIO_CODEC_SBC  5513 //"[HCI EXT] audio codec SBC infor: mode 0x%X, freq 0x%X, alloc 0x%X, subband 0x%X, block 0x%X, min_bitpool 0x%X, max_bitpool 0x%X"
#define MSFT_HCI_EXTENSION_AUDIO_CODEC_AAC  5514 //"[HCI EXT] audio codec AAC infor: object 0x%X, freq1 0x%X, freq2 0x%X, channel 0x%X, vbr 0x%X, bitrate 0x%X"
#define MSFT_HCI_EXTENSION_AUDIO_CODEC_UNKN 5515 //"[HCI EXT] audio codec unknown: id 0x%X, codec 0x%X !!!"
#define MSFT_HCI_EXTENSION_AUDIO_CODEC_APTX 5516 //"[HCI EXT] audio codec APTX infor: mode 0x%X, freq 0x%X"
#define MSFT_HCI_EXTENSION_LE_MONITOR_ADV_V1 5517 //"[HCI EXT] MSFT_HCIExtension_V1 cmd: RSI_TH_H 0x%X, RSI_TH_L 0x%X, RSI_TH_Lt_INV 0x%X, RSI_S_PERI 0x%X, CON: 0x%X"
#define MSFT_HCI_EXTENSION_LE_MONITOR_ADV_V2 5518 //"[HCI EXT] MSFT_HCIExtension_V2 cmd: RSI_TH_H 0x%X, RSI_TH_L 0x%X, RSI_TH_Lt_INV 0x%X, RSI_S_PERI 0x%X, MON_OP: 0x%X, ADV_RP_FILT_OP: 0x%X, CON: 0x%X"
#define MSFT_HCI_MONITOR_RSSI_CMD 5519 //"[HCI EXT] MSFT_HCI_MONITOR_RSSI cmd: CON_HANDLE 0x%X, RSI_TH_H 0x%X, RSI_TH_L 0x%X, RSI_TH_Lt_INV 0x%X, RSI_S_PERI 0x%X"
...
#define BRUCE_TEST_LOG5606 5606 //" (PSD)Warning!!PSD scan maybe timeout, Invalid value= 0x%x, 0x%x, 0x%x, 0x%x"
...
#define LOG_PSD_SORTING_INVALID_ARRAY_LENGTH 5636 //"(PSD) mergeSort invalid array length, left:%d, right:%d"

#define LOG_ROLE_SWITCH_CLEAN_LINK_INFO 5797 //"[LMP][ROLE_SWITCH] clean link: ce_index %d lmp_mss_state %d g_lc_scan_slot_timer_in_use %d"
#define LOG_NO_TPOLL_SUSPEND_ON_EXIT_SNIFF_WARN 5798 //"[SNIFF] Warning: no tpoll suspension on sniff exit: ce_index %d"
#define LOG_RX_INTR_DELAY_WHEN_SET_FLOW_STOP 5799 //"[RX INT] Warning: delay when set flow STOP: lut_ind 0x%x rx_end_inst %d cur_inst %d"
...
#define LEGACY_RX_INT_INFO  5802 //"[RX INT] mac_id=%d, link_type=%d, lt_addr:4/piconet_id:4/hec_error:4/crc_error:4/prev_seqn:4/seq:4/arqn:4/pkt_type:4=0x%08x, lut_index:16/rx_ch:8/tx_ch:8=0x%08x, packet_header:16/payload_header:16=0x%08x, piconet_clk=0x%x, rxfifo(acl 0x%08x sco 0x%08x), upper_lut:16/lower_lut:16=0x%08x"
#define LEGACY_IDLE_LOG 5803 //"BR/EDR status:mac_id:%d, hlc_num:%d, acl_num:%d, sniff_num:%d, esco_num:%d, status=0x%x([7:0]:is_adding_esco, [15:8]:master_link_cnt, [23:16]:device_status, [31:24]:lc_cur_dev_state), bb_link_flow_control_mask=0x%08x, bt_fw_feature=0x%x, bt_fw_feature2=0x%x, timer_isr_en.d8=0x%x, 0x32=0x%x, pn0_info=0x%x, pn1_info=0x%x, pn2_info=0x%x, pn3_info=0x%x"
...
#define MULTI_PKT_TYPE_LOG  5805 //"am_addr=%d, piconet_id=%d, lut_index=%d, ext_lower_lut_address=0x%x, ext_lut_contents=0x%x, default_pkt_type=0x%x, is_ext_lut_enable=%d, if_last_tx_nbc_timeout=%d, ptt_status=%d, pkt_type_lut=0x%x"
...
#define LEGACY_TX_INT_INFO  5809 //"[TX INT] lt_addr:4/piconet_id:4/ce_index:8(0xFF not a link)/role:4(0:m;1:s)/tx_id:4/tx_pkt_type:8=0x%08x, tx_status:16/schd_ce:4/schd_tx:4/schd2_ce:4/schd2_tx:4=0x%08x, lut_index=%d, upper_lut:16/lower_lut:16=0x%08x, piconet_clk=0x%x, txfifo(acl 0x%08x sco 0x%08x), bzdma_txmd 0x%08x"
#define SNIFF_START_INT_INFO  5810 //"[SNIFF START INT] mac_id=%d, lt_addr=%d, pid=%d, ce_index=%d, piconet_clk=0x%x, native_clk=0x%x, anchor_point=0x%x, next_next_sniff_instant=0x%x"
...
#define SETTING_FOR_HW_SNIFF_TRANSITION_MODE 5813 //"lc_start_sniff -> use_hw_sniff_trans=%d, ce_index=%d, lut_index=%d, lower_lut=0x%x, upper_lut=0x%x, tolerance=%d"
#define CLEAR_MSS_STATUS_FAIL   5814    //"!!Cannot find corresponding ce_index! bd_addr=0x%x 0x%x 0x%x 0x%x 0x%x 0x%x"
#define SNIFF_FIRST_INSTANT_INFO 5815   //"[Sniff] find first instant: cur_slot=%d, nslots2inst=%d, first_inst=%d(unit:slot), dsniff=%d, tsniff=%d(ssr_flag=%d)"
...
#define LEGACY_ESCO_TX_INT_INFO 5818 //"[TX INT] lt_addr:4/piconet_id:4/ce_index:8(0xFF not link)/role:4(0:m;1:s)/tx_id:4/tx_pkt_type:8=0x%08x, tx_status=0x%x, lut_index=%d, upper_lut:16/lower_lut:16(slave eSCO don't care)=0x%08x, piconet_clk=0x%x, txfifo(acl 0x%08x sco 0x%08x)"
...
#define RANDOM_PAGING_4 5822    //"[RANDOM_PAGING] tx_int: offset=%d, postpone_time=%d, expected_counter_in_hw_timer - native_counter=%d"
...
#define PEND_ROLE_SWITCH_DBG_2      5826    //"[PEND_ROLE_SWITCH_DBG] esco_ce_index=%d, orig_esco_next_inst=%d, next_esco_inst=%d, esco_window=%d(unit:slot), diff_inst=%d, pending_offs_slot=%d, cond_bm=0x%x"
#define PEND_ROLE_SWITCH_DBG_3      5827    //"[PEND_ROLE_SWITCH_DBG] ce_index=%d, next_sniff_inst_nat=%d, next_sniff_inst=%d, sniff_window=%d(unit:slot), diff_inst=%d, pending_offs_slot=%d, cond_bm=0x%x"
...
#define ENTER_SNIFF_TRANSITION 5830 //"[Sniff] enter sniff transition: ce_index=%d, use_hw_sniff_trans=%d, sniff_state=%d, Tpoll=%d, LR=0x%x"
#define EXIT_SNIFF_TRANSITION 5831 //"[Sniff] exit sniff transition: ce_index=%d, use_hw_sniff_trans=%d, sniff_state=%d, Tpoll=%d, LR=0x%x"
...
#define BTC_CS_CHG_INT_LOG  5852        //"[BTC_CS_IDLE] btc_cs_idle=%d, btdbg_0x2d=0x%x, wait_btc_cs_idle=%d, scan_flag=0x%x, device_status=%d, lc_cur_dev_state=%d"
#define BTC_CS_CHG_INT_LOG_WARN  5853   //"[BTC_CS_IDLE] Warning!! wait_btc_cs_idle has been set TRUE but no processed!! native_clk=0x%x, g_lc_scan_slot_timer_in_use=%d, scan_enable=%d, page_scan_count=%d, inq_scan_count=%d, scan_flag=0x%x, inq_scan_interval=0x%x, inq_scan_window=0x%x, page_scan_interval=0x%x, page_scan_window=0x%x"
#define SNIFF_FULLY_OVERLAPPED 5854 //"[Sniff] Reject fully overlapped sniff parameter: ce_index=%d, Tsniff:%d overlapped exist Tsniff %d"
#define AFH_MAP_USE_SLV_CHANNEL_CLASSIFICATION 5855 //"[AFH] num_good_channel < 20, num_slv_good_channel=%d"
#define REJECT_PAGE_SCAN_ENABLE 5856 //"Reject page scan enable: mac(%d) lc_sca_manager(master_cnt=%d slave_cnt=%d) LMP_MAX_PICONETS_SUPPORTED=%d"
#define KILL_SNIFF_SEND_SIG_FAIL    5857 //"kill sniff send sig fail: pid:%d, am_addr:%d, lc_sniff_sup_count:%d, tpoll:%d, kill_sniff_in_end_int_status:%d"
#define KILL_SNIFF_STATUS_LOG   5858 //"ce_index:%d, kill sniff status:%d"
#define SCAN_HANG_WORKAROUND_AFTER_DISC     5860    //"[SCAN HANG WORKAROUND] after disc: scatter_ctrl_reg=0x%x, pid=%d"
#define LOG_MULTI_ESCO_ALIGN_INSTANT    5861    //"[ESCO] align multiple esco instants: esco(lt_addr %d pid %d desco %d) tgt_esco(lt_addr %d pid %d tgt_ap %d tgt_desco %d) ref_inst %d"
#define NO_PERIODIC_INQUIRY_BUT_KILL    5862    //"No periodic inquiry but killed by host: lmp_mss_state=%d, "
#define LEGACY_IDLE_ACL_LINK_LOG        5863    //"ce_index=%d, am_addr=%d, pid=%d, tpoll_en=%d, tpoll=%d, susp_cnt=%d, suspension_state=%d, hw_status=0x%x, slv_tpoll_mask_reg=0x%x"
#define LEGACY_IDLE_ESCO_LINK_LOG        5864    //"esco_ce_index=%d, am_addr=%d, DeSCO=%d, TeSCO=%d, WeSCO=%d"
#define HCI_BASEBAND_CMD_PENDING_LOG    5865    //"Command opcode: 0x%x, hci_baseband_cmd_pending=%d"
#define RANDOM_PAGING_5 5866    //"[RANDOM_PAGING] timer_isr: pause once, native_clk=0x%x, native_clk_record=0x%x, native_counter=%d"
#define CHECK_AND_ENABLE_SCAN   5867    //"lc_check_and_enable_scans_in_scatternet: status=0x%x, inq_scan_status=%d, page_scan_status=%d, hlc_num=%d, lmp_mss_state=%d"
#define AVOID_TSNIFF_12N 5868 //"[SNIFF] change negotiated-tsniff: ce_index:%d, old_tsniff:0x%x, new_tsniff:0x%x, sniff_max_interval:0x%x, sniff_min_interval:0x%x"
#define OS_DELETE_TIMER_FAIL 5869 //"Warning!! OS delete timer fail, timer_id=0x%x, *timer_id=0x%x, lr:0x%x"
#define OS_START_TIMER_FAIL 5870 //"Warning!! OS start timer fail, timer_id=0x%x, lr:0x%x"
#define OS_STOP_TIMER_FAIL 5871 //"Warning!! OS stop timer fail, timer_id=0x%x, lr:0x%x"
#define OS_CHECK_TIMER_ACTIVE_FAIL 5872 //"Warning!! OS check timer active fail, timer_handle=0x%x, lr:0x%x"
#define HCI_QOS_SETUP_CMD_PARAM 5873 //"QoS cmd: ce_index=%d, service_type=%d, token_rate=%d, peak_bandwidth=%d, latency=%d, delay_variation=%d"
#define OS_TIMER_INACTIVE 5874 //"OS timer inactive, timer_id=0x%x, lr:0x%x"
#define TRIGGER_GDMA_COPY_DATA 5875 //"[RAM_MAPPING] destination=0x%x, source=0x%x, length=%d"
#define FIND_MAPPING_ADDRESS   5876 //"[RAM_MAPPING] target_buffer_ram_addr=0x%x, cur_ram_addr_mapping_entry=0x%x:0x%x(buffer:data)"
#define DUMP_PKT_1    5877    //"[DUMP_PKT] %d: 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x"
#define DUMP_PKT_2    5878    //"[DUMP_PKT] %d: 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x"
#define NO_MAPPING_DATA_RAM_ADDR 5879 //"[RAM_MAPPING] data_ram_addr == NULL: pkt_buf=0x%x"
#define DUMP_TX_PKT_INFO    5880    //"[DUMP_TX_PKT] status:%d, piconet_clk=0x%x, pkt_src=%d, pkt_len=%d, ce_index=%d, pkt=0x%x"
#define OS_CREATE_TIMER_NEW_TIMER_WRAPPER_CONTEXT_FAILED 5881 //"Warning!! OS create timer fail: no free timer wrapper context, lr:0x%x"
#define CHECK_WRONG_PKT_TYPE_FOR_FLOW_STOP 5882 //"os_check_need_flow_stop: wrong type: %d, LR=0x%x"
#define NO_CORRESPONDING_POOL_ID_EXIST 5883 //"no corresponding pool id: %d, LR=0x%x"
#define POOL_BUFFR_INIT_INFO 5884 //"spb_pool_heap_init: heap_size=%d, p_heap_start=%p, p_heap_end=%p, SPB_POOL_BUF_HDR_SIZE=%d, %d-byte align, POOL_BUFFER_MINI_SIZE=%d"
#define CHECK_NEED_FLOW_STOP 5886 //"os_check_need_flow_stop: type=%d, basic_ram_usage=%d, legacy_usage=%d, le_usage=%d, event_usage=%d"
#define CALCULATE_MAX_EXT_PLD_LEN 5887 //"lmp_get_local_max_ext_pld_len: legacy_type=%d, reg 0x%x=0x%x, extended_len=%d (unit: byte), air2mac_mac2air_latency=%d"
#define FINISH_MAX_EXT_PLD_LEN_PROCEDURE_WRONG_STATUS 5888 //"lmp_vendor_finish_set_ext_pld_len_procedure: ce_index=%d, state=%d"
#define SET_EXT_PLD_LEN 5889 //"set_self_rx_ext_pld_len_value: ext_len_br=%d, ext_len_edr=%d"
#define SET_EXT_PLD_EN  5890 //"set_ext_pld_len_enable: lut_index=%d, enable=%d"
#define DECIDE_PKT_LEN_ADD_EXT_PLD_LEN 5891 //"acl_pkt_index=%d, ce_index=%d, max_len=%d, BR_ext_len=%d, EDR_ext_len=%d, LR=0x%x"
#define UART_FLOW_CONTROL_ENABLE 5892 //"UART Flow Control enable: CTS_pin=%d, RTS_pin=%d"
#define CHECK_NEED_FLOW_STOP_C2H_NODE  5893 //"os_check_need_flow_stop type=%d, c2h node avail cnt=%d"
#define VHCI_NODE_COUNTER_ERROR        5894 //"error! free vhci c2h node but vhci_c2h_counter is already 0"

#define OS_SEND_SIG_GENERIC_FAIL    5899  //"send_signal_generic fail: type:%d, task_handle=%d, LR=0x%x"
#define OS_SEND_SIG_CALLBACK2_FAIL  5900  //"send_signal_callback2 fail: type:%d, task_handle=%d, callback=%p, param1=0x%08x, param2=0x%08x, LR=0x%x"
#define OS_SEND_SIG_CALLBACK2_FAIL2 5901  //"send_signal_callback2 fail: type:%d, task_handle=%d, callback=%p, LR=0x%x"
#define POOL_BUFFER_CREATE_ERROR_1 5902 //"spb_pool_create_intern: LR 0x%x invalid buf size %u, buf count %u"
#define POOL_BUFFER_CREATE_ERROR_2 5903 //"spb_pool_create_intern: LR 0x%x pool table overflow"
#define POOL_BUFFER_GET_ERROR_1 5904 //"spb_buffer_get_intern: LR 0x%x invalid handle %u"
#define POOL_BUFFER_GET_ERROR_2 5905 //"spb_buffer_get_intern: LR 0x%x pool %u not created"
#define POOL_BUFFER_GET_ERROR_3 5906 //"spb_buffer_get_intern: LR 0x%x no buf in size %u"
#define POOL_BUFFER_GET_ERROR_4 5907 //"spb_buffer_get_intern: LR 0x%x invalid buf size %u pool_heap_size_unused %u"
#define POOL_BUFFER_GET_ERROR_5 5908 //"spb_buffer_get_intern: LR 0x%x no block for buf size %d"
#define POOL_BUFFER_GET_INFO_1 5909 //"spb_buffer_get_intern: malloc info LR 0x%x handle %u, size %u, buf %p, buf_num_used %d, spb_pool_heap_size_unused %d"
#define POOL_BUFFER_PUT_ERROR_1 5910 //"spb_buffer_put_intern: LR 0x%x invalid buf %p"
#define POOL_BUFFER_PUT_ERROR_2 5911 //"spb_buffer_put_intern: invalid buf %p exceed pool boundary start %p, end %p"
#define POOL_BUFFER_PUT_ERROR_3 5912 //"spb_buffer_put_intern: LR 0x%x invalid handle %d"
#define POOL_BUFFER_PUT_ERROR_4 5913 //"spb_buffer_put_intern: LR 0x%x dobule free buf %p"
#define POOL_BUFFER_PUT_INFO_1 5914 //"spb_buffer_put_intern: free info LR 0x%x handle %u, size %u, buf %p, buf_num_used %d, spb_pool_heap_size_unused %d"
#define POOL_BUFFER_DUMP_INFO_1 5915 //"pool heap size %u, curr unused size %u, unused low watermark %u, total pool num %u"
#define POOL_BUFFER_DUMP_INFO_2 5916 //"pool id %u, flags 0x%04x, buf size %u, buf max num %u, buf used num %u, alignment %u"
#define POOL_BUFFER_DUMP_INFO_3 5917 //"Pool heap free list: hdr %p, next %p, size %u, id %u, flags 0x%01x"
#define GET_PKT_SIZE_WRONG_POOL_ID 5918 //"btc_get_packet_size_internal: pool_id == OS_INVALID_HANDLE, LR=0x%x"
#define POOL_DELETE_ERROR 5919 //"pool delete fail: pool_id=%d, cur_pool_cnt=%d"
#define FREE_BUFFER_NO_POOL 5920 //"Free memory because no pool exist, p_pool_start_origin=0x%x"
#define GET_PAYLOAD_MAX_SIZE_WRONG_POOL_ID 5921 //"btc_get_packet_size_internal: pool_id == OS_INVALID_HANDLE, LR=0x%x"
#define GENERAL_POOL_CREATE_FAIL 5922 //"general_data_pool_id create pool fail"
#define POOL_BUF_LIST_LOG 5923 //"pool buf list: pool id %u, flags 0x%04x, buf size %u, p_buf_entry 0x%x"
#define POOL_DELETE 5924    //"pool id %u is deleted"
#define EXT_ADV_DATA_POOL_CREATE_FAIL 5925 //"ext_adv_data_pool_id create pool fail"
#define SPB_POOL_INVALID_HANDLE_LOG 5926 //"Invalid pool handle %d, LR=0x%x"
#define ACL_H2C_POOL_CREATE_FAIL 5927 //"acl_h2c_ws_pool_id create pool fail"
#define ACL_C2H_POOL_CREATE_FAIL 5928 //"acl_c2h_ws_pool_id create pool fail"
#define SYNC_C2H_POOL_CREATE_FAIL 5929 //"sync_c2h_ws_pool_id create pool fail"
#define HCI_IPC_HANDLE_EVT_IN_HOST 5930 //"[HCI_IPC]WARNING!,Handle EVENT from Host, illegal"
#define HCI_IPC_DUMP_C2H_SEND_INFO 5931 //"[HCI_IPC] Dump C2H Send info, pkt_type:%04x len:%d, ch_type:%04x,  %08x-%08x-%08x-%08x-%08x"
#define HCI_IPC_HANDLE_HOST_CMD_PKT 5932 //"[HCI_IPC] Handle Host CMD packet, pkt_type:%04x, cmd_op:%04x, length:%d,  %08x-%08x-%08x-%08x-%08x"
#define HCI_IPC_HANDLE_HOST_ACL_PKT 5933 //"[HCI_IPC] Handle ACL Data packet, pkt_type:%04x, Conn_handle:%04x, length:%d, size:%d, pkt_len:%d  %08x-%08x-%08x-%08x-%08x"
#define HCI_IPC_HANDLE_HOST_SCO_PKT 5934 //"[HCI_IPC] Handle SCO Data packet, pkt_type:%04x, Conn_handle:%04x, length:%d, size:%d, pkt_len:%d  %08x-%08x-%08x-%08x-%08x"
#define HCI_IPC_HANDLE_HOST_ACL_PKT_PEEK 5935 //"[HCI_IPC] Handle ACL data peek, offset:%d, raw_u32:0x%08x, conn_handle:%04x"
...
#define CCH_DBG_131 6131 //"Adjust sniff param for CIS, attemp: %d, timeout: %d"
...
#define CCH_DBG_167 6167 //"[SC] Set eSCO daycounter = 0x%x"
...
#define CCH_LPS_006 6306 //"Fatal. BB write in deep sleep mode. Reg:0x%x.Val:0x%x. cnt:%d"
...
#define MP_VERSION_INFO_EVENT_NOT_HANDLE 6406 //"[MP] version info subcmd not handle: %d"
#define MP_DEBUG_LOG1 6407  //"[MP_DBG] hci_handle_mp_cmd: use_mp_new_cmd: %d, opcode=0x%x, param_len=%d, param[0]=0x%x, param[1]=0x%x, param[2]=0x%x, param[3]=0x%x"
#define MP_DEBUG_LOG2 6408  //"[MP_DBG] hci_handle_mp_general_event: use_mp_new_cmd: %d, opcode=0x%x, param_len=%d, cmd_status=0x%x, param[4]=0x%x, param[5]=0x%x, param[6]=0x%x, param[7]=0x%x, ret=%d (0: not handled by mp function)"
...
#define BRUCE_TEST_LOG_14 7004 //"BRUCE_test_log_14: 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x"
...
#define ESCO_RX_FIFO_OVER_FLUSH 7020//"[BZDMA] warning!! eSCO FIFO over flush, fifo_num = 0x%x, pkt_length = 0x%x, fifo_addr = 0x%x, fifo_data_length = 0x%x"
...
#define MSG_OS_WRAPPER_SEND_SIGNAL_FAIL 8884 //"[OS] Warning: failed to send a signal (type %d param 0x%x ext_param 0x%x) to task(task_id %d): LR 0x%x"
#define MSG_OS_WRAPPER_SEND_SIGNAL_TO_HEAD_FAIL 8885 //"[OS] Warning: failed to send a signal (type %d param 0x%x ext_param 0x%x) to task(task_id %d) head: LR 0x%x"
...
#define DMA_UART_013 9013 //"<DMA UART> goto_check_default_flag = %d, goto_LPS_mode_flag = %d, g_hci_uart_baud_default_en = %d, baudrate = 0x%.8x "
...
#define PSD_LOG_003 9252  //"PSD Calibration mode without psd modem enable"
#define CH_MAP_UNIT_LOG_001 9253  //"[WARNING] !!! lmp_init_assessment_at_connection find min_count_down_value: 0xff "
#define PSD_ERROR_SCAN_MODE 9254  //"[PSD] Error PSD scan type: %d"
#define PSD_INCOMPATIBLE_SCAN_MODE_WITH_QUATER_MODE 9255  //"[PSD] Incompatible PSD scan type: %d, slot mode: %d"
...
#define LPS_LOG_024 9324 //"[PM] !**enter lc_program_lps_mode but task_id_bm = 0x%x with signals pended in queue"
...
#define MDM_LOG_082 9582 //"<MODEM DEBUG> debug_array=0x%x, size=%d"
...
#define SECURE_CONN_LOG3 9603 //"[SC] [clk0x%08x] 7th MIC Error!! Disconnect!!"
...
#define SECURE_CONN_LOG8 9609 //"[SC_RX_INFO] pid:4/addr:4/ce_index:4/mic_err_cnt:4 = 0x%08X  Tx(Msb0x%X Lsb0x%X) Rx(Msb0x%x Lsb0x%X) DayCounter%X, seqn_old %d"

#define APCF_DELETE_TIMER_FAIL 9700 //"warning!!! APCF delete timer fail , tracker index : %x filter index : %x"
#define APCF_ON_FOUND_MODE_CREATE_TIMER_FAIL 9701 //"warning!!!! APCF create timer fail, tracker index : %x filter index : %x"
#define APCF_FREE_ON_FOUND_TRACKER_ERROR 9702 //"ERROR!!! APCF onfound tracker free error , tracker index : %x"
#define APCF_ON_FOUND_NO_FREE_ENTRY 9703 //"ERROR!!! APCF onfound tracker no free entry , filter index : %x"
#define APCF_NEED_NEW_APCF_ENTRY 9704 //"APCF reg new tracker entry"
#define APCF_ON_LOST_LOG 9705 //"APCF on lost , tracker index : %x "

// ============= PCM =============
#define PCM_LOG_LB_START                        9761 //"[PCM] PCM Loopback Start"
#define PCM_LOG_LB_FAIL                         9762 //"[PCM] PCM Loopback Compare Fail, read data: 0x%04x; expected data: 0x%04x;"
#define PCM_LOG_MSBC_SPEC_FAIL                  9763 //"[PCM] PCM MSBC Spec Violation"
#define PCM_LOG_CONFIG_FAIL                     9764 //"[PCM] PCM Config Setting Fail"
#define PCM_LOG_CONFIG_8K_8K_CVSD_TRANSPARENT   9765 //"[PCM] PCM Config Setting: PCM 8K + No Convert + CVSD + Transparent"
#define PCM_LOG_CONFIG_16K_8K_CVSD_TRANSPARENT  9766 //"[PCM] PCM Config Setting: PCM 16K + 16K to 8K Convert + CVSD + Transparent"
#define PCM_LOG_CONFIG_8K_8K_CVSD_CODEC         9767 //"[PCM] PCM Config Setting: PCM 8K + No Convert + CVSD + Codec"
#define PCM_LOG_CONFIG_16K_8K_CVSD_CODEC        9768 //"[PCM] PCM Config Setting: PCM 16K + 16K to 8K Convert + CVSD + Codec"
#define PCM_LOG_CONFIG_16K_16K_CVSD_TRANSPARENT 9769 //"[PCM] PCM Config Setting: PCM 16K + No Convert + CVSD + Transparent"
#define PCM_LOG_CONFIG_16K_16K_CVSD_CODEC       9770 //"[PCM] PCM Config Setting: PCM 16K + No Convert + CVSD + Codec"
#define PCM_LOG_CONFIG_16K_16K_MSBC_TRANSPARENT 9771 //"[PCM] PCM Config Setting: PCM 16K + No Convert + MSBC + Transparent"
#define PCM_LOG_CONFIG_8K_16K_MSBC_TRANSPARENT  9772 //"[PCM] PCM Config Setting: PCM 8K + 8K to 16K Convert + MSBC + Transparent"
#define PCM_LOG_CONFIG_16K_16K_MSBC_CODEC       9773 //"[PCM] PCM Config Setting: PCM 16K + No Convert + MSBC + Codec"
#define PCM_LOG_CONFIG_8K_16K_MSBC_CODEC        9774 //"[PCM] PCM Config Setting: PCM 8K + 8K to 16K Convert + MSBC + Codec"
#define PCM_LOG_CONFIG_8K_8K_MSBC_TRANSPARENT   9775 //"[PCM] PCM Config Setting: PCM 8K + No Convert + MSBC + Transparent"
#define PCM_LOG_CONFIG_8K_8K_MSBC_CODEC         9776 //"[PCM] PCM Config Setting: PCM 8K + No Convert + MSBC + Codec"
...
#define LC_ESCO_LINKS_CODEC  9803  //"lc_make_esco_connection, ESCO_index = %d, esco_ch_id = %d, air_mode = %d, PCM_CODEC_type = %d, En_8bit = %d"
...
#define LC_ESCO_DATA_PKT_Q 9824 //"esco_data_q_ptr->esco_data_pkt_Q: 0x%x 0x%x 0x%x 0x%x, 0x%x 0x%x 0x%x 0x%x"
#define LOG_LC_KILL_INQ_SCAN_ON_SCAN_END_INTR 9825 //"Kill inq scan on scan end intr: scan_flag=0x%x"
#define LOG_LC_KILL_PAGE_SCAN_ON_SCAN_END_INTR 9826 //"Kill page scan on scan end intr: scan_flag=0x%x"
...
#define MSG_HCI_VENDOR_CMDS_SET_BT_FW_FEATURE3 9860 //"Vendor cmd(0xFC6E, sub:13) feature_map = 0x%x"
#define MSG_HCI_VENDOR_CMDS_INTEGRATED_INIT_FAIL 9861 //"Vendor cmd(0xFDA5, sub:4) error_status = 0x%x"
#define MSG_HCI_VENDOR_CMDS_SET_BT_FW_FEATURE4 9862 //"Vendor cmd(0xFC6E, sub:14) feature_map = 0x%x"
#define MSG_HCI_VENDOR_CMD_SET_LE_LR_ADV_STATE 9863 //"Vendor Cmd (0xFC73) set LE LR adv state: 0x%x(adv:BIT0, init:BIT1, scan:BIT2), phy_bm:0x%x, ci:%d"
#define MSG_HCI_VENDOR_CMDS_SET_EXT_PHY_FEATURE_MAP 9864 //"Vendor cmd(0xFD80, sub:40) ext phy feature_map = 0x%x"

#define PAGE_SCAN_HLC_ISR_BEFORE_FHS_PARSING    9865 //"[Page scan] hlc intr before parsing fhs, pid: %d"
#define PAGE_SCAN_HLC_ISR_BEFORE_FHS_PARSING_2  9866 //"[Page scan] hlc intr before parsing fhs, hlc task, hw pid:%d, fw pid: %d"
...
#define PHY_LOG_ERROR_MODULATION  10042 //"[PHY] Error modulation scheme: %d, LR=0x%x"
#define PHY_LOG_RF_INIT_ERROR   10043 //"[PHY] RF Init Error!!"
#define PHY_LOG_ERROR_PHY_RATE  10044 //"[PHY] Error phy rate: %d, LR=0x%x"
#define PHY_TXGAIN_UPDATE_1 10045   //"[TXGAIN_UPDATE] LE ADV: rf_mode: %d, 0x%x=0x%x"
#define PHY_TXGAIN_UPDATE_2 10046   //"[TXGAIN_UPDATE] LE 1M/2M 2402/2480: rf_mode: %d, 0x%x=0x%x, 0x%x=0x%x, 0x%x=0x%x, 0x%x=0x%x"
#define PHY_TXGAIN_UPDATE_3 10047   //"[TXGAIN_UPDATE] LE Link: entry: %d, rf_mode: %d, phy_rate: %d, txgain_index=0x%x"
#define PHY_TXGAIN_UPDATE_4 10048   //"[TXGAIN_UPDATE] LE CIS: cis_uid: %d, cig_uid: %d, le_entry_id: %d, cis_uid_en_map=0x%x, txgain_index=0x%x"
#define PHY_TXGAIN_UPDATE_5 10049   //"[TXGAIN_UPDATE] LE BIS: bis_uid: %d, big_uid: %d, bis_uid_en_map=0x%x, rf_mode: %d, phy_rate: %d, txgain_index=0x%x"
#define PHY_TXGAIN_UPDATE_6 10050   //"[TXGAIN_UPDATE] LE Link Power Control: rf_mode: %d, phy_rate: %d, send_pwr_chg_ind: %d, tx_power_default=%d, tx_power_max=%d, tx_power_min=%d, entry: %d, tx_power_cur=%d, actual_tx_power=%d, tx_gain_index_cur=0x%x"
#define PHY_TXGAIN_UPDATE_7 10051   //"[TXGAIN_UPDATE] Legacy update txgain_index table: 0x%x=0x%x"
#define PHY_TXGAIN_UPDATE_8 10052   //"[TXGAIN_UPDATE] Legacy expected txgain_index table: rf_mode: %d, %dM: 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x"
#define LEGACY_GET_TXGAIN_INDEX_FAIL 10053 //"[Legacy] Get txgain index fail: rf_mode:%d, %dM, step:%d, reg_LR=0x%x"
#define LE_GET_OUTPUT_POWER_FAIL  10054   //"[LE] Get output power fail: rf_mode:%d, txgain_type:%d, request_type:%d"

// LE Proprietary 4M
#define LL_MSG_INVALID_LL_BM_PHY 10055  //"Error!! invalid ll_bm_phy:0x%x (BIT0:1M; 1:2M; 2:Coded, 7:LE Proprietary 4M)"
#define LE_4M_DBG_PHY_UPDT_DUMP_REG 10056 //"[LE 4M DBG] phy upd ent:%d, t0:0x%x, t1:0x%x, t2:0x%x, t3:0x%x, t4:0x%x, t5:0x%x, t6:0x%x, t7:0x%x, r0:0x%x, t12:0x%x, t13:0x%x, t14:0x%x"

#define LEGACY_LOG1 10101 //"ce_index=%d, lmp_opc/ext_opc=%d/%d super_state=0x%x, sub_state=0x%x, lk_type=0x%x, enc_mode=%d, auto_epr_time_count=%d, txn_params.auth_role=%d, txn_params.lk_type=0x%x"
...
#define LEGACY_LOG15 10115 //"[PAGE_SCAN] page_scan_timer in use: instr_status 0x%04x"
...
#define LEGACY_LOG55 10155 //"[LMP][ROLE_SWITCH] Warning: reject role switch req: ce_index %d status %d err_case %d"
...
#define LEGACY_LOG64 10164 //"[PSD Legacy] afh_ch_num: %d, max_mean: %d, less_psd_thd_ch_num: %d, rssi_dB: %d"
#define LEGACY_LOG65 10165 //"[PSD LE] afh_ch_num: %d, max_mean: %d, less_psd_thd_ch_num: %d, rssi_dB: %d"
#define LEGACY_LOG66 10166 //"Disallow set BD_ADDR because we are master in piconet"
...
#define LEGACY_LOG69 10169 //"Ignore remote preferred rate because there is no intersection with support feature, edr_data_rate=%d, feature_page0[3]=0x%x"
#define LEGACY_LOG70 10170 //"Set piconet info register with invalid piconet id %d, LR=0x%x"
...
#define LEGACY_LOG73 10173 //"Page scan timer cb: inst_status=0x%x 0x%x, scan_flag=0x%x, inq_scan_cnt=%d, page_scan_cnt=%d, scan_window_reg=0x%x 0x%x"
#define LEGACY_LOG74 10174 //"Inq scan timer cb:  inst_status=0x%x 0x%x, scan_flag=0x%x, inq_scan_cnt=%d, page_scan_cnt=%d, scan_window_reg=0x%x 0x%x"
...
#define LEGACY_LOG79 10179 //"Scan Info: inq_scan_cnt %d page_scan_cnt %d enable %d scan_slot_timer_in_use %d"
#define SET_AFH_OFFSET_LOG 10180 //"[SET AFH INSTANT] ce_index: %d, instant 0x%x"
#define PSD_DETAIL_LOG  10181 //"[PSD] rank(%d) %d, %d, %d, %d, %d, %d, %d, %d, %d, %d"
#define PSD_DETAIL_LOG2 10182 //"[PSD] comp and smooth conv psd %d %d, %d, %d, %d, %d, %d, %d, %d, %d, %d"
#define PSD_DETAIL_LOG3  10183 //"[PSD] intr raw psd  %d %d %d %d %d %d %d %d %d %d %d"
#define PAGE_TIMEOUT_INFO   10184   //"temp_page_to=%d (unit: slot)"
#define PAGE_TRAIN_INFO     10185   //"train_pair=0x%x, elapsed_time=0x%x, change_train=%d, use_k_nudge=%d, reg_val=0x%x"
#define LINK_ALLOW_PKT_STATUS 10186 //"lc_update_pkts_allowed: ce_index=%d, pkt_allow_status=0x%x, lcl_pkt_type=0x%x, pref_pkt_type=0x%x, ptt_status=%d, LR=0x%x"
#define PSD_DETAIL_LOG4  10187 //"[PSD] cur avg psd without comp  %d %d %d %d %d %d %d %d %d %d %d"
#define LEGACY_OTP_CONFIG_LOG  10188 //"[LEGACY] Configurable Setting: max active conn: %d, max piconet: %d, max sco conn: %d, max esco conn: %d, max bc conn: %d"
#define PKT_CONFIG_PKT_CNTS1 10189 //"[PKT_CONFIG] max_acl_tx_pkt_cnts=%d, max_acl_rx_pkt_cnts=%d, max_lmp_pkt_cnts=%d, max_event_pkt_cnts=%d, max_fhs_pkt_cnts=%d, max_le_acl_tx_pkt_cnts=%d, max_le_acl_rx_pkt_cnts=%d, max_le_pdu_pkt_cnts=%d"
#define PKT_CONFIG_PKT_CNTS2 10190 //"[PKT_CONFIG] max_sco_tx_pkt_cnts=%d, max_sco_rx_pkt_cnts=%d, acl_rx_flow_stop_threshold_pkt_cnts=%d, le_acl_rx_flow_stop_threshold_pkt_cnts=%d, max_hci_cmd_pkt_cnts=%d, max_iso_tx_pkt_cnts=%d, max_iso_rx_pkt_cnts=%d"
#define PKT_CONFIG_PKT_PAYLOAD_SIZE 10191 //"[PKT_CONFIG] max_sco_tx_payload_size=%d, max_sco_rx_payload_size=%d, max_acl_tx_payload_size=%d, max_acl_rx_payload_size=%d, max_le_acl_tx_payload_size=%d, max_le_acl_rx_payload_size=%d, max_iso_tx_payload_size=%d, max_iso_rx_payload_size=%d"
#define PKT_CONFIG_PKT_PACKET_SIZE 10192 //"[PKT_CONFIG] max_sco_tx_pkt_size=%d, max_sco_rx_pkt_size=%d, max_acl_tx_pkt_size=%d, max_acl_rx_pkt_size=%d, max_le_acl_tx_pkt_size=%d, max_le_acl_rx_pkt_size=%d, max_iso_tx_pkt_size=%d, max_iso_rx_pkt_size=%d"
#define HCI_TD_TX_COMPLETE 10193 //"hci_td_tx_complete: pkt_type=%d, free pkt buffer=0x%x"
#define HCI_TD_C2H_SEND_PACKET 10194 //"hci_td_c2h_send_packet: pkt_type=%d, pkt buffer=0x%x, len=%d"
#define HCI_TD_HANDLE_RECEIVED_PACKET 10195 //"hci_td_handle_received_packet: pkt_type=%d, pkt buffer=0x%x, len=%d"
#define HCI_TD_H2C_FREE_PACKET 10196 //"hci_td_h2c_free_packet: pkt_type=%d, free pkt buffer=0x%x"
#define DUMP_FREE_OS_STACK 10197  //"[OS] Dump OS stack: current_free_num: %d, 0x%x 0x%x 0x%x 0x%x, 0x%x 0x%x 0x%x 0x%x, 0x%x 0x%x 0x%x 0x%x"
#define DUMP_FREE_OS_STACK_NULL 10198  //"[OS] OS stack is NULL!"
#define PEEK_OS_BUFFER 10199 //"[OS] Get all free buffer of pool_id=%d, OS_MAX_POOLS=%d"
#define BLUEWIZ_REGISTER_STORE_FAIL 10200 //"bluewiz register hw backup fail !!"
#define BLUEWIZ_REGISTER_RESTORE_FAIL 10201 //"bluewiz register hw restore fail !!"
#define BB_START_STOP_TX_RX 10202 //"[BB] Start/Stop TxRx: %d, Force: %d"
#define BB_FALED_TO_CHECK_RX_FIFO 10203 //"[RX FIFO] Failed to check Rx FIFO: 0x%08X!"
#define PHY_RF_START_SCUESSS 10204 //"[RF OFF] Scceess/Failed:%d to reopen RF! Reason: State:%d RF_ON ongoing:%d state:0x%08X rest buffer:%d"
#define PAGE_SCAN_PEND_BASEBAND_CMD_LOG 10205 //"Re-handle baseband cmd in page scan, opcode: 0x%x"
#define LE_HANDLE_FEATURE_EXT_REQ 10206    //"llc_handle_ll_feature_ext_req: allocate feature page fail: %d, page_num=%d, remote_max_page=%d"
#define LE_HANDLE_FEATURE_EXT_RSP 10207    //"llc_handle_ll_feature_ext_rsp: allocate feature page fail: %d, page_num=%d, remote_max_page=%d"
#define LEGACY_LOG80 10208 //"Get piconet info register with invalid piconet id %d, LR=0x%x"
...
#define HCI_VENDOR_EVENT_UNHANDLE 10302 //"hci_vendor_generate_command_complete_event: Unhandle hci_cmd_opcode=0x%x, cmd_status=0x%x"
#define HCI_VENDOR_COMMAND_UNHANDLE 10303 //"hci_handle_vendor_cmds: Unhandle hci_cmd_opcode=0x%x"
...
#define LE_LOG9 10509 //"Wake from slv latency because rx data pkt: entry_id 0x%x"
...
#define LE_MSG_PRIVACY_CAL_RPA_LOG        10521 //"[LL][Privacy]: ll_driver_cal_rpa, rpa_idx = %d, random_num = 0x%x, local_rpa_res = 0x%x, local_rpa[0] = 0x%x, local_rpa[1] = 0x%x, local_rpa[2] = 0x%x"
...
#define ARBIT_PRE_ENTRY_ANCHOR_SHIFT   10524 //"[ARBITRATION] pre_entry anchor point shift, anchor shift: 0x%x"
#define SNIFF_END_INTR_LOG   10525 //"[SNIFF END INT] mac_id=%d, lt_addr=%d, pid=%d, ce_index=0x%x, piconet_clk=0x%x, native_clk=0x%x, sniff count:%d sup_count:%d"
#define LE_OTP_CONFIG_LOG               10526 //"[LE] Configurable Setting: ADV task/ADV data/SCAN task:(0x%06x), PA(%d):0x%x, master/slave:(0x%04x), ISO(%d):CIG/CIS/BIG/BIS:(0x%08x), resolving/white/black/PA list:(0x%08x)"
#define LE_MSG_UPDATE_SCAN_INIT_WINDOW  10527 //"[LL] Update SCAN/INIT max window, param:0x%x, SCAN %d -> %d slots, INIT %d -> %d slots."
#define LE_UPDATE_LOCAL_SCA       10528    //"[Local SCA update] LE from %d to %d"
#define LEGACY_UPDATE_LOCAL_SCA   10529    //"[Local SCA update] Legacy from %d to %d"

//le btc audio
#define LE_PA_ADV_CLK_STRANGE           10530    //"[clk1 %08X]<PA ADV> Warning!! PA event end timing strange. CAM 0x%04x"
#define LE_BTC_PA_DBG                   10531    //"PA entry:%d, ap:0x%x, offset:%d, interval:%d, rsv_slot:%d"
#define LE_BTC_PA_REG                   10532    //"PA register btc entry:%d"
#define LE_BTC_PA_UNREG                 10533    //"PA unregister btc entry:%d"
#define LE_BTC_BIS_DBG                  10534    //"BIS entry:%d, iter:%d, ap:0x%x, offset:%d, interval:%d, rsv_slot:%d"
#define LE_BTC_BIS_REG                  10535    //"BIS register btc entry:%d"
#define LE_BTC_BIS_UNREG                10536    //"BIS unregister btc entry:%d"
#define LE_BTC_CIS_DBG                  10537    //"CIS entry:%d, iter:%d, ap:0x%x, offset:%d, interval:%d, rsv_slot:%d"
#define LE_BTC_CIS_REG                  10538    //"CIS register btc entry:%d"
#define LE_BTC_CIS_UNREG                10539    //"CIS unregister btc entry:%d"
...
#define LE_UPDT_IDLE_ZONE               11500    //"[LE_IDZ] Update mgr:0x%x, inst:0x%x, window:0x%x, entry:%d, priority:%d, action:%d, cur_entry:%d, round:%d, state:0x%x, cur_clk:0x%x"
#define LE_CANCEL_IDLE_ZONE             11501    //"[LE_IDZ] Cancel mgr:0x%x, inst:0x%x, entry:%d, round:%d, cancel_inst:0x%x, cur_clk:0x%x, force_cancel:%d"
#define LE_CANCEL_IDLE_ZONE_CHECK       11502    //"[LE_IDZ] Cancel chk entry:%d, mgr_entry:%d, idle:%d, round:%d"
#define LE_UPDT_IDLE_ZONE_FAIL          11503    //"[LE_IDZ] !!!!!ERROR Update round:%d"
...
#define PTA_COEX_INFO_WITH_REASON     12064 //"<Bt Coex Info> LowByte = 0x%08x , HighByte = 0x%08x, Report Reason: 0x%08x"
...
#define LOG_BTMAC_PM_EXIT               13024 //"[PM] !**btmac exit: mac_id:%d, native_clk = 0x%x, native_cnt = %d"
...
#define LOG_BTMAC_PM_CHECK              13027 //"[PM] !**btmac check: native_us = %d, native_clk = 0x%x, nxt_status = %d, nxt_status_le = %d, nxt_clock_slot = 0x%x, nxt_clock_slot_le = 0x%x, wakeup_time_diff = %d, wakeup_time_diff_le = %d, unit_wakeup_time_diff = %d"
#define LOG_BTMAC_PM_ENTER              13028 //"[PM] !**btmac enter: native_clk = 0x%x, native_cnt = %d, wakeup_inst_slot = %d, wakeup_inst_us = %d"
#define LOG_BTMAC_PM_CHECK_FAIL         13029 //"[PM] !**btmac check fail: Error bitmap=0x%x"
#define LOG_BTMAC_PM_CHECK_FAIL2        13030 //"[PM] !**btmac check fail: Error bitmap=0x%x, native_clk=0x%x, nxt_clock_slot=0x%x, nxt_clock_slot_le=0x%x, minimum_sleep_time=%d, unit_wakeup_time_diff=0x%x"
#define LOG_MAC0_1_PM_CHECK_FAIL        13031 //"[PM] !**mac%d check fail: Error bitmap=0x%x"
#define LOG_MAC0_1_PM_CHECK             13032 //"[PM] !**mac%d check: rtc_clk = 0x%x, native_clk = 0x%x, native_cnt = %d, unit_wakeup_time_diff = 0x%x"
#define LOG_MAC0_1_PM_STATISTIC         13033 //"[PM] !**mac%d #%d: [%d] Wakeup Time: %d us Sleep Time: %d us (%d %d) Wakeup at: 0x%x %d Sleep at: 0x%x %d"
#define LOG_MAC0_1_PM_STAGE_TIME        13034 //"[PM] !**mac%d stage time: Check: %d, Store: %d, Enter: %d, Exit: %d, Restore: %d"
#define LOG_MAC0_1_PM_ENTER             13035 //"[PM] !**mac%d enter: rtc_clk = 0x%x, native_clk = 0x%x, native_cnt = %d"
#define LOG_MAC0_1_PM_EXIT              13036 //"[PM] !**mac%d exit: rtc_clk = 0x%x, native_clk = 0x%x, native_cnt = %d"
#define LOG_GENERAL_MAC_PM_CHECK        13037 //"[PM] !**general mac check: rtc_clk = 0x%x, unit_wakeup_time_diff = 0x%x"
#define LOG_GENERAL_MAC_PM_STATISTIC    13038 //"[PM] !**general mac #%d: [%d] Wakeup Time: %d us Sleep Time: %d us, Wakeup at: 0x%x Sleep at: 0x%x"
#define LOG_GENERAL_MAC_PM_STAGE_TIME   13039 //"[PM] !**general mac stage time: Check: %d, Store: %d, Enter: %d, Exit: %d, Restore: %d"
#define LOG_GENERAL_MAC_PM_ENTER        13040 //"[PM] !**general mac enter: rtc_clk = 0x%x, wakeup_inst_slot = %d, wakeup_inst_us = %d"
#define LOG_GENERAL_MAC_PM_EXIT         13041 //"[PM] !**general mac exit: rtc_clk = 0x%x"
#define LOG_WRITE_REG_IN_SLEEP_MODE_WARNING 13042 //"[PM] WARNING !!! mac%d write register in sleep mode" offset:0x%x, val:0x%x, cnt:%d"
#define LOG_BT_PM_CHECK                 13043 //"[PM] !**bt%d check: rtc_clk = 0x%x, native_clk = 0x%x, native_cnt = %d, unit_wakeup_time_diff = 0x%x, err_code: 0x%x"
#define RESTORE_UPDATE_INSTANT_PASSED   13044 //"Error restoring update cmd %d(1:conn, 2:chmap, 3:phy), instant passed, mac_id: %d, entry: %d, sched_inst: %d, cur_inst: %d"

#define LOG_ENTER_LPM_MODE 13050 //"======== Enter LPM Mode !!! ========"
#define LOG_ENTER_NORMAL_MODE 13051 //"======== Enter NORMAL Mode !!! ========"
#define LOG_WRITE_SAMSUNG_FLASH_DEBUG_MODE 13052 //"[LPM] ImageID::%x header_start_offset:%x patch_start_offset:%x patch_len:%x header_crc:%x"
...
#define DU_RX_CMD_ERROR                 14004 //"[hciapi_data_received] Rcv Cmd Error!!!!!!! Packet length (%d) > Rx Data length (%d)"
#define DU_RX_ACL_ERROR                 14005 //"[hciapi_data_received] Rcv ACL Data Error!! Packet length (%d) > Rx Data length (%d), type:%d"
#define DU_NOT_SUP_SCO                  14006 //"Do not support SCO!!"
#define DU_TYPE_ERROR                   14007 //"hciapi_data_received type error:%d"
...
#define TD_DU_RX                        14012 //"[hciapi_data_received] pkt_type:%d, rx_data_len:%d (Include pkt_type and HCI pkt header), rx_read_index:0x%x, cmd_tx_index=%d, acl_tx_index=%d, le_acl_tx_index=%d, le_iso_tx_index=%d, sco_tx_index=%d"
#define LOG_IMG_CHECK_ERROR             14013 //"IMG ERR, id: 0x%x, err: 0x%x"
#define DU_RX_SYNC_ERROR                14014 //"[hciapi_data_received] Rcv SYNC Data Error!! Packet length (%d) > Rx Data length (%d)"
#define TD_DU_RX_2                      14015 //"[hciapi_uart_rx_data_length_update] cur_rx_offset=%d, hci_td_du_com_uart: rx_offset=%d, rx_data_len=%d, rx_write_index=%d, rx_read_index=%d"
#define TD_DU_RX_3                      14016 //"[hciapi_data_received] rx_data_len=%d, start from rx_read_index=%d, rx_buffer: 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x"
#define TD_DU_RX_4                      14017 //"[hciapi_data_received] rx_data_len=%d > 6, dump tail of rx_buffer from rx_read_index=%d, rx_buffer: 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x"

// ============= Audio offload =============
#define AUDOL_ALLOCATE_BUFFER_FAIL             14500 //"[AUDOL] Allocate buffer failed, allocate index: %d"
#define AUDOL_NO_FREE_ACL_PKT                  14501 //"[AUDOL] Get ACL packet failed, all packets have been occupied"
#define AUDOL_CANNOT_START_PROCESSING_COPY_REQ 14502 //"[AUDOL] Error. Cannot start processing copy requests"
#define AUDOL_FETCH_EMPTY_COPY_REQ             14503 //"[AUDOL] Warning. Cannot fetch any copy request in LC_PROCESS_AUDOL_COPY_REQ task"
#define AUDOL_NOT_SUPPORT_LE_COPY_REQ          14504 //"[AUDOL] Error. Lowerstack still not supports LE audio offload"
#define AUDOL_INVALID_CONNECTION_HANDLE        14505 //"[AUDOL] Error. Invalid connection handle: 0x%X"
#define AUDOL_CONFIG_A2DP                      14506 //"[AUDOL] A2DP config handle: 0x%X, codec: %d, copy_m(0 cpu, 1 dma): %d, l2cap_cid: 0x%X, mtu_size: %d"
#define AUDOL_METRICS                          14507 //"[AUDOL] is_processing: %d, copy_req_cnt: %u, copy_req enq fail cnt: %u, processed_frame: %u, processed_fail: %u, enq hci data cnt: %u, free hci data cnt: %u"
#define AUDOL_PUSH_ACL_PKT_IN_Q                14508 //"Push ACL in Q pkt: 0x%X, ws: 0x%X, next: 0x%X"
#define AUDOL_POP_ACL_PKT_IN_Q                 14509 //"Pop ACL from Q pkt: 0x%X, ws: 0x%X, next: 0x%X"
#define AUDOL_ASSEM_COMPLETE_A2DP_PKT          14510 //"[AUDOL] Assembly complete a2dp pkt. handle: 0x%X, acl_len: %d, l2cap_len: %d"
#define AUDOL_CANNOT_START_PROCESSING_GDMA_COPY_DONE 14511 //"[AUDOL] Error. Cannot start processing gdma copy done"
#define AUDOL_INVALID_COPY_REQ_IN_MANAGER      14512 //"[AUDOL] Error. Invalid copy req in audol manager"
#define AUDOL_INCORRECT_COPY_MODE              14513 //"[AUDOL] Error. Incorrect copy mode"
#define AUDOL_PROCESSED_FAIL_ACL_PKT_IN_Q      14514 //"[AUDOL] processed failure, copy status %d, total cnt %d"
#define AUDOL_CONFIG_BAP                       14515 //"[AUDOL] BAP config handle: 0x%X, codec: %d, copy_m(0 cpu, 1 dma): %d, cis_uid: %d, data_path_id: %d, data_path_direction: %d"
#define AUDOL_PUSH_LE_ISO_PKT_IN_Q             14516 //"Push ISO in Q pkt: 0x%X, next: 0x%X"
#define AUDOL_POP_LE_ISO_PKT_IN_Q              14517 //"Pop ISO from Q pkt: 0x%X, next: 0x%X"
#define AUDOL_ASSEM_COMPLETE_LE_ISO_PKT        14518 //"[AUDOL] Assembly complete le iso pkt. handle: 0x%X, len: %d"
#define AUDOL_PROCESSED_FAIL_ISO_PKT_IN_Q      14519 //"[AUDOL] processed failure, copy status %d, total cnt %d"
#define AUDOL_NO_FREE_ISO_PKT                  14520 //"[AUDOL] Get ISO packet failed, current left pkt cnt: %d"

// ============= Enhance Sync Link =============
#define ENHANCE_SYNC_TRX_CODING_FORMAT_INVALID 14700 //"[ENHANCE SYNC] TRX coding format not the same: TX 0x%X, RX 0x%X"
#define ENHANCE_SYNC_IO_CODING_FORMAT_INVALID  14701 //"[ENHANCE SYNC] INPUT/OUTPUT coding format not the same: INPUT 0x%X, OUTPUT 0x%X"
#define ENHANCE_SYNC_CODING_FORMAT_RESTRICTION 14702 //"[ENHANCE SYNC] coding format restriction: TRX 0x%X, INPUT/OUTPUT 0x%X"
#define ENHANCE_SYNC_PCM_CONFIG_RESULT         14703 //"[ENHANCE SYNC] pcmconvert 0x%X, excodec_state 0x%X, scoconv 0x%X, pcmctrl1 0x%X, pcmctrl2 0x%X, pcmctrl3 0x%X, pcm_ex_codec_8bit 0x%X, pcm_ex_codec 0x%X"
#define ENHANCE_SYNC_VOICE_SETTING_MERGED      14704 //"[ENHANCE SYNC] merge params from enhance sync into legacy voice setting: 0x%X"


#define HDT_GET_BUFFER_FAIL1                15000       //"Invalid parameter: entry = %d, nb = %d, sn = %d"
#define HDT_GET_BUFFER_FAIL2                15001       //"Invalid parameter: entry = %d, sn = %d"
#define HDT_RELEASE_ENTRY1                  15002       //"ll_release_hdt_pkt_record: entry %d, sn=%d"
#define HDT_CAM_ACCESS_ERROR1               15003       //"[HDT] Translate CAM entry and row fail: entry:%d, cam_row:%d"
#define HDT_RX_PKT_LEN_MISMATCH             15004       //"[HDT] RX packet packet_len > ll_manager.hdt_manager.ll_hw_rxfifo_buf_record: %d, %d"
#define HDT_DTM_LFSR                        15005       //"[HDT DTM] (%d, %d): LFSR=0x%x, PRBS Poly=0x%x, bit_size=%d(unit: bit), bit_width=%d, last_data_block_index=%d, block_size=%d, block_bitmap=0x%x, mac_id=%d"
#define HDT_GET_BUFFER_DBG1                 15006       //"ll_get_hdt_buffer: entry_id.u16=0x%x, hdt_rx_pkt_record_entry_bitmap=0x%x, nb=%d, sn=%d, block_idx=%d, block_size=%d, payload_len=%d"
#define HDT_GET_BUFFER_DBG2                 15007       //"ll_get_hdt_buffer: address of item=0x%x, block_bitmap=0x%x, payload_bitmap=0x%x, *is_payload_complete=%d, item->payload[sn]=0x%x, ret=0x%x, size of item->payload[sn]=%d, payload_len=%d"
#define HDT_PARSING_RX_PKT_LOG              15008       //"[HDT] parsing Rx pkt: position: %d, offset=%d"
#define HDT_PARSING_RX_PAYLOAD_LOG1         15009       //"offset=%d, payload_idx=%d, block_idx=%d, initial_sn=%d, tx_len=%d, payload_len=%d"
#define HDT_PARSING_RX_PAYLOAD_LOG2         15010       //"nb=%d, cur_block_size=%d, is_payload_complete=%d, buffer=0x%x"
#define HDT_DTM_SET_PDU_HDR_CONTENT         15011       //"le_hdt_dtm_set_pdu_hdr_content: data_len=%d, data[%d]=0x%x, reg_offset=0x%x, cur_len=%d"
#define HDT_DTM_PROGRAM_PDU_HDR_CONTENT1    15012       //"le_hdt_dtm_program_pdu_hdr_content: initial_octect.u8=0x%x, cur_len=%d"
#define HDT_DTM_PROGRAM_PDU_HDR_CONTENT2    15013       //"le_hdt_dtm_program_pdu_hdr_content: rxpp=1, rx_pld_map_offset=%d, cur_len=%d, rx_pld_map=0x%x"
#define HDT_DTM_PROGRAM_PDU_HDR_CONTENT3    15014       //"le_hdt_dtm_program_pdu_hdr_content: txpp=1, tx_pld_map_offset=%d, cur_len=%d, tx_pld_map=0x%x"
#define HDT_DTM_PROGRAM_PDU_HDR_CONTENT4    15015       //"le_hdt_dtm_program_pdu_hdr_content: xhp=1, ext_header_byte0_offset=%d, cur_len=%d"
#define HDT_DTM_TX_NOT_DONE                 15016       //"Warning!! Tx not done in LE HDT Tx Cnt Mode: number_of_tx_packets=%d, expected_tx_packets=%d"
#define HDT_DTM_STATISTICS                  15017       //"HDT DTM Statistics: tx_pkts=%d, rx_ctrl_hdr=%d, rx_pdu_hdr=%d, rx_pkts=%d, rx_pkts_crc_err=%d, unexpected_CTE_pkts=%d, rx_plds=%d, rx_plds_crc_err=%d, rx_blks=%d, rx_blks_crc_err=%d, rx_pld_map=0x%x, 0x%x, 0x%x, 0x%x, 0x%x"
#define HDT_DTM_RX_PKT                      15018       //"LL_HANDLE_RECD_TEST_HDT_PACKET: entry=%d, ll_hw_rxfifo_buf_record=%d, fifo_word_cnt=%d, has_whole_pkt=%d, native_clk=0x%x"
#define HDT_DTM_DBG_LOG1                    15019       //"hdt_dtm_setting_1_offset=0x%x"
#define HDT_DTM_DBG_LOG2                    15020       //"reg_offset=0x%x, value=0x%x"
#define HDT_DTM_MULTI_BLOCK_INFO            15021       //"i:%d, block_crc_err_status=0x%x, tx_block_bitmap=0x%x, rx_crc_ok_bitmap=0x%x, rx_crc_err_bitmap=0x%x, num_of_blocks=%d, num_of_crc_ok_blocks=%d"
#define HDT_DTM_ERR_INJECT                  15022       //"i:%d, reg_offset=0x%x, crc_err_pattern=0x%x, hw_content=0x%x"
#define HDT_EXTRACT_RX_STATUS_ZONE          15023       //"[HDT] rx_status3=0x%x, rx_status2=0x%x, rx_status=0x%x, rx_status4.tx_portion2.u16=0x%x"
#define HDT_RX_PKT_THROUGHPUT               15024       //"HDT_RX: [0x%x] conn_handle=0x%x, format:%d, bit rate=%.1f Mbps, received_byte=%d, total_received_byte=%d, total_time=%.3f ms, total_received_pkt=%d, throughput= %.4f kbps"
#define HDT_RX_PKT_PARSE_FAIL               15025       //"Warning!! ll_calculate_total_payload_size: byte_count=%d, total_payload_size=%d, overhead_len=%d"
#define HDT_RX_PKT_INFO                     15026       //"[HDT] control_hdr_len=%d, pdu_hdr_len=%d, payload_zone_len=%d, rx_status_zone_len=%d, others_len=%d, byte_count=%d"
#define HDT_RELEASE_BUFFER_DBG              15027       //"ll_release_hdt_pkt_record: entry=0x%x, payload_bitmap=0x%x, rx_pkt_record_entry_bitmap=0x%x, old_sn=%d"
#define HDT_RELEASE_BUFFER_NO_PAYLOAD       15028       //"ll_release_hdt_pkt_record: Warning! payload_bitmap==0! entry=0x%x, rx_pkt_record_entry_bitmap=0x%x, old_sn=%d"
#define HDT_FORMAL_DTM_TX_PARAMETERS1       15029       //"[HDT DTM] RI=%d, PFI=%d, hdt_payload_length=%d, PHY_INT=%d"
#define HDT_FORMAL_DTM_TX_PARAMETERS2       15030       //"[HDT DTM] payload_index = %d: dsc_type=%d, nb=%d, block_size=%d, tx_block_bitmap=0x%x, payload_len=%d, LLID=%d"
#define HDT_FORMAL_DTM_TX_PARAMETERS3       15031       //"[HDT DTM] ll_phy=%d, pkt_duration_us=%d, pdu_len=%d, blk_num=%d, pkt_interval_slot=%d, total_payload_len=%d, total_block_num=%d, pdu_hdr_len=%d"
#define HDT_UPDATE_FROM_NON_HDT             15032       //"[HDT] ll_driver_phy_update_switch_to_hdt: SN=%d, NESN=%d, PCA=0x%02x%02x%02x%02x%02x, CRC32=0x%08x"
#define LE_GEN_HDT_CONFIG_REQ               15033       //"[LL]Gen LL_HDT_CONFIG_REQ (%d): payload_size_u8:0x%x, ACL_Rx_Rates:0x%x, Max_ACL_Rx_Octets_Per_Packet=%d"
#define LE_GEN_HDT_CONFIG_RSP               15034       //"[LL]Gen LL_HDT_CONFIG_RSP (%d): payload_size_u8:0x%x, ACL_Rx_Rates:0x%x, Max_ACL_Rx_Octets_Per_Packet=%d"
#define LE_HANDLE_HDT_CONFIG_REQ            15035       //"[LL] Rx LL_HDT_CONFIG_REQ (%d): preferred_ri=%d, ACL_Rx_Payload_Window_Size=%d, Max_TX_PDUs_Per_Packet=%d, Max_RX_PDUS_Per_Packet=%d"
#define LE_HANDLE_HDT_CONFIG_RSP            15036       //"[LL] Rx LL_HDT_CONFIG_RSP (%d): preferred_ri=%d, ACL_Rx_Payload_Window_Size=%d, Max_TX_PDUs_Per_Packet=%d, Max_RX_PDUS_Per_Packet=%d"
#define HDT_CREATE_CIS_LOG                  15037       //"[HDT] ll_driver_hdt_create_cis_channel: hdt_mic_len=%d, PCA=0x%02x%02x%02x%02x%02x, CRC32=0x%08x"
#define HDT_PARSE_PKT_EXCEPTION1            15038       //"[HDT] WARNING! offset=%d, pdu_len=%d, rx_status_offset=%d, all_kept_for_dbg=%d, byte_count=%d"
#define HDT_PARSE_PKT_EXCEPTION2            15039       //"[HDT] WARNING! offset=%d, pdu_hdr_len=%d, all_kept_for_dbg=%d, byte_count=%d"
#define HDT_GET_BUFFER_WARNING              15040       //"ll_get_hdt_buffer: item->payload[%d] != NULL but this is not a multi-block payload, payload_len=%d"
#define HDT_PKT_LEN_CALCULATE               15041       //"[HDT] ll_hdt_calculate_pkt_length_by_pkt_duration: ll_phy=%d, pfi=%d, ri=%d, pdu_len=%d, enc=%d, total_blk_num=%d, pkt_duration=%d, ret=%d"
#define HDT_ACL_PKT_LEN_NOT_SUCCESS         15042       //"[HDT] ll_acl_hdt_get_pkt_length_by_pkt_duration: ll_phy=%d, preferred_ri=%d, pkt_duration=%d, enc=%d"
#define HDT_CTE_SIGNATURE_PARSE_FAIL        15043       //"[HDT] WARNING! Parse CTE signature fail! offset=%d"
#define HDT_CTE_TYPE_PARSE_FAIL             15044       //"[HDT] WARNING! Parse CTEType fail! offset=%d"
#define LE_MSG_ISO_RX_LL_CIS_REQ_CIS_PARAMS2 15049      //"[ISO] recd  ll cis req info param2: hdt_mic_length %d (1:64bits, 2:128bits) payload_window_size_m2s %d payload_window_size_s2m %d"

#define LE_MSG_HDT_DATA_CH_INVALID_RX_PKT   15160       //"[HDT] Get Data Channel Invalid Pkt (entry %d rxstatus %02x), ce_count:%d"
#define LE_MSG_HDT_DATA_CH_RX_ZERO_PKT      15161       //"[HDT] Get Data Channel Zero Pkt, ce_count:%d"
#define LE_MSG_HDT_ISO_CH_INVALID_RX_PKT    15162       //"[HDT] Get ISO Channel Invalid Pkt (entry %d rxstatus %02x failed_map 0x%x), cis_count:%08x%08x"
#define LE_MSG_HDT_ISO_CH_RX_ZERO_PKT       15163       //"[HDT] Get ISO Channel Zero Pkt, cis_count:%08x%08x"
#define LE_MSG_HDT_DATA_RX_DEBUG            15164       //"[HDT] Rx Data Channel Payload: entry:%d, initial_sn:%d, sn:%d, completed_payload_bitmap:0x%x, hdt_payload_ptr:0x%x, llid:%d, payload_len:%d"
#define LE_MSG_HDT_ISO_RX_DEBUG             15165       //"[HDT] Rx CIS Channel Payload: entry:%d, initial_sn:%d, sn:%d, completed_payload_bitmap:0x%x, hdt_payload_ptr:0x%x, llid:%d, payload_len:%d, ref_ap:%d"
#define LE_MSG_HDT_CIS_RECEIVE_PACKET       15166       //"[HDT] iso packet is received: id %d, sn %d, llid %d, plen %d, cis_rxcnt %d, dat (%08x-%08x-%08x-%08x-%08x)"
#define LE_MSG_HDT_ISO_RX_LL_CIS_IND_PARAMS 15167       //"[HDT] recd ll cis hdt ind params: pca: 0x%02x 0x%02x 0x%02x 0x%02x 0x%02x"
#define LE_MSG_HDT_ISO_RX_LL_CIS_RSP_PARAMS 15168       //"[HDT] recd ll cis hdt rsp params: preferred_mic_length:%d, skd_p:0x%08x %08x, iv_p:0x%08x"
#define HDT_ISO_CALCULATE_MPT_ERROR         15169       //"[HDT] Calculate MPT Duration: mpdu:%d, ri:%d, pfi:%d"
#define HDT_ISO_CALCULATE_MPT               15170       //"[HDT] iso_hdt_calculate_mpt_duration: mpdu:%d, ri:%d, pfi:%d, duration_us:%d"
#define LE_MSG_ISO_SET_CIG_PARAM_CIS_V3     15171       //"[HDT] Set CIG param v3 (CIS Info): cis_id %02x, max_sdu(%04x %04x), phy(%02x %02x), rate(%04x %04x), rtn(%02x %02x), mic_len %02x, pkt_format %02x"
#define LE_MSG_ISO_FW_GEM_CIS_PARAM_HDT     15172       //"[HDT] Gen CIS Params from host info: phy(%d %d), rate(%d %d), mic_len %d, pkt_format (%d %d), payload_win_size (%d %d)"
#define LE_MSG_HDT_BIS_CH_INVALID_RX_PKT    15173       //"[HDT] Get BIS Channel Invalid Pkt (entry %d rxstatus %02x failed_map 0x%x), bis_count:%08x%08x"
#define LE_MSG_HDT_BIS_CH_RX_ZERO_PKT       15174       //"[HDT] Get BIS Channel Zero Pkt, bis_count:%08x%08x"
#define LE_MSG_HDT_INVALID_ENTRY            15175       //"[HDT] Rx thr interrupt entry error, entry:%d, rx_word_cnt:%d"
#define LE_MSG_HDT_BIS_RX_DEBUG             15176       //"[HDT] Rx BIS Channel Payload: entry:%d, initial_sn:%d, sn:%d, completed_payload_bitmap:0x%x, hdt_payload_ptr:0x%x, llid:%d, payload_len:%d, ref_ap:%d"
#define HDT_PKT_DURATION_CALCULATE          15177       //"[HDT] ll_hdt_calculate_pkt_duration: ll_phy=%d, pfi=%d, ri=%d, pdu_len=%d, enc=%d, total_blk_num=%d, pkt_duration=%d, ret=%d"
#define HDT_ACL_PKT_DURATION_NOT_SUCCESS    15178       //"[HDT] ll_acl_hdt_get_pkt_duration fail: ll_phy=%d, preferred_ri=%d, pdu_len=%d, enc=%d, reg_LR=0x%x"
#define LE_MSG_ISO_CREATE_BIG_PARAM_GEN_HDT 15179       //"[ISO] Generate BIG param (BIG Info for HDT): rate: 0x%x, ref_tp: 0x%x, se_len_us: %d, mic_length: %d"

#define HDT_BZDMA_SWITCH_TO_HDT             15200       //"<HDT> switch BZDMA to HDT, status: 0x%x, mac_id:%d, entry: 0x%x, malloc bytes: %d"
#define HDT_BZDMA_SWITCH_TO_NON_HDT         15201       //"<HDT> switch BZDMA to non-HDT, status: 0x%x, mac_id:%d, entry: 0x%x"
#define HDT_GEN_PHY_HDT_UPDT_IND            15202       //"<HDT> [clk:0x%08X][LL PHY UPDT(%d)] Gen LL_PHY_UPDATE_IND_V2. m_to_s %d s_to_m %d instant %d ce_cnt %d pca: %02x %02x %02x %02x %02x"
#define HDT_RECV_PHY_HDT_UPDT_IND           15203       //"<HDT> [clk:0x%08X][LL PHY UPDT(%d)] Rx LL_PHY_UPDATE_IND_V2. m_to_s %d s_to_m %d instant %d cur %d pca: %02x %02x %02x %02x %02x"
#define HDT_CHK_ENTRY_IS_IN_HDT             15204       //"<HDT> check if entry is in HDT, status: 0x%x, mac_id:%d, entry: 0x%x, is_hdt:%d"
#define HDT_EXCEED_MAX_FRAG_ERROR           15205       //"<HDT> Warning, used frag: %d > max frag count"
#define PHY_UPDATE_BACK_NON_HDT_AA_CHECK    15206       //"WARNING! Rx LL_PHY_UPDATE_IND_V2. AccessAddress mismatch pHandle->access_address=0x%x"

#define HDT_DBG_PHY_UPDT_STATE_0            15210       //"<HDT DBG> fw entry_id:%d, updt inst:%d, phy updt state:%d, hdt phy updt state:%d"
#define HDT_DBG_PHY_UPDT_STATE_1            15211       //"<HDT DBG> flow stop, cur sn:%d, nesn:%d"
#define HDT_DBG_PHY_UPDT_STATE_2            15212       //"<HDT DBG> waiting switch bzdma, cam4 conn counter:%d"
#define HDT_DBG_PHY_UPDT_STATE_3            15213       //"<HDT DBG> check if any unacked pkt, seg_vld_bm_backup: 0x%x"
#define HDT_DBG_PHY_UPDT_STATE_4            15214       //"<HDT DBG> updt phy master %d, LE_REG_PHY_UPD_ENTRY:0x%x, LE_REG_PHY_UPD_EXT:0x%x"
#define HDT_DBG_PHY_UPDT_STATE_5            15215       //"<HDT DBG> updt phy slave %d, dw22:0x%x, dw23:0x%x"
#define HDT_DBG_PHY_UPDT_STATE_6            15216       //"<HDT DBG> cam4:0x%x, hdt bzdma status:0x%x, hdt reg t0:0x%x, t1:0x%x, t2:0x%x, t3:0x%x, t4:0x%x, t5:0x%x"

#define HDT_DBG_BZDMA_SWITCH_1              15217       //"<HDT DBG> switch to HDT, seg idx: %d, original tx seg addr:0x%x, start_addr:0x%x"
#define HDT_DBG_BZDMA_SWITCH_2              15218       //"<HDT DBG> switch to HDT, seg idx: %d, tx seg addr:0x%x, repoint start_addr:0x%x"
#define HDT_DBG_BZDMA_SWITCH_3              15219       //"<HDT DBG> LE ACL bzdma entry: %d, seg idx: %d, original tx seg addr:0x%x, frag addr:0x%x, start_addr:0x%x"

#define HDT_DBG_BZDMA_TX_0                  15220       //"<HDT DBG> mac_id:%d, entry:%d, append node:0x%x, max pdu tx sz:%d, pfi:%d, blk_sz:%d"
#define HDT_DBG_BZDMA_TX_1                  15221       //"<HDT DBG> frag[%d], start_addr:0x%x, len:%d, is_last:%d"
#define HDT_DBG_BZDMA_TX_2                  15222       //"<HDT DBG> push bzdma mac_id:%d, ent:%d, node:0x%x, seg_rptr:%d, seg_wptr:%d, pTxSeg addr:0x%x dw:0x%x, pTxHdtSeg1 addr:0x%x, dw:0x%x, pTxBlock:0x%x, pTxFrag:0x%x, seg valid map:0x%x"
#define HDT_DBG_BZDMA_TX_3                  15223       //"<HDT DBG> bzdma frag[%d], start_addr:0x%x, len:%d, is_last:%d, DWord:0x%x"
#define HDT_DBG_BZDMA_TX_4                  15224       //"<HDT DBG> bzdma block[%d], start_addr:0x%x, blk len:%d, DWord:0x%x"

// ============= LL HB ===============
#define HB_CAM_ACCESS_ERROR1                15500       //[HB] Translate CAM entry and row fail: entry:%d, cam_row:%d"

// ============= HCI DMA =============
#define DMA_IS_SDIO_INTERFACE 16000 //"++++++ SDIO Interface ++++++"
#define SDIO_SET_IO_READY 16001 //"[SDIO] set I/O ready"
#define USB_BULK_MODE 16002 //"Change to USB bulk mode"
#define USB_LEGACY_MODE 16003 //"Change to USB legacy mode"
#define USB_BULK_MODE_CMD_LENGTH_ERR 16004 //"Bulk mode Command packet length error !!"
#define USB_BULK_MODE_SCO_LENGTH_ERR 16005 //"Bulk mode SCO packet length error !!"

// ============== LL channel sounding ========
#define LE_MSG_GEN_LL_CS_SEC_REQ 16500 //"[CS] Gen LL_CS_SEC_REQ (%d): CS_IV_C:0x%08x_%08x, CS_IN_C:0x%08x, CS_PV_C:0x%08x_%08x"
#define LE_MSG_GEN_LL_CS_SEC_RSP 16501 //"[CS] Gen LL_CS_SEC_RSP (%d): CS_IV_P:0x%08x_%08x, CS_IN_P:0x%08x, CS_PV_P:0x%08x_%08x"
#define LE_MSG_GEN_LL_CS_CAPABILITIES_REQ_0 16502 //"[CS] Gen LL_CS_CAPABILITIES_REQ_0 (%d): mode_type %x, RTT_Cap %x, RTT_AA_Only %d, RTT_SS_N %d, RTT_RS_N %d, NADM_SS_Cap %x, NADM_RS_Cap %x"
#define LE_MSG_GEN_LL_CS_CAPABILITIES_REQ_1 16503 //"[CS] Gen LL_CS_CAPABILITIES_REQ_1: CS_SYNC_PHY_Cap %x, Num_Ant %d, Max_Ant_Path %d, Role %d, Tx_SNR %x, ChSel3c %d, SS_PCT_Est %d"
#define LE_MSG_GEN_LL_CS_CAPABILITIES_REQ_2 16504 //"[CS] Gen LL_CS_CAPABILITIES_REQ_2: Num_Configs %d, Max_Proc_Supp %d, T_SW %d, T_IP1_Cap %04x, T_IP2_Cap %04x, T_FCS_Cap %04x, T_PM_Cap %04x"
#define LE_MSG_GEN_LL_CS_CAPABILITIES_RSP_0 16505 //"[CS] Gen LL_CS_CAPABILITIES_RSP_0 (%d): mode_type %x, RTT_Cap %x, RTT_AA_Only %d, RTT_SS_N %d, RTT_RS_N %d, NADM_SS_Cap %x, NADM_RS_Cap %x"
#define LE_MSG_GEN_LL_CS_CAPABILITIES_RSP_1 16506 //"[CS] Gen LL_CS_CAPABILITIES_RSP_1: CS_SYNC_PHY_Cap %x, Num_Ant %d, Max_Ant_Path %d, Role %d, Tx_SNR %x, ChSel3c %d, SS_PCT_Est %d"
#define LE_MSG_GEN_LL_CS_CAPABILITIES_RSP_2 16507 //"[CS] Gen LL_CS_CAPABILITIES_RSP_2: Num_Configs %d, Max_Proc_Supp %d, T_SW %d, T_IP1_Cap %04x, T_IP2_Cap %04x, T_FCS_Cap %04x, T_PM_Cap %04x"
#define LE_MSG_GEN_LL_CS_CONFIG_REQ_0 16508 //"[CS] Gen LL_CS_CONFIG_REQ_0 (%d): config ID:%d", state:%d, ChM:0x%04x_%08x_%08x, ChM_Rep:%d, Main_Mode:%d, Sub_Mode:%d"
#define LE_MSG_GEN_LL_CS_CONFIG_REQ_1 16509 //"[CS] Gen LL_CS_CONFIG_REQ_1: Main_Mode_Steps(Min %d, Max %d), Main_Mode_Rep:%d, Mode0_Steps:%d", CS_Sync_PHY:%d, RTT_type:%d, Role:%d"
#define LE_MSG_GEN_LL_CS_CONFIG_REQ_2 16510 //"[CS] Gen LL_CS_CONFIG_REQ_2: ChSel:%d, Ch3cShape:%d, Ch3cJump:%d, T_IP1:%d, T_IP2:%d, T_FCS:%d, T_PM:%d"
#define LE_MSG_GEN_LL_CS_CONFIG_RSP 16511 //"[CS] Gen LL_CS_CONFIG_RSP (%d), config ID:%d"
#define LE_MSG_GEN_LL_CS_REQ_0 16512 //"[CS] Gen LL_CS_REQ_0 (%d): config ID:%d, ce:%d, offset(min:%d max:%d), max_proc_len:%d, evt_intl:%d, subevt_per_Intl:%d, subevt_Intl:%d, subevt_len:%d"
#define LE_MSG_GEN_LL_CS_REQ_1 16513 //"[CS] Gen LL_CS_REQ_1: proc_Intl:%d, proc_cnt:%d, aci:%d, peer_ant:%d, phy:%d, pwr_delta:%d, tx_snr_i:%d, tx_snr_r:%d"
#define LE_MSG_GEN_LL_CS_RSP 16514 //"[CS] Gen LL_CS_RSP (%d): config ID:%d, ce:%d, offset(min:%d, max:%d), evt_intl:%d, subevt_per_Intl:%d, subevt_Intl:%d, subevt_len:%d, aci:%d, phy:%d, pwr_delta:%d"
#define LE_MSG_GEN_LL_CS_IND 16515 //"[CS] Gen LL_CS_IND (%d): config ID:%d, ce:%d, offset:%d, evt_intl:%d, subevt_per_Intl:%d, subevt_Intl:%d, subevt_len:%d, aci:%d, phy:%d, pwr_delta:%d"
#define LE_MSG_GEN_LL_CS_TERMINATE_REQ 16516 //"[CS] Gen LL_CS_TERMINATE_REQ(%d), config ID:%d, proc_cnt:%d, error code:%x"
#define LE_MSG_GEN_LL_CS_TERMINATE_RSP 16517 //"[CS] Gen LL_CS_TERMINATE_RSP(%d), config ID:%d, proc_cnt:%d, error code:%x"
#define LE_MSG_GEN_LL_CS_FAE_REQ 16518 //"[CS] Gen LL_CS_FAE_REQ(%d)"
#define LE_MSG_GEN_LL_CS_FAE_RSP 16519 //"[CS] Gen LL_CS_FAE_RSP(%d)"
#define LE_MSG_GEN_LL_CS_CHANNEL_MAP_IND 16520 //"[CS] Gen LL_CS_CHANNEL_MAP_IND(%d): ChM:0x%04x_%08x_%08x, Instant:%d"
#define LE_MSG_RX_LL_CS_SEC_REQ 16521 //"[CS] Rx LL_CS_SEC_REQ (%d): CS_IV_C:0x%08x_%08x, CS_IN_C:0x%08x, CS_PV_C:0x%08x_%08x"
#define LE_MSG_RX_LL_CS_SEC_RSP 16522 //"[CS] Rx LL_CS_SEC_RSP (%d): CS_IV_P:0x%08x_%08x, CS_IN_P:0x%08x, CS_PV_P:0x%08x_%08x"
#define LE_MSG_RX_LL_CS_CAPABILITIES_REQ_0 16523 //"[CS] Rx LL_CS_CAPABILITIES_REQ_0 (%d): mode_type %x, RTT_Cap %x, RTT_AA_Only %d, RTT_SS_N %d, RTT_RS_N %d, NADM_SS_Cap %x, NADM_RS_Cap %x"
#define LE_MSG_RX_LL_CS_CAPABILITIES_REQ_1 16524 //"[CS] Rx LL_CS_CAPABILITIES_REQ_1: CS_SYNC_PHY_Cap %x, Num_Ant %d, Max_Ant_Path %d, Role %d, ChSel3c %d, SS_PCT_Est %d"
#define LE_MSG_RX_LL_CS_CAPABILITIES_REQ_2 16525 //"[CS] Rx LL_CS_CAPABILITIES_REQ_2: Num_Configs %d, Max_Proc_Supp %d, T_SW %d, T_IP1_Cap %04x, T_IP2_Cap %04x, T_FCS_Cap %04x, T_PM_Cap %04x, TX_SNR %02x"
#define LE_MSG_RX_LL_CS_CAPABILITIES_RSP_0 16526 //"[CS] Rx LL_CS_CAPABILITIES_RSP_0 (%d): mode_type %x, RTT_Cap %x, RTT_AA_Only %d, RTT_SS_N %d, RTT_RS_N %d, NADM_SS_Cap %x, NADM_RS_Cap %x"
#define LE_MSG_RX_LL_CS_CAPABILITIES_RSP_1 16527 //"[CS] Rx LL_CS_CAPABILITIES_RSP_1: CS_SYNC_PHY_Cap %x, Num_Ant %d, Max_Ant_Path %d, Role %d, ChSel3c %d, SS_PCT_Est %d"
#define LE_MSG_RX_LL_CS_CAPABILITIES_RSP_2 16528 //"[CS] Rx LL_CS_CAPABILITIES_RSP_2: Num_Configs %d, Max_Proc_Supp %d, T_SW %d, T_IP1_Cap %04x, T_IP2_Cap %04x, T_FCS_Cap %04x, T_PM_Cap %04x, TX_SNR %02x"
#define LE_MSG_RX_LL_CS_CONFIG_REQ_0 16529 //"[CS] Rx LL_CS_CONFIG_REQ_0 (%d): config ID:%d", state:%d, ChM:0x%04x_%08x_%08x, ChM_Rep:%d, Main_Mode:%d, Sub_Mode:%d"
#define LE_MSG_RX_LL_CS_CONFIG_REQ_1 16530 //"[CS] Rx LL_CS_CONFIG_REQ_1: Main_Mode_Steps(Min %d, Max %d), Main_Mode_Rep:%d, Mode0_Steps:%d", CS_Sync_PHY:%d, RTT_type:%d, Role:%d"
#define LE_MSG_RX_LL_CS_CONFIG_REQ_2 16531 //"[CS] Rx LL_CS_CONFIG_REQ_2: ChSel:%d, Ch3cShape:%d, Ch3cJump:%d, T_IP1:%d, T_IP2:%d, T_FCS:%d, T_PM:%d"
#define LE_MSG_RX_LL_CS_CONFIG_RSP 16532 //"[CS] Rx LL_CS_CONFIG_RSP (%d), config ID:%d"
#define LE_MSG_RX_LL_CS_REQ_0 16533 //"[CS] Rx LL_CS_REQ_0 (%d): config ID:%d, ce:%d, offset(min:%d max:%d), max_proc_len:%d, evt_intl:%d, subevt_per_Intl:%d, subevt_Intl:%d, subevt_len:%d"
#define LE_MSG_RX_LL_CS_REQ_1 16534 //"[CS] Rx LL_CS_REQ_1: proc_Intl:%d, proc_cnt:%d, aci:%d, peer_ant:%d, phy:%d, pwr_delta:%d, tx_snr_i:%d, tx_snr_r:%d"
#define LE_MSG_RX_LL_CS_RSP 16535 //"[CS] Rx LL_CS_RSP (%d): config ID:%d, ce:%d, offset(min:%d, max:%d), evt_intl:%d, subevt_per_Intl:%d, subevt_Intl:%d, subevt_len:%d, aci:%d, phy:%d, pwr_delta:%d"
#define LE_MSG_RX_LL_CS_IND 16536 //"[CS] Rx LL_CS_IND (%d): config ID:%d, ce:%d, offset:%d, evt_intl:%d, subevt_per_Intl:%d, subevt_Intl:%d, subevt_len:%d, aci:%d, phy:%d, pwr_delta:%d"
#define LE_MSG_DBG_FLAGS 16537 //"[CS] DBG_FLAG: Error!! log_index:%x, state=%x"
#define LE_MSG_CS_SECURITY_WARN 16538 //"[CS] The CS security procedure bit is not set,acl_id:%d local:0x%x, remote:0x%x"
#define LE_MSG_CS_CAPABILITY_WARN 16539 //"[CS] The CS capability procedure bit is not set,acl_id:%d local:0x%x, remote:0x%x"
#define LE_MSG_CS_CONFIG_WARN 16540 //"[CS] The CS config procedure bit is not set,acl_id:%d local:0x%x, remote:0x%x"
#define LE_MSG_CS_START_WARN 16541 //"[CS] The CS start procedure bit is not set,acl_id:%d local:0x%x, remote:0x%x"
#define LE_MSG_CS_CHANNEL_MAP_WARN 16542 //"[CS] The CS channel map procedure bit is not expected, acl_id:%d local:0x%x, remote:0x%x"
#define LE_MSG_CS_BYPASS_CHANNEL_MAP_UPDATE 16543 //"[CS] Bypass channel map update due to procedure bit is set, acl_id:%d local:0x%x, remote:0x%x"
#define LE_MSG_CS_MODE0_FAE_WARN 16544 //"[CS] The CS mode-0 FAE table procedure bit is not set, acl_id:%d local:0x%x, remote:0x%x"
#define LE_MSG_CS_REPEAT_TERMINATE_WARN 16545 //"[CS] The CS Repeat terminate bit is not set, acl_id:%d local:0x%x, remote:0x%x"

#define LE_CS_LOCAL_CAPAB_NUM_CONFIG_ERROR 16550 //"[CS] error!!! the num of config is out of range, %d"
#define LE_CS_LOCAL_CAPAB_NUM_ANT_ERROR    16551 //"[CS] error!!! the num of antenna is out of range, %d"
#define LE_CS_LOCAL_CAPAB_ROLE_SUPP_ERROR  16552 //"[CS] error!!! the role supports nothing"
#define LE_CS_LOCAL_CAPAB_ANT_PATH_ERROR   16553 //"[CS] error!!! the antenna path is out of range, %d"
#define LE_CS_LOCAL_CAPAB_T_SW_TIME_ERROR  16554 //"[CS] error!!! the t_sw_time is out of range, %d"
#define LE_CS_LOCAL_CAPAB_CHECK_ERROR      16555 //"[CS] error!!! need to check related CS capability"
#define LE_MSG_CS_DECIDE_CS_REQ_PARAM      16556 //"[CS] error!!! need to check related CS capability"
#define LE_MSG_CS_WRITE_CAM_ERROR          16557 //"[CS] error!!! write cs cam, cam_addr:0x%x, wdata:0x%x"
#define LE_MSG_CS_READ_CAM_ERROR           16558 //"[CS] error!!! read cs cam, cam_addr:0x%x"
#define LE_MSG_CS_h9_VERIFICATION          16559 //"[CS] H9 verification, kdrbg:0x%x,0x%x,0x%x,0x%x, vdrbg:0x%x,0x%x,0x%x,0x%x"
#define LE_MSG_CS_HW_CONFIG 16560 //"[CS] Enter CS HW CAM config setting:config_id:%d, acl_uid:%d"
#define LE_MSG_CS_CREATE_CONFIG 16561 //"[CS] START CS CONFIG:config_id:%d, acl_uid:%d"
#define LE_MSG_CS_DUMP_CS_CAM_VALUE 16562 //"[CS] CS CAM, start_index:%d, cam_value:0x%x, cam_value:0x%x, cam_value:0x%x, cam_value:0x%x, cam_value:0x%x, cam_value:0x%x, cam_value:0x%x"
#define LE_MSG_CS_DBG_CAM_AFTER_WRITE 16563 //"[CS] CS CAM, addr:%d, cam_value:0x%x, expected_value:0x%x"
#define LE_MSG_CS_DUMP_CS_REG_CREATE 16564 //"[CS] CS REG DUMP, config_id:%d, reg:0x%x:0x%x reg:0x%x:0x%x reg:0x%x:0x%x reg:0x%x:0x%x"
#define LE_MSG_CS_ANCHOR_POINT 16565 //"[CS] CS meu anchor point:0x%x slot, 0x%x us, cam anchor point:0x%x slot, 0x%x us"
#define LE_MSG_CS_WW_ACL_TO_CS 16566 //"[CS] CS ww value:%d slot, %d us, cs_acl2cs_t_offset_slot:%d, offset:%d"
#define LE_MSG_CS_ACTIVE_INTR 16567 //"[CS] CS active interrupt, cs_uid:%d"
#define LE_MSG_CS_RMV_INTR 16568 //"[CS] CS remove interrupt, cs_uid:%d, remove_reason:%d"
#define LE_MSG_CS_PROC_END_INTR 16569 //"[CS] CS procedure end interrupt, cs_uid:%d, intr_sts:0x%x"
#define LE_MSG_CS_ANCHOR_ADJCENT 16570 //"[CS] CS acl_air_achor_adjcent info, asso_acl_ce:%d, acl_ce:%d, acl_intv:0x%x(slots), acl_ap:0x%x, acl_ap_us:%d, ww_slot:%d, ww_us:%d, final_ap_slot:0x%x, final_ap_us:%d"
#define LE_MSG_CS_DUMP_KEY 16571 //"[CS] CS dump init key parameter, iv_DRBG:0x%08x_%08x_%08x_%08x, in_DRBG:0x%08x_%08x, pv_DRBG:0x%08x_%08x_%08x_%08x"
#define LE_MSG_CS_DUMP_LE_REG 16572 //"[CS] CS dump LE REG, 0x%x:0x%x, 0x%x:0x%x, 0x%x:0x%x"
#define LE_MSG_CS_DUMP_TX_POWER_VALUE 16573 //"[CS] CS dump tx power, LE_ACL:0x%x, cs:0x%x, power_delta:%d(dbm)"
#define LE_MSG_CS_DTM_CAM_AFTER_WRITE 16574 //"[CS] CS DTM indirect, addr:0x%x, cam_value:0x%x, expected_value:0x%x"
#define LE_MSG_CS_DRBG_CAM_AFTER_WRITE 16575 //"[CS] CS DRBG indirect, addr:0x%x, cam_value:0x%x, expected_value:0x%x"
#define LE_MSG_CS_DTM_ENABLE 16576 //"[CS] CS DTM procedure enable, enable state:%d"
#define LE_MSG_CS_DTM_DISABLE 16577 //"[CS] CS DTM procedure disable, enable state:%d"
#define LE_MSG_CS_WRONG_STATE_DTM_DISABLE 16578 //"[CS] WARNING!!!, wrong stat when disable dtm, enable state:%d"
#define LE_MSG_CS_DUMP_MASTER_ADJCENT 16579 //"[CS] CS acl master adject anchor info:, txon_delay:%d, fixed_time:%d, final_hw_slot:%d, final_hw_us:%d"
#define LE_MSG_CS_DUMP_SLAVE_ADJCENT 16580 //"[CS] CS acl slave adject anchor info:, txon_delay:%d, fixed_time:%d, final_hw_slot:%d, final_hw_us:%d"
#define LE_MSG_CS_MASTER_ANCHOR_PARAMETER 16581 //"[CS] CS master final anchor info: offset:%d, T_FCS:%d, cs_mac2air_delay:%d(0.1us), cs_initial_time:%d, cs_early_tx_mode0:%d"
#define LE_MSG_CS_SLAVE_ANCHOR_PARAMETER 16582 //"[CS] CS slave final anchor info: offset:%d, T_FCS:%d, cs_initial_time:%d, cs_pre_rx_mode0:%d"
#define LE_MSG_CS_DUMP_AA_VALUE 16583 //"[CS] Dump AA value, local: 0x%08x_%08x, Remote:0x%08x_%08x"
#define LE_MSG_CS_ACL_WW_INFO 16584 //"[CS] CS ACL WW info(us): ww_acl:%d, ap_ce_cnt:%d, cs_acl_ce:%d, delta_from_curr_to_cs_acl_ww:%d, ww_acl_acc:%d"
#define LE_MSG_CS_WW_INFO 16585 //"[CS] CS WW info(us): remote_sca_ppm:%d(ppm), window_value:%d, cs_ww_value_ind_offset:%d, ww_value:%d"
#define LE_MSG_CS_MODEM_REG 16586 //"[CS] Dump CS modem reg, page:0x%x, addr:0x%x, value:0x%x"
#define LE_MSG_CS_MODEM_INFO 16587 //"[CS] Dump CS modem info, r_rx_dly:%d(0.1us), cs_dt_a:%d(0.1us), cs_dt_b:%d(0.1us), cs_rxon2hit_target_mux_1M:%d(us),%d(0.1 us), cs_rxon2hit_target_mux_2M:%d(us), %d(0.1us), cs_rxon2hit_target_mux_2M_2BT:%d(us), %d(0.1us)"
#define LE_MSG_CS_RX_HEADER_INFO1 16588 //"[CS] RX header info_1, Mode:%d, step_size_w:%d, chn_idx:%d, cs_entry:%d, subevent_done:%d, procedure_done:%d, tone_ext_tx_pres:%d"
#define LE_MSG_CS_RX_HEADER_INFO2 16589 //"[CS] RX header info_2, acc_miss:%d, mode0_step_cnt:%d, rtt_ant_id:%d, ant_perm idx:%d, cs_prcdr_cnt:%d, cs_evt_cnt:%d, cs_sbevt_cnt:%d"
#define LE_MSG_CS_RX_MODE0_INFO 16590 //"[CS] Rx Mode0 Info, role:%d, data_length:%d, packet quality:0x%x, rssi:0x%x, antenna field:0x%x, freq_off:0x%x%x"
#define LE_MSG_CS_RX_MODE1_INFO 16591 //"[CS] Rx Mode1 Info, role:%d, rtt_type:%d, data_length:%d, packet quality:0x%x, nadm:0x%x, rssi:0x%x, time_diff:0x%x, rtt_ant_id:%d, pkt_pct1:0x%x, pkt_pct2:0x%x"
#define LE_MSG_CS_RX_MODE2_PCT_INFO 16592 //"[CS] Rx Mode2 PCT info, ap:%d, tone_pct:0x%x, tone_quality:0x%x"
#define LE_MSG_CS_RX_MODE2_INFO 16593 //"[CS] Rx Mode2 Info, role:%d, ant_perm_idx:%d, data_length:%d"
#define LE_MSG_CS_RX_MODE3_PCT_INFO 16594 //"[CS] Rx Mode3 PCT info, ap:%d, tone_pct:0x%x, tone_quality:0x%x"
#define LE_MSG_CS_RX_MODE3_INFO 16595 //"[CS] Rx Mode3 Info, role:%d, rtt_type:%d, data_length:%d, packet quality:0x%x, nadm:0x%x, rssi:0x%x, rtt_ant_id:%d, pkt_pct1:0x%x, pkt_pct2:0x%x, time_diff:0x%x, ant_perm_idx:%d"
#define LE_MSG_CS_DTM_PROC_END 16596 //"[CS] CS Procedure end intr, enable state:%d"
#define LE_MSG_CS_DTM_RESET_WAIT 16597 //"[CS] CS DTM delay wait before updating channel, wait_count:%d"
#define LE_MSG_CS_DTM_HANDLE_RESET 16598 //"[CS] Handle CS DTM reset in CH map update intr, dtm_reset:%d, update_status:0x%x"
#define LE_MSG_CS_DRBG_READ_INFO 16599 //"[CS] CS DRBG read, addr:%d, value:0x%x, done_count:%d, set_clr:%d"
#define LE_MSG_CS_DUMP_DTM_TRX_TIMING_OFFSET 16600 //"[CS] CS dump TRX timing offset info, cs_early_tx_mode0:%d, cs_pre_rx_mode0:%d, t_ip1:%d, cs_adj_rx2tx_offset_value(0.1us):%d, cs_adj_tx2rx_offset_value(0.1us):%d, reg_cs_adj_rx2tx_offset:0x%x, reg_cs_adj_tx2rx_offset:0x%x"
#define LE_MSG_CS_CHM_UPDATE 16601 //"[CS] Update channel map, cs_uid:%d, chm_num:%d, update_prcdr:%d, update_chmap:%x%x%x"
#define LE_MSG_CS_CHM_UPDATE_INTR 16602 //"[CS] CS channel map update interrupt, cs_uid:%d, channel_num:%d, update_reason:%d"
#define LE_MSG_CS_DUMP_INTR 16603 //"[CS] CS dump interrupt, reg:0x52c, value:0x%x"
#define LE_MSG_CS_CHM_TRIGGER_UPDATE 16604 //"[CS] CS trigger chm update, cs_uid:%d, chm_num:%d, update_prcdr:%d, update_chmap:%x%x%x"
#define LE_MSG_CS_CHECK_CHM_UPDATE 16605 //"[CS] CS check if need chm update, cs_uid:%d, max_proc_count:%d, proc_intv:%d, first_proc_ce:%d, final_proc_ce:%d, result:%d"
#define LE_MSG_CS_FIND_CHM_UPDATE_PROC 16606 //"[CS] CS find chm update proc, cs_uid:%d, max_proc_count:%d, proc_intv:%d, first_proc_ce:%d, final_proc_ce:%d, find:%d, target_proc:%d, target_proc_ce_count:%d"
#define LE_MSG_CS_CHM_CE_END 16607 //"[CS] Handle channel update in ce_end, chm_update_inst:%d, curr_ce_count:%d, instant_pass:%d, curr_chm:%x%x%x"
#define LE_MSG_CS_PROC_INTV_CAM 16608 //"[CS] Procedure intv info, proc_intv:%d, max_proc_length:%d, ce_intv:%d, proc_intv_in_cam:%d"
#define LE_MSG_CS_DUMP_NONCE 16609 //"[CS] CS dump init key nonce, k_drvg:0x%08x_%08x_%08x_%08x, v_drbg:0x%08x_%08x_%08x_%08x"
#define LE_MSG_CS_DTM_RX_INFO 16610 //"[CS] CS DTM RX Info, phy:%d, cs_rampdown_delay:%d, r2r_intv_fix:%d(0.1us), rx_window:%d, rx2rx_intv_value:0x%x, rx2rx_intv_value_in_lut:0x%x"
#define LE_MSG_CS_CHM_HW_CE_END 16611 //"[CS] CS trigger CHM HW update in ce_end,  cs_uid:%d, update_id:%d, curr_proc:%d, update_proc:%d"
#define LE_MSG_CS_DUMP_DTM_REG 16612 //"[CS] CS Dump DTM general reg,  reg:0x%x:0x%x, reg:0x%x:0x%x, reg:0x%x:0x%x"
#define LE_MSG_CS_WRONG_PHY_INDEX 16613 //"[CS] WARNING!!!, invalid phy index, cs_uid:%d"
#define LE_MSG_CS_DUMP_TX_POWER_INFO 16614 //"[CS] CS TX power info: cs_uid:%d, rf_mode:%d, txgain_type:%d, cs_tx_power:%d(dBm), txgain_index:0x%x"
#define LE_MSG_CS_CHECK_TERM_PROC 16615 //"[CS] Check terminate CS info: cs_uid:%d, cur_proc:%d, term_proc:%d, last_proc:%d, LR:0x%x"
#define LE_MSG_CS_TERM_CS_PROC 16616 //"[CS] Kill CS procedure: cs_uid:%d, cur_proc:%d, term_proc:%d, last_proc:%d, LR:0x%x"
#define LE_MSG_CS_SUBEVENT_END 16617 //"[CS] Dump procedure status in sub-event end intr: cs_uid:%d, rx_word_cnt:%d, anch_diff_rpt0:0x%x, anch_diff_rpt1:0x%x"
#define LE_MSG_CS_MODE_X_DURATION_INFO 16618 //"[CS] Mode:%d duration info: t_fcs:%d t_pm:%d t_ip1:%d t_ip2:%d t_sw:%d aci_index:%d n_ap:%d rtt_type:%d cs_phy_index:%d, duration:%d"
#define LE_MSG_CS_MODE_X_REFLECTOR_RX 16619 //"[CS] Mode:%d Reflector RX info: t_pm:%d t_ip1:%d t_ip2:%d t_sw:%d aci_index:%d n_ap:%d rtt_type:%d cs_phy_index:%d, duration:%d"
#define LE_MSG_CS_MODE_X_REFLECTOR_TX 16620 //"[CS] Mode:%d Reflector TX info: t_pm:%d t_sw:%d aci_index:%d n_ap:%d rtt_type:%d cs_phy_index:%d, duration:%d"
#define LE_MSG_CS_MODE_X_MODE_Y_T2T 16621 //"[CS] Mode:%d to Mode:%d T2T info : role:%d t_fcs:%d duration:%d"


// ============== Mailbox ========
#define MAILBOX_HANDLE_WRITE_TO_WIFI        17000       //"<mailbox> mailbox trigger write [raw0]: %08x, [raw1]: %08x"
#define MAILBOX_HANDLE_READ_FROM_WIFI       17001       //"<mailbox> mailbox read [raw0]: %08x, [raw1]: %08x"
#define MAILBOX_TRIGGER_WRITE_FAIL          17002       //"<mailbox> warning! mailbox write fail [raw0]: %08x, [raw1]: %08x"
#define MAILBOX_WRITE_DONE_INT              17003       //"<mailbox interrupt> mailbox write done interrupt: [ctrl]: %04x, [raw0]: %08x, [raw1]: %08x"
#define MAILBOX_READ_INT                    17004       //"<mailbox interrupt> mailbox read interrupt: [ctrl]: %04x, [raw0]: %08x, [raw1]: %08x"
#define MAILBOX_TASK_ABORT                  17005       //"<mailbox> warning! mailbox sending abort since WIFI does not ACK; No reaction time: %d ms; Total Abort Count: %d"


// ============== 5.0 LE Periodic Advertising ========
#define PA_ENTITY_FREE_FAIL                 17500       //"<PA> WARNING!!, PA entity is NULL. LR 0x%x"
#define PA_ENTITY_ALLOCATE_FAIL             17501       //"<PA> WARNING!!, PA entity allocate fail. mac_id %d LR 0x%x"
...
#define PA_UNKNOWN_PA_TYPE                  17505       //"<PA> WARNING!!, Unknown pa type %d"
...
#define PA_CREATE_SYNC_SUCCESS              17512       //"<PA> PA create sync SUCCESS. pa_unit_id: 0x%x."
#define PA_CREATE_SYNC_FAIL                 17513       //"<PA> WARNING!! PA create sync FAIL. pending PA entity %x"
#define PA_ENTITY_INFO_1                    17514       //"<PA Info> ent(uid: 0x%x, role: %d, handle: 0x%x, intvl: %d)"
#define PA_ENTITY_INFO_2                    17515       //"<PA Info> ent(uid: 0x%x, role: %d, handle: 0x%x, intvl: %d) ent(uid: 0x%x, role: %d, handle: 0x%x, intvl: %d)"
#define PA_CHANNEL_MAP_UPT_INFO             17516       //"<PA> Receiving PA channel map update indication. pa_unit_id: %x, instant: %x, map_l: %x, map_h: %x
...
#define PA_BIG_CHECK_AND_CHANGE_MAP         17521       //"<PA> Change Channel Map at Next BIG End: big_uid:%d, bis_uid:%d, channel_map:0x%x%x -> 0x%x%x"
#define PA_CH_AS_TASK_NULL_PTR              17522       //"<PA> Got NULL ptr"
...
#define PA_GET_PA_ENTITY_FAIL               17555       //"<PA> get invalid pa entity, LR:0x%x"
#define PA_ADV_ACAD_TOO_BIG                 17556       //"<PA ADV> WARNING!! PA ADV EXT_HEADER+ACAD is larger than 63 byte.(0x%02X)ofst(acad_begin:%d cur:%d) ad_len %d adv_h %d flag0x%2X ch_map %d big%d"
#define PA_GET_PA_ENTITY_BY_UNIT_ID_FAIL    17557       //"<PA> get invalid pa entity, mac_id:%d, uid:%d, LR:0x%x"
#define PA_GET_PA_ENTITY_BY_PAE_INDEX_FAIL  17558       //"<PA> get invalid pa enitty, pae_index:%d, LR:0x%x"
...
#define PAST_TRANSLATE                      17603       //"[clk1 %08X]<PAST> PA translate IN:0x%08x %dus OUT:0x%08x %dus, slv_ent 0x%x pa_ent %d reg 0x%04x %04x"
#define PAST_CREATE_SYNC_MESSAGE            17604       //"<PAST> PAST create sync is triggered due to receive LL_PERIODIC_SYNC_IND. Connection entry ID: %d, PA entry ID: %d, syncConnEventCount: %d, lastPaEventCounter: %d, connEventCount: (%d, %d), PeriodicEventCounter: (%d, %d), CEt: %d, %d us."
#define PAST_CREATE_SYNC_SUCCESS            17605       //"<PAST> PAST create sync SUCCESS. conn_entry_id: 0x%x, pa_unit_id: 0x%x."
#define PAST_TX_ADD_COMPENSATION            17606       //"<PAST> PAST Tx Add compensation. conn_entry 0x%x(Master?%d)PA rolw(%d 1:ADV;2:SCAN) Tx_Phy %d CI%d sync_offset %d tx_on_delay %d result %d"
...
#define PAST_RX_WW_TOO_LARGE                17608       //"<PAST> WARNING!!, window widening is too large."
#define PAST_LL_PERIODIC_SYNC_WR_IND_TX     17609       //"<PAST><PAWR> ll_gen_periodic_wr_sync(%d) cur%d ce_cnt%d ap slot0x%06x us%d sync_event%d ap slot0x%06x us%d ofst%dus %d(*(%d)0:30/1:300), subevent_num %d, subevent_int %d, rsp_slot_delay %d, rsp_slot_spacing %d, %02x %02x %02x %02x %02x"
#define PAST_CREATE_SYNC_WR_MESSAGE         17610       //"<PAST> PAST create sync is triggered due to receive LL_PERIODIC_SYNC_WR_IND. Connection entry ID: %d, PA entry ID: %d, syncConnEventCount: %d, lastPaEventCounter: %d, connEventCount: (%d, %d), PeriodicEventCounter: (%d, %d), CEt: %d, %d us, subevent_num %d, subevent_int %d, rsp_slot_delay %d, rsp_slot_spacing %d, rspAA %x."

#define PAWR_REPORT_CURRENT_PA_EVENT_AND_SUBEVENT   17630       //"<PAWR> Subevent end update PA entity from CAM,  PA event count = %d, Subevent cnt = %d"
#define PAWR_SET_REPONSE_DATA_TIME_INFO_METHOD1     17631       //"<PAWR> RSP anchor = %d us,  Next_sub anchor(slot, offset) = (%d, %d) us, Next_sub ww anchor(slot, offset) = (%d, %d) us, sync interval = %d us, rsp slot delay = %d us, rsp slot = %d us, rsp slot spacing = %d us, txon_early = %d us"
#define PAWR_SET_REPONSE_DATA_TIME_INFO_METHOD2     17632       //"<PAWR> RSP anchor = %d us,  Next_sub anchor(slot, offset) = (%d, %d) us  Next_sub ww anchor(slot, offset) = (%d, %d) us, subevent interval = %d us, next and current diff %d us, rsp slot delay = %d us, rsp slot = %d us, rsp slot spacing = %d us"

#define PA_EARLY_INFO                       17700       //"<PA> mac(%d) Ear sync_cnt:%d, ent:%d, ntv_clk slot:0x%x, ap:0x%x, pacam0:0x%x, pacam1:0x%x"
#define PA_END_INFO                         17701       //"<PA> mac(%d) End sync_cnt:%d, ent:%d, ntv_clk slot:0x%x, ap:0x%x, pacam0:0x%x, pacam1:0x%x, is_src: %d"

#define MULTI_SLAVE_LOG_01  17702 //"[MULTI_SLAVE] ce end hw_entry 0, fw_entry_id = %d, ap_0_13 = 0x%x, ap_14_16 = 0x%x"
#define MULTI_SLAVE_LOG_02  17703 //"[MULTI_SLAVE] entry %d transfer to entry %d, native_clk = 0x%x, meu_reg.value = 0x%x, cmpl_reg.value = 0x%x, reg(0x258) = 0x%x, new_ap = 0x%x"
#define MULTI_SLAVE_LOG_03  17704 //"[MULTI_SLAVE] first early interrupt of entry 0, fw_entry_id = %d, ori_des = 0x%x, ori_seg_vld = 0x%x, descriptor_backup = 0x%x, seg_vld_bm = 0x%x"
#define MULTI_SLAVE_LOG_04  17705 //"[MULTI_SLAVE] le create connection, fw_entry_id = %d"
#define MULTI_SLAVE_LOG_05  17706 //"[MULTI_SLAVE] ce early have background entry, compare_entry = %d, compare_fw_id = %d, winner_entry = %d, winner_ap = 0x%x, cur_slot = 0x%x"
#define MULTI_SLAVE_LOG_06  17707 //"[MULTI_SLAVE] conn interrupt, conn_entry = %d"
#define MULTI_SLAVE_LOG_07  17708 //"[MULTI_SLAVE] find closest entry in background, winner_entry = %d, winner_ap = 0x%x, bg_entry = %d, bg_ap = 0x%x, clk_diff = 0x%x"
#define MULTI_SLAVE_LOG_08  17709 //"[MULTI_SLAVE] just created link fw_entry %d, hw entry %d keep in background"
#define MULTI_SLAVE_LOG_09  17710 //"[MULTI_SLAVE] ce end entry %d temp_cs = %d"
#define MULTI_SLAVE_LOG_10  17711 //"[MULTI_SLAVE] ce end issue kill connection, fw_entry_id = %d, hw_entry = %d"
#define MULTI_SLAVE_LOG_11  17712 //"[MULTI_SLAVE] ce end issue disconnection, fw_entry_id = %d, hw_entry = %d"
#define MULTI_SLAVE_LOG_12  17713 //"[MULTI_SLAVE] ce end entry %d, fw_entry_id %d, read cam row_14 = 0x%x, ori_seg_valid = 0x%x"
#define MULTI_SLAVE_LOG_13  17714 //"[MULTI_SLAVE] restore bzdma entry %d, fw_entry_id %d, pTxSegDesc = 0x%x, pTxFragDesc = 0x%x, seg_wptr = 0x%x, seg_rptr = 0x%x, free_segs = 0x%x, bm_used_segs = 0x%x, vld_bm = 0x%x, active_bm = 0x%x"
#define MULTI_SLAVE_LOG_14  17715 //"[MULTI_SLAVE] ce end after transfer disconn entry, compare_entry = %d, winner_entry = %d, winner_ap = 0x%x, cur_slot = 0x%x"
#define MULTI_SLAVE_LOG_15  17716 //"[MULTI_SLAVE] ce early have background entry, but hw entry %d keep original fw_entry %d"
#define MULTI_SLAVE_LOG_16  17717 //"[MULTI_SLAVE] update complete, type = %d, set fw entry %d in_bg bit to 1"
#define MULTI_SLAVE_LOG_17  17718 //"[MULTI_SLAVE] store bzdma entry %d, fw_entry_id = %d, wptr = 0x%x, rptr = 0x%x, free_seg = 0x%x, used_seg = 0x%x, vld_bm = 0x%x"

#define MULTI_SLAVE_LOG_18  17719 //"ce end update complete, entry 1 && entry 2 are inactive, stop hw_entry = %d, fw_entry_id = %d, switch to hw entry %d"
#define LE_LINK_DBG_CE_EAR  17720 //"Erl:%d slv:0x%x ap:0x%x native_clk:0x%x entry:%d fw_entry_id = %d, non-hdt sn/nesn=%d/%d, hdt sn/nesn=%d/%d"
#define MULTI_SLAVE_LOG_19  17721 //"handle tx ack, hw_entry = %d, fw_entry_id = %d, acked_cnt = %d"

#define MULTI_SLAVE_LOG_21  17723 //"write cam error!!!"
#define MULTI_SLAVE_LOG_22  17724 //"le_sched_pkt_fifo_ce_end_observer_update, hw_entry = %d, fw_entry_id = %d"
#define MULTI_SLAVE_LOG_23  17725 //"ce end update complete, entry 1 or entry 2 are active, stop entry %d fw entry %d, set in_bg and wait to switch to entry 1 or 2"
#define MULTI_SLAVE_LOG_24  17726 //"[MULTI_SLAVE] read cam error entry:%d, addr:0x%x, LR:0x%x"
#define MULTI_SLAVE_LOG_25  17727 //"[MULTI_SLAVE] write cam error entry:%d, addr:0x%x, value:0x%x, LR:0x%x"
#define MULTI_SLAVE_LOG_26  17728 //"[MULTI_SLAVE] mode Enable!! master link number:%d, slave link number:%d, mac_id: %d"
#define MULTI_SLAVE_LOG_27  17729 //"[MULTI_SLAVE] check_and_schedule_next_pend_pdu, entry:%d, pend_conn_updt:%d, pend_ch:%d, pend_phy:%d, bm:0x%x"
#define MULTI_SLAVE_LOG_28  17730 //"[MULTI_SLAVE] wait transfer to background hw_entry = %d, fw_entry_id = %d, pend_conn_updt:%d, pend_ch:%d, pend_phy:%d"
#define MULTI_SLAVE_LOG_29  17731 //"[MULTI_SLAVE] ll_multi_slave_get_fw_entry invalid hw entry: %d"
#define MULTI_SLAVE_LOG_30  17732 //"[MULTI_SLAVE] ll_multi_slave_set_fw_entry invalid hw entry: %d"
#define MULTI_SLAVE_LOG_31  17733 //"[MULTI_SLAVE] ll_multi_slave_get_is_in_background_imp invalid fw entry: %d"
#define MULTI_SLAVE_LOG_32  17734 //"[MULTI_SLAVE] ll_multi_slave_set_is_in_background_imp invalid fw entry: %d"
#define RESTORE_UNACK_PKT_ERROR 17735 //"seg_vld_bm_backup unmatch le_sched_pkt_fifo hw_entry: %d, fw_entry: %d, idx: %d, seg_vld_bm_backup: 0x%x"

#define LE_MSG_ISO_20_BIS_HW2REAL_BIG_OFFSET    17750 //"[ISO] BIS HW to Real big_offset: tune_value:%d, BIS load cam:%d, PA load cam:%d, mst_trx_delay:%d, lbt_en:%d, iso_minus_lbt_time:%d"
#define LE_MSG_ISO_20_BIS_WW_UPD_DEBUG          17751 //"[ISO] BIS ww update interrupt!! entry:%d, HW disable ww auto update."
#define LE_MSG_ISO_20_BIS_AP_LOG                17752 //"[ISO] BIS AP: entry:%d, counter:%d, clock:0x%x, meu AP:(0x%x:0x%x), cam AP:(0x%x:0x%x), ww:(0x%x:0x%x)"
#define LE_MSG_CIG_EVT_END_DBG_LOG              17753 //"[ISO] CIG EVENT END, cis_uid: %d, na_clk:0x%x, meu AP:(0x%x:0x%x), cam AP:(0x%x:0x%x), ww:(0x%x:0x%x), cis_ce_count[15:0]: 0x%x %x, enc pkt cnt: 0x%x %x, dec pkt cnt: 0x%x %x, acc_hit: %d, rx_crc_pkt: %d, mic_err: %d, no_rx_cnt: %d, cam4: 0x%x, cam14: 0x%x, valid_bm: 0x%x"
...
#define GEN_ENC_KEY_SIZE_CONN_ERR   18040 //"Generate encryption change connection not exist."

//HP beacon
#define LOG_HP_BEACON_ENABLE_MSG        19700   //"[HP beacon] HP beacon enable"
#define LOG_HP_POWERON_MSG              19701   //"[HP beacon] Notify Power On Off:%d"
#define LOG_HP_FW_BEACON_MSG            19702   //"[HP beacon] Start HP beacon in s4/s5"
#define LOG_HP_CANCEL_FW_BEACON_MSG     19703   //"[HP beacon] Filter Driver notify cancel due to entering D3"
#define LOG_HP_REGENERATE_NONCE_MSG     19704   //"[HP beacon] Regenerate nonce"
#define LOG_HP_CHECK_DECRYPT_MSG        19705   //"[HP beacon] HP beacon register: %d, state: %d, check_decrypt_pass: %d"
#define LOG_HP_NONCE_CARRY_FORWARD      19706   //"[HP beacon] Nonce last byte carry forward

// ============== GDMA ========
#define GDMA_DATA_RAM_BUFFER_FULL       22000   //"SPORT FIFO to/from Data RAM buffer full !!! %d"
#define GDMA_DATA_RAM_BUFFER_EMPT       22001   //"SPORT FIFO to/from Data RAM buffer empty !!! %d"
#define GDMA_DATA_RAM_BUFFER_CLR        22002   //"clear Data RAM buffer"
#define GDMA_CHANNEL_SUSPEND_FAIL       22003   //"GDMA channel %d suspend fail %d times !!!"
#define GDMA_DATA_ENQUE_DEQUE_ERR       22004   //"GDMA data enque/deque error, enque: %d, reason: %d"
#define GDMA_DATA_ENQUE_DEQUE_STATISTIC 22005   //"GDMA data enque/deque failure statistics, H2C enque: %d, H2C deque: %d, C2H enque: %d, C2H deque: %d"
#define GDMA_AVDTP_SIDEBAND_INIT_FAIL   22006   //"GDMA AVDTP sideband init fail: %d non-supported codec on AMD"
#define GDMA_AVDTP_SIDEBAND_CTRL_SUCC   22007   //"GDMA AVDTP sideband control success: %d"
#define GDMA_AVDTP_SIDEBAND_CTRL_FAIL   22008   //"GDMA AVDTP sideband control fail: %d"
#define GDMA_LE_AUD_SIDEBAND_CTRL_SUCC  22009   //"GDMA LE audio sideband control success: 0x%x"
#define GDMA_LE_AUD_SIDEBAND_CTRL_FAIL  22010   //"GDMA LE audio sideband control fail: 0x%x"
#define GDMA_LE_AUD_SIDEBAND_HANDLE_ERR 22011   //"GDMA LE audio sideband cis handle error: 0x%x"
#define GDMA_LE_AUD_SIDEBAND_ACTUID_ERR 22012   //"GDMA LE audio sideband cis active uid error: 0x%x, 0x%x"
#define GDMA_LE_AUD_SIDEBAND_PATH_WARN  22013   //"GDMA LE audio sideband data path has been actived, 0x%x"

// ============= Data path manager =============
#define CONFIG_SIDEBAND_DATA_PATH_FAIL  22040   //"sideband data path config failure, 0x%x"


//==============COEX ==========================
#define COEX_SET_PAUSE_ACL_REG 22500   //"<BT Coex> Set pause acl reg: %d"
#define COEX_WLAN_DISABLE_TDMA_MODE   22501 //"<Scoreboard> Wlan Disable TDMA mode :%x  "
#define COEX_RECEIVE_WLAN_TDMA_END_CNT 22502 //"<Wlan Mailbox Cmd(0x42)> Receive Wlan-Slot End %d times"
#define COEX_RECEIVE_SCOREBOARD 22503 //"<Scoreboard> scoreboard id: %d receive scoreboard data: 0x%x interrupt: 0x%x"
#define COEX_SEND_SCOREBOARD 22504 //"<Scoreboard> send scoreboard data: 0x%x mac_id: 0x%x"
#define PATCH_PROFILE_NOTIFY_V2_LOG  22505 //<Profile> 0x%x  ,SCO: 0x%x,HID_Exist 0x%x,A2DP_Exist: 0x%x,FTP_Exist: 0x%x,HID_count: 0x%x
#define COEX_LNA_CONSTRAINT_CURRENT_VALUE   22506   //"Current LNA Constraint Value: %x"
#define COEX_WLAN_NOTIFY_ALL_SCAN_LOW_PRI 22507 //"<BT Coex> Wlan set all BT scan low priority: %d"
#define COEX_WIFI_CONTROL_BT_TX_POWER 22508 //"!! IMPORTANT!! wifi set bt tx power diff step :%x(INT8) , pausing thermal tracking!! "
#define COEX_MAILBOX_PROFILE_INFO_REPORT 22509 //"<Wlan Mailbox Cmd(0x45)> Raw Data: 0x%08x, 0x%08x"
#define COEX_MAILBOX_PROFILE_REPORT_HANDLE_INVALID  22510   //"<Bt Coex> Profile query with error conn_handle: %x"
#define FC19_CMD_PARSE 22511 //"[Profile Info] SCO_bit[0]=%d HID_bit[1]=%d A2DP_bit[2]=%d FTP_bit[3]=%d number of HID = %d"
#define L2CAP_ACL_SIGNAL_CONN_REQ 22512 //"[L2CAP SIG][Tx: %d][Conn req] conn_handle: %d, profile_idx: 0x%X, local_cid: 0x%X, remote_cid: 0x%X, profile_pos: 0x%x"
#define L2CAP_ACL_SIGNAL_CONN_RESP 22513 //"[L2CAP SIG][Tx: %d][Conn resp] conn_handle: %d, profile_idx: 0x%X, local_cid: 0x%X, remote_cid: 0x%X"
#define L2CAP_ACL_SIGNAL_DISCONN_REQ 22514 //"[L2CAP SIG][Tx: %d][DisConn req] conn_handle: %d, idx: 0x%X, local_cid: 0x%X, remote_cid: 0x%X"
#define L2CAP_DENIED_PROFILE_REPORT 22515 //"[L2CAP] Denied profile report from host"
#define L2CAP_FC19_CMD_PARSE 22516 //"[L2CAP Profile Info] SCO_bit[0]=%d HID_bit[1]=%d A2DP_bit[2]=%d FTP_bit[3]=%d number of HID = %d"


// ============== 6.0 LE Frame Space Update ========
#define LE_MSG_GEN_LL_FRAME_SPACE_REQ                   22800   //"[LL][FSU] Gen LL_FRAME_SPACE_REQ: %02x %02x %02x %02x %02x %02x %02x"
#define LE_MSG_GEN_LL_FRAME_SPACE_RSP                   22801   //"[LL][FSU] Gen LL_FRAME_SPACE_RSP: %02x %02x %02x %02x %02x"
#define LE_MSG_GEN_LL_FSU_RX_TMP_WINDOW_WARNING         22802   //"[LL][FSU] Warning !! The window expand value %d is greater than the current window start %d"
#define LE_MSG_GEN_LL_FSU_PHY_RATE_SUPPORT_UNKNOWN      22803   //"[LL][FSU] Warning !! Unknwon PHY rate %d"
#define LE_MSG_GEN_LL_FSU_SPACING_TYPE_SUPPORT_UNKNOWN  22804   //"[LL][FSU] Warning !! Unknwon Spacing Type %d"
#define LE_MSG_GEN_LL_FSU_SET_VALUE_INVALID_FS_TYPE     22805   //"[LL][FSU] Set FS value undefined fs type %d"
#define LE_MSG_GEN_LL_FSU_TRANSFORM_TO_HW_DIRECTION     22806   //"[LL][FSU] Transform to HW direction t2r: %d, tx_phy: %d, rx_phy: %d"
#define LE_MSG_GEN_LL_FSU_SCHEDULE                      22807   //"[LL][FSU] Schedule FSU procedure fs_max %d, fs_min %d, PHYS %x, Spacing_Types %x"
#define LE_MSG_GEN_LL_FSU_EXPAND_RX_SEARCH_WINDOW       22808   //"[LL][FSU] Expand RX search window left %d, right %d"
#define LE_MSG_GEN_LL_FSU_HW_COPY_DONE                  22809   //"[LL][FSU] FSU HW copy done ,status 0x%x"
#define LE_MSG_GEN_LL_FSU_DISABLE_TMP_RX_SEARCH_WINDOW  22810   //"[LL][FSU] Remote FS changed, disable tmp rx search window, after ll_frame_space_rsp ce cnt %d, recent t2r fs %d"
#define LE_MSG_GEN_LL_FSU_PROCEDURE_ALL_DONE            22811   //"[LL][FSU] FSU procedure all done"
#define LE_MSG_GEN_LL_FSU_INIT_CAM                      22812   //"[LL][FSU] Init FSU CAM handle 0x%04x, Master %d"
#define LE_MSG_GEN_LL_FSU_FUNCTION_ENABLE               22813   //"[LL][FSU] FSU function enabled handle 0x%04x, Master %d"
#define LE_MSG_GEN_LL_FSU_RADIO_TIMING_SETTING          22814   //"[LL][FSU] Tx PHY %d, Rx PHY %d, txon_early_afe 0x%x, rxon_early_afe 0x%x, rx_search_to_val 0x%x, txon_early 0x%x, rx_timeout_delay 0x%x, txon_delay 0x%x, rxon_delay 0x%x, rx_search_to_val_lr 0x%x"
#define LE_MSG_GEN_LL_FSU_TRANSFORM_HW_REG              22815   //"[LL][FSU] Tx PHY %d, Rx PHY %d, fs_type %d, hw_entry_id %d, reg 0x%x, Frame Space %d"
#define LE_MSG_GEN_LL_FSU_TRANSFORM_HW_REG_WARN         22816   //"[LL][FSU] Warning !!! FSU TRX HW Direction transform failed, tx phy %d, rx phy %d"
#define LE_MSG_GEN_LL_FSU_PHY_UPDATE_INSTANT_REACHED    22817   //"[LL][FSU] PHY Update Instant %d, Current connection counter %d, New Tx PHY %d, New Rx PHY %d"
#define LE_MSG_GEN_LL_FSU_HCI_COMMAND_ERROR             22818   //"[LL][FSU] LL HCI frame space command error, error bitmap %d"
#define LE_MSG_GEN_LL_FSU_GET_TRX_DELAY                 22819   //"[LL][FSU] Get trx_delay from LE formal register tx_phy %d, rx_phy %d, t2r %d, trx_delay %d"    
#define LE_MSG_GEN_LL_FSU_MAKE_FS_DECISION_FAILED       22820   //"[LL][FSU] Cannot find the frame space value for fs_min_req %d, fs_max_req %d" 
#define LE_MSG_GEN_LL_FSU_RECV_UNEXPECTED_RSP           22821   //"[LL][FSU] Ignore unexpected ll_frame_space_rsp fs_type 0x%x, phys 0x%x, fs %d"  
#define LE_MSG_GEN_LL_FSU_RECV_REQ_PROCEDURE_COLLISION  22822   //"[LL][FSU] Received ll_frame_space_req during fsu procedure is proceeding"   
#define LE_MSG_GEN_LL_FSU_TRANS_HW_DIRECTION_FAILED     22823   //"[LL][FSU] Failed to transform to hw direction tx phy %d, rx phy %d"    
#define LE_MSG_FSU_REJECT_PROCEDURE_WARN                22824   //"[LL][FSU] The FSU reject ind is not expected, acl_id:%d local:0x%x, remote:0x%x"
#define LE_MSG_FSU_REJECT_REMOTE_REQ                    22825   //"[LL][FSU] The FSU reject remote request reason %d, error_bm 0x%x"
#define LE_MSG_FSU_REJECT_REMOTE_REQ_MULTI_SLAVE        22826   //"[LL][FSU] FSU request received when multi-slave is enabled"

//===================== IPU ==========================
#define LE_MSG_ISO_SET_CIG_PARAM_CIS_V2     22900  //"[IPU] Set CIG param v2 (CIS Info): cis_id %02x, max_sdu(%04x %04x), rtn(%02x %02x), coded_rate_m2s %02x, coded_rate_s2m %02x"
#define LE_MSG_ISO_FW_GEM_CIS_PARAM_IPU     22901  //"[IPU] Gen CIS Params from host info: coded_rate_m2s %02x, coded_rate_s2m %02x"
