...
typedef enum PAD_OUTPUT_ENABLE_Mode
{
    PAD_OUT_DISABLE,
    PAD_OUT_ENABLE
...
typedef enum PAD_PULL_CONFIG_VAL
{
    PAD_WEAK_PULL,
    PAD_STRONG_PULL
} PAD_PULL_VAL;
...
typedef enum PAD_WAKEUP_POL_VAL
{
    PAD_WAKEUP_POL_HIGH,
    PAD_WAKEUP_POL_LOW
} PAD_WAKEUP_POL_VAL;
 ...
 * \param[in] Pin_Num: Pin number to be configured. \ref Pin_Define.
 * \return  None.
 *
 * <b>Example usage</b>
 * \code{.c}
...
/**
 * \brief   Configure the usage function of the selected pin.
 * \param[in] Pin_Num: Pin number to be configured. \ref Pin_Define.
 * \param[in] Pin_Func: Use function of pin.
 *      This parameter refers to \ref Pin_Function_Number
 * \return None.
 *
 * <b>Example usage</b>
 * \code{.c}
...
/**
  ...
  * @note  Call this API will clear the debounce wakeup status bit.
 ...
 * \param[in] Pin_Num: Pin number to be configured. \ref Pin_Define.
 * \param[in] value: Configure pin output level.
 *            This parameter can be one of the following values:
 *            \arg PAD_OUT_LOW: Pad output low.
 *            \arg PAD_OUT_HIGH: Pad output high.
 * \return    None.
 ...
 *            This parameter can be enumerated PAD_OUTPUT_ENABLE_Mode of the values:
 ...
 *            This parameter is from P0_0 to H_2, please refer to rtl876x.h \ref Pin_Define part.
...
/**
 * \brief     Set pin driving current.
 * \param[in] Pin_Num: Pin number to be configured.
 *            This parameter can be P0_0 P0_5 P0_6 P5_1.
 * \param[in] PAD_Driving_Current: This parameter sets the pin driving current.
 *            This parameter can be the following:
 *            \arg PAD_DRIVING_CURRENT_8_8mA.
 *            \arg PAD_DRIVING_CURRENT_12_18mA.
 *            \arg PAD_DRIVING_CURRENT_16_28mA.
 * \return None.
 *
 * <b>Example usage</b>
 * \code{.c}
...
/**
  ...
  * \note   Call this API will clear the debounce wakeup status bit.
...
/**
  ...
  * \param[in]  value: LCD8080 select interface:
  *         \arg 0x0 : disable LCD interface
  *         \arg 0x1 : enable I8080 interface
  *         \arg 0x2 : enable QSPI interface
  *         \arg 0x3 : disable LCD interface
  * \return None
  */
...
/**
  ...
  * \param[in]  Pin_Num: LCD8080 Pinmux pos:
  *         \arg P0_1 LCD PINMUX POS: 0
  *         \arg P0_2 LCD PINMUX POS: 1
  *         \arg P0_4 LCD PINMUX POS: 2
  *         \arg P0_5 LCD PINMUX POS: 3
  *         \arg P2_0 LCD PINMUX POS: 4
  *         \arg P3_2 LCD PINMUX POS: 5
  *         \arg P3_3 LCD PINMUX POS: 6
  *         \arg P3_4 LCD PINMUX POS: 7
  *         \arg P3_5 LCD PINMUX POS: 8
  *         \arg P3_6 LCD PINMUX POS: 9
  *         \arg P4_0 LCD PINMUX POS: 10
  *         \arg P4_1 LCD PINMUX POS: 11
  *         \arg P4_2 LCD PINMUX POS: 12
  *         \arg P4_3 LCD PINMUX POS: 13
